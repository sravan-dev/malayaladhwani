            ...
            <header class="td-post-title">
                ...
                <div class="td-module-meta-info">
                    ...
                    <div class="td-post-author-name">
                        <?php $mad_reporter = get_post_meta(get_the_ID(), '_mad_reporter_name', true); ?>
                        <?php if (!empty($mad_reporter)): ?>
                            <?php echo esc_html($mad_reporter); ?>
                        <?php else: ?>
                    ...
                    <span class="td-post-date">
                        <?php
                        $mad_date = get_post_meta(get_the_ID(), '_mad_reporter_date', true);
                        $date_timestamp = !empty($mad_date) ? strtotime($mad_date) : get_the_time('U');
                        $date_formatted = !empty($mad_date) ? date_i18n(get_option('date_format'), $date_timestamp) : get_the_time(get_option('date_format'));
                        ?>
                        <time class="entry-date updated td-module-date" datetime="<?php echo esc_html(date(DATE_W3C, $date_timestamp)) ?>"><?php echo esc_html($date_formatted) ?></time>
                    </span>
