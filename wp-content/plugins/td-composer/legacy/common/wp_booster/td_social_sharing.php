...
class td_social_sharing {
    ...
    private static function get_readable_share_url( $url ) {
        ...
        $auth .= $parsed_url['host'];

        if ( ! empty( $parsed_url['port'] ) ) {
            $auth .= ':' . $parsed_url['port'];
        }
        ...
        $readable_url = $scheme . $auth . $path;

        if ( ! empty( $parsed_url['query'] ) ) {
            $readable_url .= '?' . $parsed_url['query'];
        }

        if ( ! empty( $parsed_url['fragment'] ) ) {
            $readable_url .= '#' . $parsed_url['fragment'];
        }
    ...
    private static function get_service_share_info($service_id, $post_id = null ) {
        ...
        if ( $post === null ) {
            ...
            if ( $term_exists ) {
                ...
                $page_permalink = get_term_link( $term->term_id );
                $page_id = $term->term_id;
                $page_title = $term->name;
            }
        }

        if ( ! is_string( $page_permalink ) ) {
            $page_permalink = '';
        }
        ...
        $page_share_permalink = self::get_readable_share_url( $page_permalink );
        $page_permalink_param = rawurlencode( $page_share_permalink );
        $page_title_text = html_entity_decode( $page_title, ENT_COMPAT, 'UTF-8' );

        switch ( $service_id ) {

            case 'facebook':
                return array(
                    'url' => 'https://www.facebook.com/sharer.php?u=' . $page_permalink_param,
                    'title' => 'Facebook'
                );
                break;
            ...
            case 'twitter':
                ...
                return array(
                    'url' => 'https://twitter.com/intent/tweet?text=' . htmlspecialchars(urlencode($page_title_text), ENT_COMPAT, 'UTF-8') . '&url=' . $page_permalink_param . $twitter_via_param,
                    'title' => 'Twitter'
                );
                break;
            ...
            case 'pinterest':
                ...
                return array(
                    'url' => 'https://pinterest.com/pin/create/button/?url=' . $page_permalink_param . '&amp;media=' . rawurlencode( $image_url ) . '&description=' . esc_html($td_pinterest_share_description),
                    'title' => 'Pinterest'
                );
                break;
            ...
            case 'linkedin':
                return array(
                    'url' => 'https://www.linkedin.com/shareArticle?mini=true&url=' . $page_permalink_param . '&title=' . htmlspecialchars(urlencode($page_title_text)),
                    'title' => 'Linkedin'
                );
                break;
            ...
            case 'tumblr':
                return array(
                    'url' => 'https://www.tumblr.com/share/link?url=' . $page_permalink_param . '&name=' . rawurlencode( $page_title_text ),
                    'title' => 'Tumblr'
                );
                break;
            ...
            case 'mail':
                return array(
                    'url' => 'mailto:?subject=' . rawurlencode( $page_title_text ) . '&body=' . rawurlencode( $page_share_permalink ),
                    'title' => __td('Email')
                );
                break;
            ...
            case 'telegram':
                return array(
                    'url' => 'https://telegram.me/share/url?url=' . $page_permalink_param . '&text=' . htmlspecialchars(urlencode($page_title_text)),
                    'title' => 'Telegram'
                );
                break;
            ...
            case 'whatsapp':
                return array(
                    'url' => 'https://api.whatsapp.com/send?text=' . rawurlencode( $page_title_text . "\n\n" . $page_share_permalink ),
                    'title' => 'WhatsApp'
                );
                break;
            ...
            case 'digg':
                return array(
                    'url' => 'https://www.digg.com/submit?url=' . $page_permalink_param,
                    'title' => 'Digg'
                );
                break;
            ...
            case 'reddit':
                return array(
                    'url' => 'https://reddit.com/submit?url=' . $page_permalink_param . '&title=' . htmlspecialchars(urlencode($page_title_text)),
                    'title' => 'ReddIt'
                );
                break;
            ...
            case 'stumbleupon':
                return array(
                    'url' => 'https://www.mix.com/add?url=' . $page_permalink_param,
                    'title' => 'Mix'
                );
                break;
            ...
            case 'vk':
                return array(
                    'url' => 'https://vk.com/share.php?url=' . $page_permalink_param,
                    'title' => 'VK'
                );
                break;
            ...
            case 'line':
                return array(
                    'url' => 'https://line.me/R/msg/text/?' . rawurlencode( $page_title_text . "\r\n" . $page_share_permalink ),
                    'title' => 'LINE'
                );
                break;
            ...
            case 'viber':
                return array(
                    'url' => 'viber://forward?text=' . rawurlencode( $page_title_text . ' ' . $page_share_permalink ),
                    'title' => 'Viber'
                );
                break;
            ...
            case 'naver':
                return array(
                    'url' => 'https://share.naver.com/web/shareView.nhn?url=' . $page_permalink_param . '&title=' . htmlspecialchars(urlencode($page_title_text)),
                    'title' => 'Naver'
                );
                break;
            ...
            case 'flipboard':
                return array(
                    'url' => 'https://share.flipboard.com/bookmarklet/popout?v=2&title=' . htmlspecialchars(urlencode($page_title_text)) . '&url=' . $page_permalink_param,
                    'title' => 'Flip'
                );
                break;
            ...
            case 'kakao':
                return array(
                    'url' => 'https://story.kakao.com/s/share?url=' . $page_permalink_param . '&text=' . htmlspecialchars(urlencode($page_title_text)),
                    'title' => 'Kakao Story'
                );
                break;
            ...
            case 'gettr':
            return array(
                'url' => 'https://gettr.com/share?text=' . htmlspecialchars(urlencode($page_title_text)) . '&url=' . $page_permalink_param,
                'title' => 'Gettr'
            );
            break;
            ...
            case 'koo':
            return array(
                'url' => 'https://www.kooapp.com/create?title=' . $page_permalink_param,
                'title' => 'Koo'
            );
            break;
