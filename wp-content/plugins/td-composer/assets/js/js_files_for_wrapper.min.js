...
function(a){};e.onerror=function(){}}},get:function(b){var a=f.Deferred(),e=tdcStore.getObjectStore(tdcStore._dbStoreName,"readwrite");try{var c=e.get(b)}catch(g){throw console.log(g.name),g;}c.onsuccess=function(b){a.resolve(this)};c.onerror=function(){};return a}};tdcStore.init("TagDivComposer","History");tdcStore.openDb()})(jQuery,_);var tdcSavePost;
...
"success"===e&&b.isObject(a)&&(b.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(b.has(a,"header_template_id")&&(tdcState.setHeaderTemplateId(a.header_template_id),tdcSidebar.updateHeaderTemplates()),tdcMain.resetContentModified(),tdcSidebar.setCurrentHeaderTemplate(),new tdcNotice.notice("Header Successfully Saved!",!1,!0)))}).fail(function(a,b,e){})},getHeaderTemplateData:function(){var a=tdcState.getHeaderTemplateId(),b="",c={};""!==a&&"no_header"!==a&&(b=tdcUtil.b64EncodeUnicode(JSON.stringify(tdcIFrameData.getHeaderShortcodeFromData())));
tdcState.setHeaderTemplateId(a);tdcState.setHeaderTemplateContent(b);c.tdc_header_template_id=a;c.tdc_header_template_content=b;c.tdc_assoc_header_template=tdcState.isGlobalHeaderTemplate()?"":!0;return c},cloudLoadHeaderTemplate:function(a,e,c,g,m){b.isUndefined(a)||(g={td_magic_token:tdcLivePanel.$token.val(),tdc_action:"load_header_template",tdc_header_template_content:a,tdc_header_template_title:g},b.isUndefined(c)||(g.tdc_header_template_id=c),b.isUndefined(m)||(g.tdc_header_is_mobile=m),f.ajax({timeout:1E4,
...
e),b.isUndefined(window.tdcPostSettings.prevTemplateType)||(window.tdcPostSettings.tdbTemplateType=window.tdcPostSettings.prevTemplateType,window.tdcPostSettings.prevTemplateType=d))}).fail(function(a,b,e){}))},assignCloudLoadHeaderTemplate:function(a,e,c,g,m,n,k){b.isUndefined(a)||(a={td_magic_token:tdcLivePanel.$token.val(),tdc_action:"load_header_template",tdc_header_template_content:a,tdc_header_template_title:g,tdc_header_is_mobile:!0},b.isUndefined(c)||(a.tdc_header_template_id=c),b.isUndefined(m)||
...
(window.tdcPostSettings.tdbTemplateType=window.tdcPostSettings.prevTemplateType,window.tdcPostSettings.prevTemplateType=d))}).fail(function(a,b,e){}))},cloudLoadFooterTemplate:function(a,e,c,g){b.isUndefined(a)||(g={td_magic_token:tdcLivePanel.$token.val(),tdc_action:"load_footer_template",tdc_footer_template_content:a,tdc_footer_template_title:g},b.isUndefined(c)||(g.tdc_footer_template_id=c),tdcState.isMobileComposer()&&(g.tdc_footer_is_mobile=1),f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/load_footer_template",
...
window.tdcPostSettings.prevTemplateType,window.tdcPostSettings.prevTemplateType=d))}).fail(function(a,b,e){}))},getFooterTemplateData:function(){var a=tdcState.getFooterTemplateId(),b="",c={};""!==a&&"no_footer"!==a&&(b=tdcIFrameData.getFooterShortcodeFromData());tdcState.setFooterTemplateId(a);tdcState.setFooterTemplateContent(b);c.tdc_footer_template_id=a;c.tdc_footer_template_content=b;c.tdc_assoc_footer_template=tdcState.isGlobalFooterTemplate()?"":!0;return c},saveMobileMenu:function(a,e){f.ajax({timeout:1E4,
...
new tdcNotice.notice("Footer Successfully Saved!",!1,!0)))}).fail(function(a,b,e){})}}})(jQuery,Backbone,_);var tdcShortcodeParser={};
...
(function(){tdcJobManager={_sentJobs:{},totalJobsCount:0,job:function(){this.model=void 0;this.shortcode="";this.columns=0;this.error_callback=this.success_callback=this.blockUid=""},jobRequest:function(f){this.parentRowAttributes="";if(!_.isUndefined(f.model)){var c=f.model.getParentModel("vc_row");_.isUndefined(c)||(this.parentRowAttributes=JSON.stringify(c.attributes.attrs))}this.shortcode=f.shortcode;this.columns=f.columns;this.jobId=tdcJobManager._generateJobId();this.postId=window.tdcPostSettings.postId;
this.replyHtml=""},addJob:function(f){tdcMain.setContentModified();tdcDebug.group("%c tdcJobManager.addJob","background-color:#2489c2; color:white");var c=new tdcJobManager.jobRequest(f),b="";!1!==window.tdcPostSettings.tdbLoadDataFromId&&(b+="&tdbLoadDataFromId="+window.tdcPostSettings.tdbLoadDataFromId);!1!==window.tdcPostSettings.tdbTemplateType&&(b+="&tdbTemplateType="+window.tdcPostSettings.tdbTemplateType);jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/do_job",
"tmp_jobId="+c.jobId+"&tmp_blockUid="+c.blockUid+"&post_id="+window.tdcPostSettings.postId+b+"&uuid="+tdcJobManager._getUniqueID()),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},cache:!1,data:c,dataType:"json",statusCode:{404:function(){console.log("tdcJobManager.addJob - ERROR: 404 not found")},500:function(){console.log("tdcJobManager.addJob - ERROR: 500 server error")}},success:function(b,a,e){null===b?f.error_callback(c,"tdcJobManager.addJob - ERROR: Empty response received from server"):
(!0===tdcJobManager._isJobCallbackReplyValid(f.blockUid,b.jobId)?f.success_callback(b):tdcDebug.log("tdcJobManager.addJob - dropped job :) (probably it's older than the last timestamp)"),tdcDebug.groupEnd())},error:function(b,a,e){f.error_callback(c,"tdcJobManager.addJob - Error callback - textStatus: "+a+" errorThrown: "+e);tdcDebug.groupEnd()}})},_isJobCallbackReplyValid:function(f,c){return"undefined"===typeof tdcJobManager._sentJobs[f]||parseInt(tdcJobManager._sentJobs[f])<parseInt(c)?(tdcJobManager._sentJobs[f]=
c,!0):!1},_generateJobId:function(){var f=tdcJobManager.totalJobsCount;tdcJobManager.totalJobsCount++;return f},_getUniqueID:function(){function f(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return f()+f()+"-"+f()+"-"+f()+"-"+f()+"-"+f()+f()+f()}}})();var tdcAdminWrapperUI;
...
tdcOperationUI.getDraggedElement(),e=tdcOperationUI.getCurrentElementOver(),c=tdcAdminWrapperUI.$placeholder,g="";if(!(b.isUndefined(a)||b.isUndefined(e)||b.isUndefined(c)||!c.is(":visible")&&e!==tdcAdminWrapperUI.$recycle)){var m=tdcOperationUI.isSidebarElementDragged(),n=tdcOperationUI.isElementDragged(),k=!1,l=!1,p=!1,q=!1,r=!1,t=!1,v=tdcOperationUI.isElementWithRowDragged(),u=tdcOperationUI.getRowStartValues();if(n){var x=a.closest(".tdc-elements");if(!m&&(g=tdcIFrameData._getSourceCol(tdcOperationUI.getDraggedElement()),
b.isUndefined(g)))return}else(k=tdcOperationUI.isInnerColumnDragged())&&(x=a.closest(".tdc-inner-columns"));!k&&(l=tdcOperationUI.isInnerRowDragged(),p=tdcOperationUI.isTempInnerRowDragged(),l||p)&&(x=a.closest(".tdc-elements"));l||p||(q=tdcOperationUI.isColumnDragged())&&(x=a.closest(".tdc-columns"));!q&&(r=tdcOperationUI.isRowDragged(),t=tdcOperationUI.isTempRowDragged(),r||t)&&(x=a.closest(".tdc-rows"));if(m||n||k||l||p||q||r||t){var C="",z=a.find(".td_block_inner");z.length&&(C=z.attr("id"));
if(!m&&!b.isUndefined(x)&&x.length){var w=x.children();z=w.index(a);var y=w.index(c);if(e!==tdcAdminWrapperUI.$recycle&&-1!==y&&1===Math.abs(z-y))return;if(n||l||p||r||t){if((n||l||r)&&e===tdcAdminWrapperUI.$recycle){c="Deleting ";tdConfirm.showModal(l?c+"inner row":r?c+"row":c+"element",tdcOperationUI,function(){if((-1===y&&1===w.length||2===w.length&&-1!==y)&&(!r||1!==tdcIFrameData.tdcRows.length)){var b="";A=a.closest(".tdc-inner-column");A.length?b=" tdc-element-inner-column":(B=a.closest(".tdc-column"),
B.length&&(b=" tdc-element-column"));b=f('<div class="'+tdcOperationUI._emptyElementClass+b+'"></div>');tdcElementUI.bindEmptyElement(b);x.append(b)}tdcRecycle.takeSnapshot("Delete element");tdcOperationUI.setDraggedElement(a);tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);tdcIFrameData.changeData({$refEl:tdcOperationUI.getDraggedElement(),wasSidebarElementDragged:m,wasElementDragged:n,wasInnerColumnDragged:k,wasInnerRowDragged:l,wasTempInnerRowDragged:p,wasColumnDragged:q,wasRowDragged:r,
wasTempRowDragged:t,wasElementWithRowDragged:v,rowStartValues:u,draggedBlockUid:C,sourceColParam:g});tdcSidebarPanel.clearPanel();tdcOperationUI.setDraggedElement(d);tdcOperationUI.setCurrentElementOver(d);tb_remove()},d,"Are you sure you want to delete this element?");return}if(-1===y&&1===w.length||2===w.length&&-1!==y){e="";var A=a.closest(".tdc-inner-column");if(A.length)e=" tdc-element-inner-column";else{var B=a.closest(".tdc-column");B.length&&(e=" tdc-element-column")}e=f('<div class="'+tdcOperationUI._emptyElementClass+
e+'"></div>');tdcElementUI.bindEmptyElement(e);x.append(e)}}}m&&(e="",n?e="tdc-element":p?e="tdc-element-inner-row-temp":l?e="tdc-element-inner-row":t?e="tdc-row-temp":r&&(e="tdc-row"),e=f('<div class="'+e+'">'+a.html()+"</div>"),b.isUndefined(a.data("shortcodeName"))||e.data("shortcodeName",a.data("shortcodeName")),b.isUndefined(a.data("startValues"))||e.data("startValues",a.data("startValues")),b.isUndefined(a.data("shortcodeContent"))||e.data("shortcodeContent",a.data("shortcodeContent")),b.isUndefined(a.data("rowStartValues"))||
...
c.remove();c=a.next();c.hasClass(tdcOperationUI._emptyElementClass)&&c.remove();tdcIFrameData.changeData({$refEl:tdcOperationUI.getDraggedElement(),wasSidebarElementDragged:m,wasElementDragged:n,wasInnerColumnDragged:k,wasInnerRowDragged:l,wasTempInnerRowDragged:p,wasColumnDragged:q,wasRowDragged:r,wasTempRowDragged:t,wasElementWithRowDragged:v,draggedBlockUid:C,sourceColParam:g})}else new tdcNotice.notice("_moveDraggedElement Error: $draggedElement not valid!",!0,!1)}},_copyElement:function(a){var e=
...
m.result.content;if("undefined"!==typeof n.readyState&&"done"===n.readyState&&"undefined"!==typeof n.result&&(n=n.result.content,"undefined"!==typeof k.readyState&&"done"===k.readyState&&"undefined"!==typeof k.result)){k=k.result.content;var p=m=!1,q=!1,r=!1,t=!1,v="",u=f('<div class="tdc-dropped"></div>');"vc_row"===h?(v="tdc-row",t=!0,u.addClass("tdc-row-temp")):"vc_column"===h?(v="tdc-element-column",q=!0):"vc_row_inner"===h?(v="tdc-element-inner-row",r=!0,u.addClass("tdc-element-inner-row-temp")):
"vc_column_inner"===h?(v="tdc-element-inner-column",p=!0):""!==h&&(v="tdc-element",m=!0);u.addClass(v);u.data("shortcodeName",h);u.data("startValues",g);if(t||r)u.data("templateContent",k);else if(q||p){h=e.data("model_id");var x="";g=tdcIFrameData.getModel(h).get("childCollection");b.isUndefined(g)||b.map(g.models,function(a,e){e={error:d,getShortcode:""};tdcIFrameData._checkModelData(a,e);b.isUndefined(e.getShortcode)||(x+=e.getShortcode)});g="";g=b.isUndefined(a)||!0!==a?tdcUtil.b64EncodeUnicode(tdcUtil.b64DecodeUnicode(k)+
x):tdcUtil.b64EncodeUnicode(x+tdcUtil.b64DecodeUnicode(k));u.data("templateContent",g);u.data("model_id",h)}c.replaceWith(u);u.closest(".tdc-inner-columns").length?u.addClass("tdc-element-inner-column"):u.closest(".tdc-columns").length&&u.addClass("tdc-element-column");tdcIFrameData.changeData({$refEl:u,wasSidebarElementDragged:!0,wasElementDragged:m,wasInnerColumnDragged:p,wasInnerRowDragged:!1,wasTempInnerRowDragged:r,wasColumnDragged:q,wasRowDragged:!1,wasTempRowDragged:t,wasElementWithRowDragged:!1,
...
(function(f,c,b,d){tdcZoneHandlerUI={_handlerId:"tdc-zone",_handlerText:"Zone",_handlerCssClass:"tdc-mask-zone",$elementRow:d,_$handlerWrapper:d,_$handlerClone:d,_isInitialized:!1,init:function(a){b.isUndefined(a)||!0!==a||(tdcZoneHandlerUI._isInitialized=!1);tdcZoneHandlerUI._isInitialized||"td-aib-style"===window.tdcPostSettings.loadDataFromPostType||(tdcMaskUI.$handlerStructure.find("#"+tdcZoneHandlerUI._handlerCssClass).length||(tdcZoneHandlerUI._$handlerWrapper=f('<div id="'+tdcZoneHandlerUI._handlerCssClass+
'"><div class="tdc-mask-handler-drag" title="Zone settings">'+tdcZoneHandlerUI._handlerText+"</div></div>"),tdcMaskUI.$handlerStructure.append(tdcZoneHandlerUI._$handlerWrapper)),tdcZoneHandlerUI._$handlerWrapper.mousedown(function(a){1===a.which&&tdcZoneHandlerUI._triggerEvent(a)}).mouseup(function(a){tdcZoneHandlerUI._triggerEvent(a)}).mousemove(function(a){tdcMaskUI.show();tdcZoneHandlerUI._triggerEvent(a)}).mouseenter(function(a){a.preventDefault();tdcMaskUI.setCurrentContainer(tdcZoneHandlerUI.$elementRow);
tdcMaskUI.show()}).mouseleave(function(a){a.preventDefault();tdcMaskUI.setCurrentContainer(d);tdcMaskUI.hide()}).on("contextmousedown",function(a){a.preventDefault();tdcContextMenu.setContextMenu(a,tdcZoneHandlerUI.$elementRow)&&tdcZoneHandlerUI._triggerEvent(a)}),tdcMaskUI.addHandler(tdcZoneHandlerUI._handlerId,tdcZoneHandlerUI),tdcZoneHandlerUI._isInitialized=!0)},setElement:function(a){a=tdcOperationUI.inZone(a);b.isUndefined(a)?tdcZoneHandlerUI._$handlerWrapper.hide():(tdcZoneHandlerUI.$elementRow=
a,tdcZoneHandlerUI._$handlerWrapper.show())},_triggerEvent:function(a){b.isUndefined(a)||b.isUndefined(tdcZoneHandlerUI.$elementRow)||tdcZoneHandlerUI.$elementRow.trigger(a)}}})(jQuery,Backbone,_);var tdcRowHandlerUI;
(function(f,c,b,d){tdcRowHandlerUI={_handlerId:"tdc-row",_handlerText:"Row",_handlerCssClass:"tdc-mask-row",$elementRow:d,_$handlerWrapper:d,_$handlerClone:d,_isInitialized:!1,init:function(a){b.isUndefined(a)||!0!==a||(tdcRowHandlerUI._isInitialized=!1);tdcRowHandlerUI._isInitialized||"td-aib-style"===window.tdcPostSettings.loadDataFromPostType||(tdcMaskUI.$handlerStructure.find("#"+tdcRowHandlerUI._handlerCssClass).length||(tdcRowHandlerUI._$handlerWrapper=f('<div id="'+tdcRowHandlerUI._handlerCssClass+
'"><div class="tdc-mask-handler-drag" title="Row settings">'+tdcRowHandlerUI._handlerText+"</div></div>"),tdcRowHandlerUI._$handlerClone=f('<div class="tdc-mask-clone" title="Duplicate row"></div>'),tdcRowHandlerUI._$handlerWrapper.append(tdcRowHandlerUI._$handlerClone),tdcMaskUI.$handlerStructure.append(tdcRowHandlerUI._$handlerWrapper)),tdcRowHandlerUI._$handlerWrapper.mousedown(function(a){1===a.which&&tdcRowHandlerUI._triggerEvent(a)}).mouseup(function(a){tdcRowHandlerUI._triggerEvent(a)}).mousemove(function(a){tdcMaskUI.show();
tdcRowHandlerUI._triggerEvent(a)}).mouseenter(function(a){a.preventDefault();tdcMaskUI.setCurrentContainer(tdcRowHandlerUI.$elementRow);tdcMaskUI.show()}).mouseleave(function(a){a.preventDefault();tdcMaskUI.setCurrentContainer(d);tdcMaskUI.hide()}).on("contextmousedown",function(a){a.preventDefault();tdcContextMenu.setContextMenu(a,tdcRowHandlerUI.$elementRow)&&tdcRowHandlerUI._triggerEvent(a)}),tdcRowHandlerUI._$handlerClone.mousedown(tdcRowHandlerUI.cloneHandler),tdcMaskUI.addHandler(tdcRowHandlerUI._handlerId,
tdcRowHandlerUI),tdcRowHandlerUI._isInitialized=!0)},setElement:function(a){a=tdcOperationUI.inRow(a);b.isUndefined(a)?tdcRowHandlerUI._$handlerWrapper.hide():(tdcRowHandlerUI.$elementRow=a,tdcRowHandlerUI._$handlerWrapper.show())},_triggerEvent:function(a){b.isUndefined(a)||b.isUndefined(tdcRowHandlerUI.$elementRow)||tdcRowHandlerUI.$elementRow.trigger(a)},cloneHandler:function(a){if("click"!==a.type||1===a.which)a.preventDefault(),a.stopPropagation(),tdConfirm.showModal("Clone row",tdcRowHandlerUI,
function(a){a=tdcRowHandlerUI.$elementRow.data("model_id");if(b.isUndefined(a))new tdcNotice.notice("tdcRowHandlerUI -> tdcRowHandlerUI._$handlerClone Error: Element model id is not in $draggedElement data!",!0,!1);else{a=tdcIFrameData.getModel(a);var e=a.get("parentModel"),c=e.get("childCollection");if(b.isUndefined(a))new tdcNotice.notice("tdcRowHandlerUI -> tdcRowHandlerUI._$handlerClone Error: Element model not in structure data!",!0,!1);else{tdcOperationUI.setDraggedElement(f('<div class="tdc-row">Cloned row</div>'));
var m=tdcOperationUI.getDraggedElement();m.insertAfter(tdcRowHandlerUI.$elementRow);tdcRowUI.bindRow(m);var n=m.prevAll(".tdc-row").length,k=new tdcIFrameData.TdcModel({content:"",attrs:b.clone(a.get("attrs")),tag:"vc_row",type:"closed",level:1,parentModel:e});new tdcIFrameData.TdcLiveView({model:k,el:m[0]});var l=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:k});m.data("model_id",k.cid);c.add(k,{at:n});c=new tdcIFrameData.TdcCollection;c.add(l);
k.set("childCollection",c);l.set("childCollection",new tdcIFrameData.TdcCollection);document.dispatchEvent(new CustomEvent("tdc.modelCloned",{detail:{model:k,position:n,destination:e}}));k.getShortcodeRender(3,"",!0,a);tdcOperationUI.setDraggedElement(d);tb_remove()}}},[a],"Are you sure you want to clone the current row and all its elements?"),tdcRowHandlerUI._inCloneOperation=!1},deleteHandler:function(a){null!==a&&a.preventDefault();a.preventDefault();a.stopPropagation();tdConfirm.showModal("Delete row",
tdcRowHandlerUI,function(a){tdcOperationUI.setDraggedElement(tdcRowHandlerUI.$elementRow);tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);a=tdcOperationUI.getDraggedElement();var b=tdcAdminWrapperUI.$placeholder;a=a.closest(".tdc-elements");var e=a.children();b=e.index(b);if(-1===b&&1===e.length||2===e.length&&-1!==b)b="",tdcElementHandlerUI.$element.closest(".tdc-inner-column").length?b=" tdc-element-inner-column":tdcElementHandlerUI.$element.closest(".tdc-column").length&&(b=" tdc-element-column"),
b=f('<div class="'+tdcOperationUI._emptyElementClass+b+'"></div>'),tdcElementUI.bindEmptyElement(b),a.append(b);tdcIFrameData.changeData({$refEl:tdcOperationUI.getDraggedElement(),wasSidebarElementDragged:!1,wasElementDragged:!1,wasInnerColumnDragged:!1,wasInnerRowDragged:!1,wasTempInnerRowDragged:!1,wasColumnDragged:!1,wasRowDragged:!0,wasTempRowDragged:!1,draggedBlockUid:"",sourceColParam:null});tdcOperationUI.setDraggedElement(d);tdcOperationUI.setCurrentElementOver(d);tdcSidebarPanel.clearPanel();
...
(function(f,c,b,d){tdcColumnHandlerUI={_handlerId:"tdc-column",_handlerText:"Column",_handlerCssClass:"tdc-mask-column",$elementColumn:d,_$handlerWrapper:d,_isInitialized:!1,init:function(a){b.isUndefined(a)||!0!==a||(tdcColumnHandlerUI._isInitialized=!1);tdcColumnHandlerUI._isInitialized||"td-aib-style"===window.tdcPostSettings.loadDataFromPostType||(tdcMaskUI.$handlerStructure.find("#"+tdcColumnHandlerUI._handlerCssClass).length||(a=f('<div id="'+tdcColumnHandlerUI._handlerCssClass+'"><div class="tdc-mask-handler-drag" title="Column settings">'+
tdcColumnHandlerUI._handlerText+"</div></div>"),tdcColumnHandlerUI._$handlerWrapper=a,tdcMaskUI.$handlerStructure.append(a)),tdcColumnHandlerUI._$handlerWrapper.mousedown(function(a){1===a.which&&tdcColumnHandlerUI._triggerEvent(a)}).mouseup(function(a){tdcColumnHandlerUI._triggerEvent(a)}).mousemove(function(a){tdcMaskUI.show();tdcColumnHandlerUI._triggerEvent(a)}).mouseenter(function(a){tdcMaskUI.show();tdcColumnHandlerUI._triggerEvent(a)}).mouseleave(function(a){tdcColumnHandlerUI._triggerEvent(a)}).on("contextmousedown",
function(a){a.preventDefault();tdcContextMenu.setContextMenu(a,tdcColumnHandlerUI.$elementColumn)&&tdcColumnHandlerUI._triggerEvent(a)}),tdcColumnHandlerUI._$handlerWrapper.mouseenter(function(a){a.preventDefault();tdcMaskUI.setCurrentContainer(tdcColumnHandlerUI.$elementColumn);tdcMaskUI.show()}).mouseleave(function(a){a.preventDefault();tdcMaskUI.setCurrentContainer(d);tdcMaskUI.hide()}),tdcMaskUI.addHandler(tdcColumnHandlerUI._handlerId,tdcColumnHandlerUI),tdcColumnHandlerUI._isInitialized=!0)},
...
"td-aib-style"!==window.tdcPostSettings.loadDataFromPostType&&tdcMaskUI.$handlerStructure.append(tdcElementHandlerUI._$handlerWrapper)),tdcElementHandlerUI._$handlerDelete.click(function(a){tdcElementHandlerUI.deleteHandlerConfirm(a)}),tdcElementHandlerUI._$handlerClone.click(function(a){tdcElementHandlerUI.cloneHandler(a)}),tdcElementHandlerUI._$handlerWrapper.mousedown(function(a){1===a.which&&tdcElementHandlerUI._triggerEvent(a)}).mouseup(function(a){tdcElementHandlerUI._triggerEvent(a)}).mousemove(function(a){tdcMaskUI.show();
tdcElementHandlerUI._triggerEvent(a)}).mouseenter(function(a){a.preventDefault();tdcMaskUI.setCurrentElement(tdcElementHandlerUI.$element);tdcMaskUI.show()}).mouseleave(function(a){a.preventDefault();tdcMaskUI.setCurrentElement(d);tdcMaskUI.hide()}).on("contextmousedown",function(a){a.preventDefault();tdcContextMenu.setContextMenu(a,tdcElementHandlerUI.$element)&&tdcElementHandlerUI._triggerEvent(a)}),tdcMaskUI.addHandler(tdcElementHandlerUI._handlerId,tdcElementHandlerUI),tdcElementHandlerUI._isInitialized=
!0)},deleteHandlerConfirm:function(a){tdConfirm.showModal("Delete current element",tdcElementHandlerUI,function(a){tdcElementHandlerUI.deleteHandler(a);tb_remove()},[a],"Are you sure you want to delete this element?")},deleteHandler:function(a){null!==a&&a.preventDefault();"Delete"===a.key||f(a.target).hasClass("tdc-delete-shortcode")?tdcOperationUI.setDraggedElement(tdcOperationUI.getSelectedElement()):tdcOperationUI.setDraggedElement(tdcElementHandlerUI.$element);tdcOperationUI.setCurrentElementOver(tdcAdminWrapperUI.$recycle);
a=tdcOperationUI.getDraggedElement();var b=tdcAdminWrapperUI.$placeholder;a=a.closest(".tdc-elements");var c=a.children();b=c.index(b);if(-1===b&&1===c.length||2===c.length&&-1!==b)b="",tdcElementHandlerUI.$element.closest(".tdc-inner-column").length?b=" tdc-element-inner-column":tdcElementHandlerUI.$element.closest(".tdc-column").length&&(b=" tdc-element-column"),b=f('<div class="'+tdcOperationUI._emptyElementClass+b+'"></div>'),tdcElementUI.bindEmptyElement(b),a.append(b);tdcIFrameData.changeData({$refEl:tdcOperationUI.getDraggedElement(),
wasSidebarElementDragged:!1,wasElementDragged:!0,wasInnerColumnDragged:!1,wasInnerRowDragged:!1,wasTempInnerRowDragged:!1,wasColumnDragged:!1,wasRowDragged:!1,wasTempRowDragged:!1,draggedBlockUid:"",sourceColParam:null});tdcOperationUI.setDraggedElement(d);tdcOperationUI.setCurrentElementOver(d);tdcSidebarPanel.clearPanel()},cloneHandler:function(a){a.preventDefault();a.stopPropagation();a=tdcElementHandlerUI.$element.data("model_id");if(b.isUndefined(a))new tdcNotice.notice("tdcElementHandlerUI -> tdcElementHandlerUI._$handlerClone Error: Element model id is not in $draggedElement data!",
...
c=tdcShortcodeParser.parse(1,tdcUtil.b64DecodeUnicode(c));if(c.length!==p.length){new tdcNotice.notice("Errors happened in templateContent(content.length!==$tdcRows.length) during tdcIFrameData.TdcLiveView -> customRender!",!0,!1);return}a=tdcIFrameData.getFirstModelByZoneType("tdc_content");b.isUndefined(a)&&new tdcNotice.notice("Errors happened in templateContent during tdc_content zone!",!0,!1);k=a.get("childCollection");b.isUndefined(k)&&new tdcNotice.notice("Errors happened in templateContent during tdc_content childCollection!",
!0,!1);k=new tdcIFrameData.TdcCollection;a.set("childCollection",k);l={};b.each(c,function(b,c,e){tdcIFrameData._getData(a,b,l)});b.isEmpty(l)||(tdcDebug.log(l),new tdcNotice.notice("Errors happened in templateContent during tdcIFrameData.changeData() -> _getData()!",!0,!1));c={error:d,shortcode:d};tdcIFrameData.checkCurrentData(c);b.isUndefined(c.error)||(tdcDebug.log(c.error),new tdcNotice.notice(l,!0,!1));k=a.get("childCollection");if(p.length!==k.length){new tdcNotice.notice("Errors happened in templateContent during() tdcIFrameData.TdcLiveView -> customRender!",
!0,!1);return}r.$el.find(".tdc-row").each(function(a,c){var e=f(c);e.insertBefore(r.$el);a=k.at(a);new tdcIFrameData.TdcLiveView({model:a,el:c});var d=r.$el.prevAll().length;c=a.get("childCollection");k.add(a,{at:d});window.addRowWrappers(e);if(!0===tdcIFrameData._initNewContentStructureData(2,q,a)&&!b.isUndefined(c))if(d={},tdcIFrameData.bindViewsModelsWrappers(d,c,e,2),b.isEmpty(d))e.data("model_id",a.cid);else{for(var h in d)tdcDebug.log(d[h]);new tdcNotice.notice("Errors happened during tdcIFrameData.TdcLiveView -> customRender!",
!0,!1)}});a.set("childCollection",k);p=tdcOperationUI.inZone(r.$el);r.$el.remove();tdcIFrameData.removeModel(r.model);tdcZoneUI.init(e);tdcRowUI.init(e);tdcColumnUI.init(e);tdcInnerRowUI.init(e);tdcInnerColumnUI.init(e);tdcElementUI.init(e);tdcSidebar.setSettings({$currentZone:p,$currentRow:e},d,this.model);tdcIFrameData._callbackShortcodeRender(h)}}else if(this.$el.hasClass("tdc-row-temp")){if(a.has("templateContent")){c=tdcUtil.b64DecodeUnicode(a.get("templateContent"));e=this.$el.find(".tdc-row");
k=a.get("childCollection");a.set("type","closed");a.set("content",c);a.unset("shortcode",{silent:!0});a.unset("templateContent",{silent:!0});tdcShortcodeParser.init(tdcIFrameData._shortcodeParserSettingsClone);n=tdcShortcodeParser.parse(1,c);n.length&&(n=b.clone(n[0].shortcode.attrs.named),a.set("attrs",n));this.$el.removeClass("tdc-row-temp").addClass(e.attr("class"));this.$el.attr("id",e.attr("id"));this.$el.html(e.html());this.model.set("blockUid",e.attr("id"));window.addRowWrappers(this.$el);
...
!0,!1);var m=tdcIFrameData._getDestinationCol(a.$refEl);g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection);var n=g.get("childCollection");var k={},l=c.data("start-values"),p;"undefined"!==typeof l&&(l=JSON.parse(tdcUtil.b64DecodeUnicode(l)),"undefined"!==typeof l&&(b.isArray(l)&&l.length?(k=l[0],1<l.length&&(p=l)):k=l));l=c.data("shortcodeName");l=new tdcIFrameData.TdcModel({content:"",attrs:k,tag:l,type:"single",level:4,parentModel:g});new tdcIFrameData.TdcLiveView({model:l,
el:c[0]});b.isUndefined(p)||l.set("presetValues",p);tdcElementUI.bindElement(c);tdcRecycle.takeSnapshot(l.get("tag")+" : sidebar element added");c.data("model_id",l.cid);n.add(l,{at:h});l.set("parentModel",g);l.getShortcodeRender(m,a.draggedBlockUid,!0)}else if(a.wasTempInnerRowDragged)tdcRecycle.takeSnapshot("Sidebar inner-row added"),g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]),b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",
!0,!1),m=tdcIFrameData._getDestinationCol(a.$refEl),g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection),n=g.get("childCollection"),p=c.data("templateContent"),b.isUndefined(p)?(k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row_inner",type:"closed",level:3,parentModel:g}),new tdcIFrameData.TdcLiveView({model:k,el:c[0]}),l=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column_inner",type:"closed",level:4,parentModel:k}),c.data("model_id",k.cid),n.add(k,
{at:h}),p=new tdcIFrameData.TdcCollection,p.add(l),k.set("childCollection",p),p=new tdcIFrameData.TdcCollection,l.set("childCollection",p)):(k=new tdcIFrameData.TdcModel({templateContent:p,attrs:{},tag:"vc_row_inner",type:"template",level:3,parentModel:g}),new tdcIFrameData.TdcLiveView({model:k,el:c[0]}),l={},p=c.data("startValues"),"undefined"!==typeof p&&(l=JSON.parse(window.atob(p))),k.set({attrs:l}),c.data("model_id",k.cid),n.add(k,{at:h})),k.getShortcodeRender(m,a.draggedBlockUid,!0);else if(a.wasTempRowDragged)if(tdcRecycle.takeSnapshot("Sidebar row added"),
p=c.data("templateContent"),g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-zone"]),b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1),g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection),n=g.get("childCollection"),b.isUndefined(p)){var q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:g});new tdcIFrameData.TdcLiveView({model:q,el:c[0]});k=new tdcIFrameData.TdcModel({content:"",
attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q});c.data("model_id",q.cid);h=c.prevAll(".tdc-row").length;n.add(q,{at:h});var r=new tdcIFrameData.TdcCollection;r.add(k);q.set("childCollection",r);m=new tdcIFrameData.TdcCollection;k.set("childCollection",m);if(a.wasElementWithRowDragged){p={};r={};l=c.data("start-values");var t=c.data("row-start-values");"undefined"!==typeof t&&(r=JSON.parse(window.atob(t)));q.set({attrs:r});"undefined"!==typeof l&&(p=JSON.parse(window.atob(l)),b.isArray(p)&&
(p=p[0]));l=c.data("shortcodeName");l=new tdcIFrameData.TdcModel({content:"",attrs:p,tag:l,type:"single",level:3,parentModel:k});m.add(l);m=new tdcIFrameData.TdcCollection;l.set("childCollection",m)}document.dispatchEvent(new CustomEvent("tdc.newModelCreated",{detail:{model:q,position:h,destination:g}}));q.getShortcodeRender(1,a.draggedBlockUid,!0)}else l=c.data("shortcodeName"),b.isUndefined(l)||"tdc_zone"!==l?(q=new tdcIFrameData.TdcModel({templateContent:p,attrs:{},tag:"vc_row",type:"template",
level:1,parentModel:g}),new tdcIFrameData.TdcLiveView({model:q,el:c[0]}),h=c.prevAll(".tdc-row").length,c.data("model_id",q.cid),b.isUndefined(g)||(n.add(q,{at:h}),g.set("childCollection",n),q.set("childCollection",new tdcIFrameData.TdcCollection)),q.getShortcodeRender(1,a.draggedBlockUid,!0),document.dispatchEvent(new CustomEvent("tdc.newModelCreated",{detail:{model:q,position:h,destination:g}}))):(p=JSON.parse(window.atob(p)).reverse(),b.map(p,function(d,e){setTimeout(function(){console.log(e);
0!==e&&(c=f(c[0].outerHTML).insertBefore(c),c.html(""),c.addClass("tdc-dropped"));var m=new tdcIFrameData.TdcModel({templateContent:window.btoa(d),attrs:{},tag:"vc_row",type:"template",level:1,parentModel:g});new tdcIFrameData.TdcLiveView({model:m,el:c[0]});h=c.prevAll(".tdc-row").length;c.data("model_id",m.cid);b.isUndefined(g)||(n.add(m,{at:h}),g.set("childCollection",n),m.set("childCollection",new tdcIFrameData.TdcCollection));document.dispatchEvent(new CustomEvent("tdc.newModelCreated",{detail:{model:m,
position:h,destination:g}}));m.getShortcodeRender(1,a.draggedBlockUid,!0)},500+2E3*parseInt(e,10))}));else if(a.wasColumnDragged){if(tdcRecycle.takeSnapshot("Column copied"),p=c.data("templateContent"),!b.isUndefined(p)){l=c.data("model_id");if(b.isUndefined(l)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}k=tdcIFrameData.getModel(l);if(b.isUndefined(k)){new tdcNotice.notice("changeData Error: Column model not in structure data!",!0,!1);return}k.set("templateContent",
p);k.set("type","template");m=tdcIFrameData._getDestinationCol(a.$refEl);k.getShortcodeRender(m,a.draggedBlockUid,!0)}}else{if(a.wasInnerColumnDragged&&(tdcRecycle.takeSnapshot("Inner column copied"),p=c.data("templateContent"),!b.isUndefined(p))){m=c.data("model_id");if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Column model id is not in $refEl data!",!0,!1);return}l=tdcIFrameData.getModel(m);if(b.isUndefined(m)){new tdcNotice.notice("changeData Error: Column model not in structure data!",
!0,!1);return}l.set("templateContent",p);l.set("type","template");m=tdcIFrameData._getDestinationCol(a.$refEl);l.getShortcodeRender(m,a.draggedBlockUid,!0)}}else{l=c.data("model_id");if(b.isUndefined(l)){new tdcNotice.notice("changeData Error: Element model id is not in $refEl data!",!0,!1);return}l=tdcIFrameData.getModel(l);if(b.isUndefined(l)){new tdcNotice.notice("changeData Error: Element model not in structure data!",!0,!1);return}if(a.wasElementDragged){tdcDebug.log("case 1");if(tdcOperationUI.getCurrentElementOver()===
tdcAdminWrapperUI.$recycle){tdcDebug.log("element recycled");tdcIFrameData.removeModel(l);tdcRecycle.takeSnapshot(l.get("tag")+" : element recycled");return}tdcRecycle.takeSnapshot(l.get("tag")+" : element moved");p=l.get("parentModel");g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-inner-column",".tdc-column"]);b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);p.cid===g.cid?(m=p.get("childCollection"),m.remove(l,{silent:!0}),m.add(l,
{at:h})):(m=tdcIFrameData._getDestinationCol(a.$refEl),g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection),n=g.get("childCollection"),tdcIFrameData.removeModel(l,!1,{silent:!0}),n.add(l,{at:h}),l.set("parentModel",g),a.sourceColParam!==m&&l.getShortcodeRender(m,a.draggedBlockUid,!0));tdcRecycle.takeSnapshot(l.get("tag")+" : element moved")}else if(a.wasInnerRowDragged){tdcDebug.log("case 2");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){tdcDebug.log("inner row recycled");
tdcIFrameData.removeModel(l);tdcRecycle.takeSnapshot("Inner row recycled");return}tdcRecycle.takeSnapshot("Inner row moved");p=l.get("parentModel");g=tdcIFrameData._getDestinationModel(a.$refEl,[".tdc-column"]);b.isUndefined(g)&&new tdcNotice.notice("changeData Error: Destination model not in structure data!",!0,!1);if(p.cid===g.cid)m=p.get("childCollection"),m.remove(l,{silent:!0}),m.add(l,{at:h});else{g.has("childCollection")||g.set("childCollection",new tdcIFrameData.TdcCollection);n=g.get("childCollection");
tdcIFrameData.removeModel(l,!0,{silent:!0});n.add(l,{at:h});l.set("parentModel",g);p=p.get("attrs");r=g.get("attrs");if(b.has(p,"width"))switch(p.width){case "1/3":m="13";break;case "2/3":m="23"}if(b.has(r,"width"))switch(r.width){case "1/3":k="13";break;case "2/3":k="23"}b.isUndefined(m)&&(m="11");b.isUndefined(k)&&(k="11");if(m!==k&&(p=l.get("childCollection"),!b.isUndefined(p))){p=tdcIFrameData.getChildCollectionWidths(p);b.isUndefined(p)&&(p="11");r="11";t=1;switch(k){case "11":switch(p){case "11":r=
"11";break;case "23_13":r="23_13";break;case "13_23":r="13_23";break;case "12_12":r="13_13_13";break;case "13_13_13":r="13_13_13"}t=3;break;case "13":switch(p){case "11":r="11";break;case "23_13":r="11";break;case "13_23":r="11";break;case "12_12":r="11";break;case "13_13_13":r="11"}break;case "23":switch(p){case "11":r="12_12";break;case "23_13":r="12_12";break;case "13_23":r="12_12";break;case "12_12":r="12_12";break;case "13_13_13":r="12_12"}t=2}if(p!==r||m!==k)tdcIFrameData.changeInnerRowModel(l,
p,r),l.getShortcodeRender(t,null,!0)}m=tdcOperationUI.inZone(c);k=tdcOperationUI.inRow(c);p=tdcOperationUI.inColumn(c);r=tdcOperationUI.inInnerRow(c);b.isUndefined(m)||b.isUndefined(k)||b.isUndefined(p)||b.isUndefined(r)||tdcSidebar.setSettings({$currentZone:m,$currentRow:k,$currentColumn:p,$currentInnerRow:r},!0)}tdcRecycle.takeSnapshot(l.get("tag")+" : inner row moved")}else if(a.wasInnerColumnDragged||a.wasColumnDragged)tdcDebug.log("case 3"),p=l.get("parentModel"),m=p.get("childCollection"),m.remove(l,
{silent:!0}),m.add(l,{at:h}),a.wasColumnDragged?(m=tdcOperationUI.inZone(c),k=tdcOperationUI.inRow(c),b.isUndefined(k)||b.isUndefined(m)||tdcSidebar.setSettings({$currentZone:m,$currentRow:k}),tdcRecycle.takeSnapshot("Column moved")):a.wasInnerColumnDragged&&(m=tdcOperationUI.inZone(c),k=tdcOperationUI.inRow(c),p=tdcOperationUI.inColumn(c),r=tdcOperationUI.inInnerRow(c),b.isUndefined(m)||b.isUndefined(k)||b.isUndefined(p)||b.isUndefined(r)||tdcSidebar.setSettings({$currentZone:m,$currentRow:k,$currentColumn:p,
$currentInnerRow:r}),tdcRecycle.takeSnapshot("Inner-column moved"));else if(a.wasRowDragged){tdcDebug.log("case 4");p=l.get("parentModel");k=p.get("blockUid");m=p.get("childCollection");if(tdcOperationUI.getCurrentElementOver()===tdcAdminWrapperUI.$recycle){m.remove(l);tdcDebug.log("row recycled");tdcRecycle.takeSnapshot("Row recycled");m.length||(q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:p}),new tdcIFrameData.TdcLiveView({model:q,el:tdcIFrameData.iframeContents.find("#"+
k+" .tdc_zone")[0]}),k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q}),m.add(q,{at:0}),r=new tdcIFrameData.TdcCollection,r.add(k),q.set("childCollection",r),k.set("childCollection",new tdcIFrameData.TdcCollection),q.getShortcodeRender(1,a.draggedBlockUid,!0),document.dispatchEvent(new CustomEvent("tdc.newModelCreated",{detail:{model:q,position:0,destination:p}})));document.dispatchEvent(new CustomEvent("tdc.modelDeleted",{detail:{model:l,source:p}}));
return}h=c.prevAll(".tdc-row").length;r=c.closest(".tdc-zone").data("model_id");g=tdcIFrameData.getModel(r);n=m;p.cid!==r&&(n=g.get("childCollection"),g.set("childCollection",n),l.set("parentModel",g));m.remove(l,{silent:!0});n.add(l,{at:h});tdcSidebar.setSettings({$currentZone:tdcOperationUI.inZone(c)});m.length||(q=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_row",type:"closed",level:1,parentModel:p}),new tdcIFrameData.TdcLiveView({model:q,el:tdcIFrameData.iframeContents.find("#"+k+" .tdc_zone")[0]}),
k=new tdcIFrameData.TdcModel({content:"",attrs:{},tag:"vc_column",type:"closed",level:2,parentModel:q}),m.add(q,{at:0}),r=new tdcIFrameData.TdcCollection,r.add(k),q.set("childCollection",r),k.set("childCollection",new tdcIFrameData.TdcCollection),setTimeout(function(){q.getShortcodeRender(1,d,!0)},200));p.set("childCollection",m);tdcRecycle.takeSnapshot("Row moved");tdcDebug.log("newPosition: "+h);tdcDebug.log(c);document.dispatchEvent(new CustomEvent("tdc.modelPositionChanged",{detail:{model:l,newPosition:h,
source:p,destination:g}}))}}tdcDebug.log(tdcIFrameData.tdcTopCollection)}},_parseModelWidthAttrs:function(a){a=a.get("attrs");var c=3;if(b.has(a,"width"))switch(a.width){case "1/3":c=1;break;case "2/3":c=2;break;case "1/2":c=1}return c},getColumnNumber:function(a){var c=3,d=parseInt(a.get("level"),10),g=a.get("parentModel");b.isUndefined(g)||(4===d?(a=tdcIFrameData._parseModelWidthAttrs(g),c=3===a?tdcIFrameData.getColumnNumber(g):a):(a=tdcIFrameData._parseModelWidthAttrs(a),c=3===a?tdcIFrameData.getColumnNumber(g):
a));return c},_getDestinationModel:function(a,c){for(var d,e=0;e<c.length&&(d=a.closest(c[e]),!d.length);e++);d.length||new tdcNotice.notice("_getDestinationModel Error: Container destination not available!",!0,!1);a=d.data("model_id");b.isUndefined(a)&&new tdcNotice.notice("_getDestinationModel Error: Model id of the container destination not in data!",!0,!1);a=tdcIFrameData.getModel(a);b.isUndefined(a)&&new tdcNotice.notice("_getDestinationModel Error: Model not in structure data!",!0,!1);return a},
...
new tdcNotice.notice("_getDestinationCol Error: The column model id not in data!",!0,!1),a=tdcIFrameData.getModel(c),b.isUndefined(c)&&new tdcNotice.notice("_getDestinationCol Error: Tne column model not in structure data!",!0,!1),a=tdcIFrameData._parseModelWidthAttrs(a);new tdcNotice.notice("_getDestinationCol Error: The destination container is not inside of .tdc-column !",!0,!1)},_getSourceCol:function(a){var c=a.closest(".tdc-column");a=a.closest(".tdc-inner-column");if(a.length&&(a=a.data("model_id"),
b.isUndefined(a)&&new tdcNotice.notice("_getSourceCol Error: The inner column model id not in data!",!0,!1),a=tdcIFrameData.getModel(a),b.isUndefined(a)&&new tdcNotice.notice("_getSourceCol Error: The inner column model not in structure data!",!0,!1),a=tdcIFrameData._parseModelWidthAttrs(a),3!==a))return a;if(c.length)return c=c.data("model_id"),b.isUndefined(c)&&new tdcNotice.notice("_getSourceCol Error: The column model id not in data!",!0,!1),a=tdcIFrameData.getModel(c),b.isUndefined(c)&&new tdcNotice.notice("_getSourceCol Error: Tne column model not in structure data!",
!0,!1),a=tdcIFrameData._parseModelWidthAttrs(a)},getShortcodeFromData:function(a){a.getShortcode="";var b=tdcIFrameData.getFirstModelByZoneType("tdc_content");tdcIFrameData._checkModelData(b,a)},getHeaderShortcodeFromData:function(){var a={};"Newspaper"===window.tdcAdminSettings.themeName&&["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile","tdc_header_mobile_sticky"].forEach(function(c){var e={error:d,getShortcode:""},g=tdcIFrameData.getFirstModelByZoneType(c);tdcIFrameData._checkModelData(g,
e);b.isUndefined(e.error)?b.isUndefined(e.getShortcode)?delete a[c]:a[c]=e.getShortcode:new tdcNotice.notice(e.errors,!0,!1)});if(!b.isEmpty(a))return a.tdc_is_header_sticky=tdcState.isHeaderSticky(),a.tdc_is_mobile_header_sticky=tdcState.isMobileHeaderSticky(),a},getFooterShortcodeFromData:function(){var a={};if("Newspaper"===window.tdcAdminSettings.themeName){var c={error:d,getShortcode:""},h=tdcIFrameData.getFirstModelByZoneType("tdc_footer");tdcIFrameData._checkModelData(h,c);if(!b.isUndefined(c.error)){new tdcNotice.notice(c.errors,
!0,!1);return}b.isUndefined(c.getShortcode)||(a=c.getShortcode)}if(!b.isEmpty(a))return a},bindViewsModelsWrappers:function(a,c,d,g){if(b.isEmpty(a)&&(b.isUndefined(g)&&(g=0),!b.isUndefined(c))){var e=[];switch(g){case 0:var h=[];d.find(".tdc-zone").each(function(){var a=f(this);a.parents(".menu-item").length||h.push(a)});if(c.models.length!==h.length){a[b.keys(a).length]={collection:c,jqDOMElements:h,info:"Error at zones: "+c.models.length+"(models) : "+h.length+"(dom)"};return}g++;b.each(h,function(b,
c,d){c=f(b);d=c.data("type");d=tdcIFrameData.getFirstModelByZoneType(d);c.data("model_id",d.cid);d.set("blockUid",c.attr("id"));d.set("html",b.innerHTML);new tdcIFrameData.TdcLiveView({model:d,el:b});d.has("childCollection")&&tdcIFrameData.bindViewsModelsWrappers(a,d.get("childCollection"),c,g)});g--;return;case 1:d.find(".tdc-row").each(function(){var a=f(this);a.parents(".menu-item").length||e.push(a)});if(c.models.length!==e.length){a[b.keys(a).length]={collection:c,jqDOMElements:e,info:"Error at rows: "+
c.models.length+"(models) : "+e.length+"(dom)"};return}break;case 2:d.find(".tdc-columns:first").children(".tdc-column").each(function(){var a=f(this);a.parents(".menu-item").length||e.push(a)});if(c.models.length!==e.length){a[b.keys(a).length]={collection:c,jqDOMElements:e,info:"Errors at columns: "+c.models.length+"(models) : "+e.length+"(dom)",level:g};return}break;case 3:d.find(".tdc-elements:first").children(".tdc-element, .tdc-element-inner-row").each(function(){var a=f(this);a.parents(".menu-item").length||
e.push(a)});if(c.models.length!==e.length){a[b.keys(a).length]={collection:c,jqDOMElements:e,info:"Errors at columns elements: "+c.models.length+"(models) : "+e.length+"(dom)",level:g};return}break;case 4:d.find(".tdc-inner-columns:first").children(".tdc-inner-column").each(function(){var a=f(this);a.parents(".menu-item").length||e.push(a)});if(c.models.length!==e.length){a[b.keys(a).length]={collection:c,jqDOMElements:e,info:"Errors at inner columns: "+c.models.length+"(models) : "+e.length+"(dom)",
level:g};return}break;case 5:if(d.find(".tdc-elements:first").children(".tdc-element").each(function(){var a=f(this);a.parents(".menu-item").length||e.push(a)}),c.models.length!==e.length){a[b.keys(a).length]={collection:c,jqDOMElements:e,info:"Errors at elements: "+c.models.length+"(models) : "+e.length+"(dom)",level:g};return}}g++;b.each(e,function(d,e,h){e=c.models[e];h=f(d);h.data("model_id",e.cid);e.set("html",d.innerHTML,{silent:!0});if(5===e.get("level")){var m=h.data("td-block-uid");if(b.isUndefined(m)){var k=
h.find(".td_block_inner, .tdb-block-inner, .td-post-sharing");k.length&&(m=k.attr("id"))}}else 3===e.get("level")?(k=h.find(".tdc-inner-row"),k.length&&(m=k.attr("id"))):1===e.get("level")&&(m=h.attr("id"));e.set("blockUid",m);new tdcIFrameData.TdcLiveView({model:e,el:d});!h.hasClass("tdc-element")&&e.has("childCollection")&&0<b.size(e.get("childCollection"))&&tdcIFrameData.bindViewsModelsWrappers(a,e.get("childCollection"),h,g)});g--}},changeRowModel:function(a,c,d){var e=a.get("childCollection");
if("11"===c&&("23_13"===d||"13_23"===d||"13_13_13"===d)){d=d.split("_");var h=d[0].charAt(0)+"/"+d[0].charAt(1),n=e.at(0),k=n.get("attrs");b.isUndefined(k)?n.set("attrs",{width:h}):(k=b.clone(k),k.width=h,n.set("attrs",k));e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:d[1].charAt(0)+"/"+d[1].charAt(1)},type:"closed",level:1,parentModel:a}));3===d.length&&e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:d[2].charAt(0)+"/"+d[2].charAt(1)},type:"closed",
level:1,parentModel:a}));tdcIFrameData.changeColumnModel(n,c,d[0])}else if(("23_13"===c||"13_23"===c||"13_13_13"===c)&&"11"===d){c=c.split("_");n=e.at(0);k=n.get("attrs");var f=n.get("childCollection"),p=e.at(1),q=p.get("childCollection");b.isUndefined(k)||(k=b.clone(k),delete k.width,n.set("attrs",k));b.isUndefined(f)&&(f=new tdcIFrameData.TdcCollection,n.set("childCollection",f));!b.isUndefined(q)&&q.length&&b.each(q.models,function(a,b,c){a.set("parentModel",n);f.add(a)});3===c.length&&(a=e.at(2),
e=a.get("childCollection"),!b.isUndefined(e)&&e.length&&b.each(e.models,function(a,b,c){a.set("parentModel",n);f.add(a)}),tdcIFrameData.removeModel(a));tdcIFrameData.removeModel(p);tdcIFrameData.changeColumnModel(n,c[0],d)}else if(!("23_13"!==c&&"13_23"!==c&&"13_13_13"!==c||"23_13"!==d&&"13_23"!==d&&"13_13_13"!==d)){c=c.split("_");d=d.split("_");h=d[0].charAt(0)+"/"+d[0].charAt(1);var r=d[1].charAt(0)+"/"+d[1].charAt(1);n=e.at(0);k=n.get("attrs");p=e.at(1);var t=p.get("attrs");q=p.get("childCollection");
3===d.length?e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:d[2].charAt(0)+"/"+d[2].charAt(1)},type:"closed",level:1,parentModel:a})):3===c.length&&(a=e.at(2),e=a.get("childCollection"),!b.isUndefined(e)&&e.length&&(b.isUndefined(q)&&(q=new tdcIFrameData.TdcCollection,p.set("childCollection",q)),b.each(e.models,function(a,b,c){a.set("parentModel",p);q.add(a)})),tdcIFrameData.removeModel(a));k=b.clone(k);k.width=h;n.set("attrs",k);c[0]!==d[0]&&tdcIFrameData.changeColumnModel(n,
c[0],d[0]);h=b.clone(t);h.width=r;p.set("attrs",h);c[1]!==d[1]&&tdcIFrameData.changeColumnModel(p,c[1],d[1])}tdcDebug.log(tdcIFrameData.tdcTopCollection.models)},changeFluidStructureModel:function(a,c,d){var e=a.get("childCollection"),h=a.get("tag"),n="vc_column";c=c.split("_");var k=d.split("_");if("vc_row"===h||"vc_row_inner"===h){"vc_row_inner"===h&&(n="vc_column_inner");if(k.length>c.length)for(h=0;h<k.length;h++){d="";for(var f=0;f<k[h].length;f++)d+=k[h].charAt(f)+"/";""!==d&&(d=d.substring(0,
d.length-1));if(h<c.length){var p=e.at(h);f=p.get("attrs");var q=b.clone(f);q.width=d;p.set("attrs",q)}else e.add(new tdcIFrameData.TdcModel({content:"",tag:n,attrs:{width:d},type:"closed",level:1,parentModel:a}))}else for(h=0;h<c.length;h++)if(h<k.length){p=e.at(h);f=p.get("attrs");q=b.clone(f);d="";for(f=0;f<k[h].length;f++)d+=k[h].charAt(f)+"/";""!==d&&(d=d.substring(0,d.length-1));q.width=d;p.set("attrs",q);var r=p}else{p=e.at(k.length);a=p.get("childCollection");var t=r.get("childCollection");
b.isUndefined(t)&&(t=new tdcIFrameData.TdcCollection,r.set("childCollection",t));b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",r);t.add(a)});tdcIFrameData.removeModel(p)}tdcDebug.log(tdcIFrameData.tdcTopCollection.models)}},changeColumnModel:function(a,c,d){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(d))){var e=a.get("childCollection");if(!b.isUndefined(e)&&e.length){var h=a.get("attrs");!b.isUndefined(h)&&b.has(h,"width");b.each(e.models,function(e,h,g){if("vc_row_inner"===
e.get("tag")&&(e=e.get("childCollection"),!b.isUndefined(e)&&e.length)){var m="";b.each(e.models,function(a,c,d){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(m=c===d.length-1?m+a.width:m+(a.width+"_"))});m=m.replace(/\//g,"");"12_12"!==m&&"23_13"!==m&&"13_23"!==m&&"13_13_13"!==m&&(m="");if("11"===c)if("23"===d)if("23_13"===m){var k=e.at(0),f=e.at(1);g=k.get("attrs");h=f.get("attrs");g=b.clone(g);h=b.clone(h);g.width="1/2";h.width="1/2";k.set("attrs",g);f.set("attrs",h)}else if("13_23"===
m)k=e.at(0),f=e.at(1),g=k.get("attrs"),h=f.get("attrs"),g=b.clone(g),h=b.clone(h),g.width="1/2",h.width="1/2",k.set("attrs",g),f.set("attrs",h);else if("13_13_13"===m){k=e.at(0);f=e.at(1);e=e.at(2);g=k.get("attrs");h=f.get("attrs");var n=e.get("attrs");g=b.clone(g);h=b.clone(h);b.clone(n);g.width="1/2";h.width="1/2";k.set("attrs",g);f.set("attrs",h);h=e.get("childCollection");if(!b.isUndefined(h)&&h.length){var l=f.get("childCollection");b.isUndefined(l)&&(l=new tdcIFrameData.TdcCollection,f.set("childCollection",
l));b.each(h.models,function(a,b,c){l.add(a);a.set("parentModel",f)})}tdcIFrameData.removeModel(e)}else{if(e.models.length){k=e.at(0);g=k.get("attrs");g=b.clone(g);var u=k.get("childCollection");delete g.width;k.set("attrs",g);b.isUndefined(u)&&(u=new tdcIFrameData.TdcCollection,k.set("childCollection",u));var x=0;for(b.each(e.models,function(a,c,d){0!==c&&(x=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);u.add(a)}))});0<x;)tdcIFrameData.removeModel(e.at(x)),
x--}}else{if("13"===d&&e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),u=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(u)&&(u=new tdcIFrameData.TdcCollection,k.set("childCollection",u)),x=0,b.each(e.models,function(a,c,d){0!==c&&(x=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);u.add(a)}))});0<x;)tdcIFrameData.removeModel(e.at(x)),x--}else if("23"===c)if("11"===d)if("12_12"===m)k=e.at(0),f=e.at(1),g=k.get("attrs"),
h=f.get("attrs"),g=b.clone(g),h=b.clone(h),g.width="1/3",h.width="1/3",k.set("attrs",g),f.set("attrs",h),h=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,parentModel:a}),e.add(h);else{if(e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),u=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(u)&&(u=new tdcIFrameData.TdcCollection,k.set("childCollection",u)),x=0,b.each(e.models,function(a,c,d){0!==c&&(x=c,a=a.get("childCollection"),
b.isUndefined(a)||b.each(a.models,function(a){a.set("parentModel",k);u.add(a)}))});0<x;)tdcIFrameData.removeModel(e.at(x)),x--}else{if("13"===d&&e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),u=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(u)&&(u=new tdcIFrameData.TdcCollection,k.set("childCollection",u)),x=0,b.each(e.models,function(a,c,d){0!==c&&(x=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);u.add(a)}))});0<
x;)tdcIFrameData.removeModel(e.at(x)),x--}else if("13"===c)if("11"===d)if(""===m||"12_12"!==m&&"23_13"!==m&&"13_23"!==m&&"13_13_13"!==m){if(e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),u=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(u)&&(u=new tdcIFrameData.TdcCollection,k.set("childCollection",u)),x=0,b.each(e.models,function(a,c,d){0!==c&&(x=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);u.add(a)}))});0<
x;)tdcIFrameData.removeModel(e.at(x)),x--}else"12_12"===m&&e.models.length&&(k=e.at(0),f=e.at(1),g=k.get("attrs"),h=f.get("attrs"),g.width="1/3",h.width="1/3",k.set("attrs",g),f.set("attrs",h),e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===d&&(""===m||"12_12"!==m)&&e.models.length)for(k=e.at(0),g=k.get("attrs"),g=b.clone(g),u=k.get("childCollection"),delete g.width,k.set("attrs",g),b.isUndefined(u)&&(u=
new tdcIFrameData.TdcCollection,k.set("childCollection",u)),x=0,b.each(e.models,function(a,c,d){0!==c&&(x=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,b,c){a.set("parentModel",k);u.add(a)}))});0<x;)tdcIFrameData.removeModel(e.at(x)),x--}})}}},changeInnerRowModel:function(a,c,d){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(d))){var e=a.get("childCollection");if("11"!==c||"12_12"!==d&&"23_13"!==d&&"13_23"!==d&&"13_13_13"!==d)if("12_12"!==c&&"23_13"!==c&&"13_23"!==
c||"11"!==d&&"12_12"!==d&&"23_13"!==d&&"13_23"!==d&&"13_13_13"!==d)"13_13_13"!==c||"11"!==d&&"12_12"!==d&&"23_13"!==d&&"13_23"!==d?tdcIFrameData.changeFluidStructureModel(a,c,d):("11"===d?(q=e.at(0),r=q.get("attrs"),h=q.get("childCollection"),k=e.at(1),f=k.get("childCollection"),a=e.at(2),e=a.get("childCollection"),b.isUndefined(r)||(r=b.clone(r),delete r.width,q.set("attrs",r)),b.isUndefined(h)&&(h=new tdcIFrameData.TdcCollection,q.set("childCollection",h)),!b.isUndefined(f)&&f.length&&b.each(f.models,
function(a,b,c){a.set("parentModel",q);h.add(a)}),!b.isUndefined(e)&&e.length&&b.each(e.models,function(a,b,c){a.set("parentModel",q);h.add(a)}),tdcIFrameData.removeModel(k)):(l=d.split("_"),p=l[0].charAt(0)+"/"+l[0].charAt(1),c=l[1].charAt(0)+"/"+l[1].charAt(1),q=e.at(0),r=q.get("attrs"),k=e.at(1),d=k.get("attrs"),f=k.get("childCollection"),a=e.at(2),e=a.get("childCollection"),r=b.clone(r),r.width=p,q.set("attrs",r),d=b.clone(d),d.width=c,k.set("attrs",d),b.isUndefined(f)&&(f=new tdcIFrameData.TdcCollection,
k.set("childCollection",f)),!b.isUndefined(e)&&e.length&&b.each(e.models,function(a,b,c){a.set("parentModel",k);f.add(a)})),tdcIFrameData.removeModel(a));else if("11"===d){q=e.at(0);r=q.get("attrs");var h=q.get("childCollection");k=e.at(1);var f=k.get("childCollection");b.isUndefined(r)||(r=b.clone(r),delete r.width,q.set("attrs",r));b.isUndefined(h)&&(h=new tdcIFrameData.TdcCollection,q.set("childCollection",h));!b.isUndefined(f)&&f.length&&b.each(f.models,function(a,b,c){a.set("parentModel",q);
h.add(a)});tdcIFrameData.removeModel(k)}else l=d.split("_"),p=l[0].charAt(0)+"/"+l[0].charAt(1),c=l[1].charAt(0)+"/"+l[1].charAt(1),q=e.at(0),r=q.get("attrs"),k=e.at(1),d=k.get("attrs"),r=b.clone(r),r.width=p,q.set("attrs",r),d=b.clone(d),d.width=c,k.set("attrs",d),3===l.length&&e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:l[2].charAt(0)+"/"+l[2].charAt(1)},type:"closed",level:3,parentModel:a}));else{var k=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",
type:"closed",level:3,parentModel:a}),l=d.split("_"),p=l[0].charAt(0)+"/"+l[0].charAt(1);c=l[1].charAt(0)+"/"+l[1].charAt(1);var q=e.at(0),r=q.get("attrs");b.isUndefined(r)?q.set("attrs",{width:p}):(r=b.clone(r),r.width=p,q.set("attrs",r));k.set("attrs",{width:c});e.add(k);3===l.length&&e.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:l[2].charAt(0)+"/"+l[2].charAt(1)},type:"closed",level:3,parentModel:a}))}}},getChildCollectionWidths:function(a){if(!b.isUndefined(a)){var c;
b.map(a.models,function(a,d){a=a.get("attrs");b.has(a,"width")&&(c=b.isUndefined(c)?a.width.replace("/",""):c+("_"+a.width.replace("/","")))});return c}}}})(jQuery,Backbone,_);var tdcAdminIFrameUI;
...
function(b){var c=jQuery(this),a=c.closest(".tdc-property-responsive"),e=a.find('input[type="range"]'),h=a.find('input[type="radio"]:checked'),g=a.find('input[type="text"]'),m=e.get(0),f="",k=h.data("default_value"),l=tdcIFrameData.getModel(e.data("model_id")),p=e.data("param_name"),q=window.tdcAdminSettings.mappedShortcodes[l.attributes.tag],r=l="";var t=[];for(var v=0;v<q.params.length;v++)if(p===q.params[v].param_name){v=q.params[v].tdc_values;for(var u in v)v.hasOwnProperty(u)&&(t.push(v[u].unit),
""===l||""===r)&&(l=v[u].value,r=v[u].unit);break}h.length&&(f=h.data("unit_value"));if("range"===c.attr("type"))t=e.val(),g.val(t),h.data("last_value",t),g.val(t),e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),t+f,tdcSidebar.currentViewportSettings.name)),a.removeClass("tdc-css-inherited");else if("text"===c.attr("type")){if("input"===b.type||"change"===b.type)return;a.removeClass("tdc-css-inherited");t=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
t||_.isUndefined(k)||""===k?(e.val(t),h.data("last_value",t),e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),t+f,tdcSidebar.currentViewportSettings.name))):(e.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),e.data("range_value",l),e.data("range_unit",r),e.val(l),f=a.find('input[type="radio"][data-unit_value="'+r+'"]'),q=f.data("unit"),u=e.data("min_"+q),h=e.data("max_"+q),q=e.data("step_"+q),f.prop("checked",
!0),m.min=u,m.max=h,m.step=q,m.value=l,f.data("last_value",l),g.val(l));else if(""===t)if(f=tdcSidebarPanel.getCurrentResponsiveValue(e.attr("name"),"all"),"undefined"===typeof f)e.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name)),e.data("range_value",l),e.data("range_unit",r),e.val(l),f=a.find('input[type="radio"][data-unit_value="'+r+'"]'),q=f.data("unit"),u=e.data("min_"+q),h=e.data("max_"+q),q=e.data("step_"+q),f.prop("checked",
!0),m.min=u,m.max=h,m.step=q,m.value=l,f.data("last_value",l),g.val(l),a.addClass("tdc-css-inherited");else for(v=0;v<q.params.length;v++){if(p===q.params[v].param_name){t=[];g=[];v=q.params[v].tdc_values;for(u in v)v.hasOwnProperty(u)&&t.push(v[u].unit);for(v=0;v<t.length&&!(g=f.split(t[v]),1<g.length);v++);g.length&&(l=g[0],r=t[v],e.data("range_value",l),e.data("range_unit",r),f=a.find('input[type="radio"][data-unit_value="'+r+'"]'),q=f.data("unit"),u=e.data("min_"+q),h=e.data("max_"+q),q=e.data("step_"+
q),f.prop("checked",!0),m.min=u,m.max=h,m.step=q,m.value=l,f.data("last_value",l),a.find('input[type="text"]').val(l));e.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+p,tdcSidebar.currentViewportSettings.name));a.addClass("tdc-css-inherited");break}}else e.val(t),h.data("last_value",t),e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),t+f,tdcSidebar.currentViewportSettings.name))}else if("radio"===c.attr("type")){if("input"===b.type)return;
p=h.data("last_value");q=h.data("unit");u=e.data("min_"+q);h=e.data("max_"+q);q=e.data("step_"+q);m.min=u;m.max=h;m.step=q;""===p?(g.val(k),e.val(k),t=k):(g.val(p),e.val(p),t=p);e.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(e.attr("name"),t+f,tdcSidebar.currentViewportSettings.name));a.removeClass("tdc-css-inherited")}f="";a=jQuery(m).parent().find('input[type="radio"]:checked');a.length&&(f=jQuery(a[0]).data("unit_value"));"focusin"===b.type?m.oldValue=m.value+f:(a=jQuery(m),
...
function(){var b=jQuery('.tdc-fs-link-post-toggle input[type="checkbox"]');b.length&&tdcSidebarPanel.toggleEnableFSLinkPostParams(b)});c.on("change",'.tdc-fs-link-post-toggle input[type="checkbox"]',function(){tdcSidebarPanel.toggleEnableFSLinkPostParams(jQuery(this))});c.on("change",".tdc-block-sort select",function(){tdcSidebarPanel.toggleEnableBlockSortParams(jQuery(this))});c.on("change",'[data-tag="tdb_single_custom_field"] [data-param_name="acf_field"]',function(){tdcSidebarPanel.toggleEnableCFParams(jQuery(this))});
c.on("mousedown",function(b){var c=jQuery("#tdc-sidebar"),a=jQuery("#tdc-icon-selector"),e=jQuery("#tdc-gradient"),h=jQuery("#tdc-palette"),g=jQuery("#tdc-font-list"),m=jQuery(".tdc-preset-values-list");a.length?a.get(0).contains(b.target)||(a.hide(),c.after(a)):a=tdcSidebar.buildIconSelector();e.length?e.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-gradient-wrap")||(e.hide(),c.after(e))):e=tdcSidebar.buildGradient();h.length?h.get(0).contains(b.target)||(a=jQuery(b.target),a.hasClass("tdc-colorpicker-wrap")||
(h.hide(),c.after(h),h.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):h=tdcSidebar.buildPalette();g.length&&!g.get(0).contains(b.target)&&(g.hide(),c.after(g));!m.length||m.get(0).contains(b.target)||jQuery(".tdc-preset-values").get(0).contains(b.target)?m.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(b.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),
$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0)},100):m.is(":visible")&&(m.hide(),c=jQuery(b.target),jQuery(".tdc-top-buttons").get(0).contains(b.target)||c.hasClass("tdc-top-buttons")||jQuery(".tdc-sidebar-bottom").get(0).contains(b.target)||c.hasClass("tdc-sidebar-bottom")||jQuery(".tdc-current-element-head").get(0).contains(b.target)||c.hasClass("tdc-current-element-head")?jQuery(".tdc-current-element-head").get(0).contains(b.target)||
c.hasClass("tdc-current-element-head")?(tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),$currentInnerRow:tdcSidebar.getCurrentInnerRow(),$currentInnerColumn:tdcSidebar.getCurrentInnerColumn(),$currentElement:tdcSidebar.getCurrentElement()},!0),jQuery(".tdc-current-element-head").trigger(b)):tdcSidebarPanel.clearPanel():setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),
...
jQuery(this);-1===a.data("font_class").indexOf(c)?a.hide():a.show()})})});c.on("change keyup focus",".tdc-tab-no-design .tdc-property-colorpicker input",function(b){if("focusin"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var c=tdcIFrameData.getModel(jQuery(this).data("model_id"));tdcSidebarController.onUpdate(c,jQuery(this).data("param_name"),this.oldValue,b);this.oldValue=b}});c.on("change",".tdc-tab-no-design .tdc-property-gradient input",function(b){b=jQuery(this).val();var c=
tdcIFrameData.getModel(jQuery(this).data("model_id"));tdcSidebarController.onUpdate(c,jQuery(this).data("param_name"),this.oldValue,b);this.oldValue=b});c.on("change",".tdc-tab-no-design .tdc-row-col-dropdown input.tdc-property-input-radio",function(b){"undefined"!==typeof tdcSidebarPanel.timerChangingColumns&&clearTimeout(tdcSidebarPanel.timerChangingColumns);var c=jQuery(this);tdcSidebarPanel.timerChangingColumns=setTimeout(function(){var a=c.val(),b=tdcSidebar.getCurrentRow().data("model_id");
b=tdcIFrameData.getModel(b);var d=b.get("childCollection");this.oldValue="11";_.isUndefined(d)||(d=tdcIFrameData.getChildCollectionWidths(d),_.isUndefined(d)||(this.oldValue=d));"11"===this.oldValue&&("23_13"===a||"13_23"===a||"13_13_13"===a)||"23_13"===this.oldValue&&("11"===a||"13_23"===a||"13_13_13"===a)||"13_23"===this.oldValue&&("11"===a||"23_13"===a||"13_13_13"===a)||"13_13_13"===this.oldValue&&("11"===a||"23_13"===a||"13_23"===a)?(tdcIFrameData.changeRowModel(b,this.oldValue,a),b.getShortcodeRender(1,
null,!0)):this.oldValue!==a&&(tdcIFrameData.changeFluidStructureModel(b,this.oldValue,a),b.getShortcodeRender(1,null,!0));this.oldValue=a},300)});c.on("change",".tdc-tab-no-design .tdc-property-dropdown.tdc-add-class input.tdc-property-input-radio",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this);var c=b.val(),a=tdcIFrameData.getModel(b.data("model_id"));tdcSidebarController.onUpdate(a,b.data("param_name"),this.oldValue,c);this.oldValue=c}});c.on("change focus",
".tdc-tab-no-design .tdc-innerRow-col-dropdown select",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var c=tdcSidebar._$currentInnerRow.data("model_id");c=tdcIFrameData.getModel(c);tdcIFrameData.changeInnerRowModel(c,this.oldValue,b);c.getShortcodeRender(tdcIFrameData.getColumnNumber(c),null,!0);this.oldValue=b}});c.on("change",".tdc-tab-no-design .tdc-innerRow-col-dropdown input.tdc-property-input-radio",function(b){"undefined"!==typeof tdcSidebarPanel.timerChangingInnerColumns&&
clearTimeout(tdcSidebarPanel.timerChangingInnerColumns);var c=jQuery(this);tdcSidebarPanel.timerChangingInnerColumns=setTimeout(function(){var a=c.val(),b=tdcSidebar._$currentInnerRow.data("model_id");b=tdcIFrameData.getModel(b);var d=b.get("childCollection");this.oldValue="11";_.isUndefined(d)||(d=tdcIFrameData.getChildCollectionWidths(d),_.isUndefined(d)||(this.oldValue=d));tdcIFrameData.changeInnerRowModel(b,this.oldValue,a);b.getShortcodeRender(tdcIFrameData.getColumnNumber(b),null,!0);this.oldValue=
a},300)});c.on("change focus",".tdc-tab-no-design .tdc-widget-sidebar-dropdown select",function(b){if("focusin"===b.type||"focus"===b.type)this.oldValue=this.value;else{b=jQuery(this).val();var c=tdcIFrameData.getModel(jQuery(this).data("model_id"));tdcSidebarController.onUpdate(c,jQuery(this).data("param_name"),this.oldValue,b);this.oldValue=b}});c.on("click",".tdc-tab-no-design .tdc-open-wpeditor",function(b){b.preventDefault();var c=jQuery(this);b=jQuery("#tdc-wpeditor");var a=b.children(".content"),
e=c.data("mapped_parameter_name");c=c.data("model_id");var h=tdcIFrameData.getModel(c).get("parentModel").get("attrs"),g="tdc-three-column";if(_.has(h,"width"))switch(h.width){case "1/3":g="tdc-one-column";break;case "2/3":g="tdc-two-column"}a.addClass("tdc-dropped-wpeditor");a.html('<iframe id="tdc-iframe-wpeditor" class="'+g+'" src="'+window.tdcAdminSettings.pluginUrl+"/includes/wpeditor.php?wp_path="+window.tdcAdminSettings.ABSPATH+'" scrolling="auto" style="width: 100%; height: 100%" data-model_id="'+
c+'" data-mapped_parameter_name="'+e+'"></iframe>');b.show();tdcWindowFrame.setWindowFrame(b)});c.on("click","#tdc-wpeditor .tdc-iframe-close-button",function(b){b.preventDefault();jQuery("#tdc-wpeditor").hide()});c.on("click","#tdc-zone .tdc-iframe-close-button",function(b){b.preventDefault();jQuery("#tdc-zone").hide()});c.on("click",".tdc-sidebar-shortcode-row",function(b){b=jQuery(b.currentTarget).data("model_id");b=tdcIFrameData.getModel(b);var c={error:f,getShortcode:""};_.isUndefined(b)||tdcIFrameData._checkModelData(b,
c);_.isUndefined(c.getShortcode)||console.log(c.getShortcode)});c.on("click",".tdc-sidebar-aib-section-config",function(b){b=jQuery(b.currentTarget).data("model_id");var c=tdcIFrameData.getModel(b);_.isUndefined(window.TdAiBuilderModal)||"vc_row"!==c.attributes.tag||(b={error:f,getShortcode:""},_.isUndefined(c)||tdcIFrameData._checkModelData(c,b),_.isUndefined(b.getShortcode)||(c=c.attributes.attrs,b={id:c.aib_section_id,type:c.aib_section_type,title:c.aib_section_title,style:_.isUndefined(c.aib_section_style)?
"":c.aib_section_style,preview:"",content:b.getShortcode.replace(/(aib_section_title=".*?)(\s\d+)"(.*?)/g,'$1"')},console.log(JSON.stringify(b,null,2))))});c.on("click",".tdc-sidebar-current-styles-settings",function(b){b=tdcSidebarPanel.getCurrentStyleSettings(b);if(!_.isUndefined(b)){var c="",a;for(a in b)c+='"'+a+'" => "'+b[a]+'",\n';console.log(c)}});c.on("click",".tdc-sidebar-font-reset",function(b){tdConfirm.modal({caption:"Clear Font Settings",htmlInfoContent:"This will clear all values for this font group settings.",
textYes:"Yes",objectContext:this,callbackYes:function(){tb_remove();var b=jQuery(this),a=b.data("model_id"),c=tdcIFrameData.getModel(a),h=c.get("attrs");h=_.clone(h);for(var g="font-family font-size font-line-height font-style font-weight font-transform font-spacing".split(" "),m="",f=0;f<g.length;f++){var k=b.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+g[f]+":first");if(k.length){var l=k.find('[data-model_id="'+a+'"]');l.length&&(l.val(""),l.data("responsive",""),k.removeClass("tdc-css-inherited"),
m=k.find(".tdc-inherit"),m.length&&m.hide(),m=l.data("placeholder"),"undefined"!==typeof m&&l.attr("placeholder",m),m=l.data("param_name"),delete h[m],l=l.attr("name"),tdcSidebarPanel.deleteResponsiveValues(l))}}c.set("attrs",h);tdcSidebarController.onUpdate(c,m,"","")}})});c.on("click",".tdc-sidebar-font-save",function(b){b=jQuery(this);var c=b.data("model_id");c=tdcIFrameData.getModel(c).get("attrs");var a=b.data("param_name").replace("font_settings",""),e="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" "),
h={};_.each(c,function(b,c,d){if(0===c.indexOf(a))for(d=0;d<e.length;d++)if(0<c.indexOf(e[d])){h[e[d]]=b;break}});_.isEmpty(h)||tdConfirm.modal({caption:"Saving Font Settings",htmlInfoContent:function(){setTimeout(function(){jQuery("#TB_ajaxContent").find("input").focus()},100);return'<label>Font Name: </label><input type="text" autofocus><div class="info"></div>'},textYes:"Save",textNo:"Cancel",callbackYes:function(){var a=jQuery("#TB_ajaxContent"),b=a.find(".info");a=a.find("input").val().trim();
...
function(){jQuery("#TB_ajaxContent").find(".info").html("Font has been saved!");setTimeout(function(){tb_remove()},500)})):b.html("Font name already exists! Choose another one")}}})});c.on("click",".tdc-sidebar-font-load",function(){var b=jQuery(this),c=b.closest(".tdc-property-wrap"),a=b.data("model_id"),e=b.data("param_name");if(""!==window.tdcAdminSettings.tdcSavings&&("undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts||"undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts)){var h=
jQuery("#tdc-font-list");h.length||(h=tdcSidebar.buildFontList(a,e));h.html("");"undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts&&(jQuery('<div class="tdc-font-list-header"><span>Saved fonts</span></div>').appendTo(h),_.map(window.tdcAdminSettings.tdcSavings.fonts,function(b){jQuery('<div class="tdc-font-settings" data-value="'+b.value+'" data-model_id="'+a+'" data-param_name="'+e+'"><span class="tdc-font-name">'+b.name+'</span><span class="tdc-font-delete"></span></div>').appendTo(h)}));
if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(h);b=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var g=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<g;g--){var m=window.tdcAdminSettings.tdcSavings.recentFonts[g],f=b[m];_.isUndefined(f)||jQuery('<div class="tdc-recent-font-settings" data-value="'+m+'" data-model_id="'+a+'" data-param_name="'+e+'"><span class="tdc-font-name">'+
f+'</span><span class="tdc-recent-font-delete"></span></div>').appendTo(h)}}c.after(h);h.toggle()}});c.on("click",".tdc-font-delete",function(b){b.stopImmediatePropagation();var c=jQuery(this).closest(".tdc-font-settings");b=c.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,{name:b});window.tdcAdminSettings.tdcSavings.fonts.splice(b,1);tdcUtil.updateTdcSavings(this,function(){c.remove()})});c.on("click",".tdc-recent-font-delete",function(b){b.stopImmediatePropagation();var c=jQuery(this).closest(".tdc-recent-font-settings");
...
_.each(c,function(a,b,c){-1!==_.indexOf(g,b)&&(e[h+b]=a)});a.set({attrs:e,rebindToPanel:!0});tdcSidebarController.onUpdate(a)});c.on("click",".tdc-recent-font-settings",function(){var b=jQuery(this),c=b.data("value"),a=b.data("model_id");a=tdcIFrameData.getModel(a);var e=a.get("attrs");b=b.data("param_name").replace("font_settings","");e[b+"font_family"]=c;a.set({attrs:e,rebindToPanel:!0});tdcSidebarController.onUpdate(a)});tdcSidebarPanel.$_paramSwitchWrap=c.find(".tdc-param-switch-wrap");tdcSidebarPanel.$_paramNameSwitch=
c.find(".tdc-param-name-switch");if(0<tdcSidebarPanel.$_paramNameSwitch.length)c.on("click",".tdc-param-name-switch",function(){jQuery(this).toggleClass("tdc-param-switch-active");jQuery(".tdc-param-name").toggleClass("tdc-param-name-active")});tdcSidebarPanel.$_paramInfoSwitch=c.find(".tdc-param-info-switch");c.on("click",".tdc-param-info-switch",function(){jQuery(this).toggleClass("tdc-param-switch-active");jQuery("#tdc-sidebar").toggleClass("tdc-param-info-active");jQuery.ajax({timeout:1E4,type:"POST",
url:tdcUtil.getRestEndPoint("td-composer/set_param_info_option","uuid="+tdcJobManager._getUniqueID()),beforeSend:function(b){b.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{action:"tdc_ajax_set_param_info_option"}})});c.on("tdc_wm_global_color_name_update",function(b,c){b=c.new_option;var a="var(--"+c.option.replace("_","-")+")",d="var(--"+b.replace("_","-")+")";jQuery(".tdc-property-colorpicker").each(function(){var b=jQuery(this),c=b.find("input");b=b.find(".tdc-colorpicker-wrap");
!_.isUndefined(c.val())&&""!==c.val()&&/var\(--[a-zA-z0-9\-]*\)/.test(c.val())&&c.val()===a&&(c.val(d),b.attr("style","background: "+d).data("has-color","1"),b.attr("title","Global color: "+d),c.trigger("change"))});jQuery(".tdc-property-gradient").each(function(){var b=jQuery(this),c=b.find("input");b=b.find(".tdc-gradient-wrap");!_.isUndefined(c.val())&&""!==c.val()&&/var\(--[a-zA-z0-9\-]*\)/.test(c.val())&&c.val()===a&&(c.val(d),b.attr("style","background: "+d),b.attr("title","Global color: "+
d),c.trigger("change"))})});c.on("keyup","input.tdc-edit-page_id",function(b){var c=jQuery(this).closest(".tdc-property-wrap").find("a.tdc-edit-page_id");""===b.currentTarget.value.trim()?c.hide():c.length&&"undefined"!==typeof window.tdData&&(c.attr("href",tdData.adminUrl+"post.php?post="+b.currentTarget.value.trim()+"&action=edit").show(),c.css("visibility","visible"))});c.on("change","select.tdc-edit-cloud_tpl_module_id",function(b){var c=jQuery(this).closest(".tdc-property-wrap").find("a.tdc-edit-cloud_tpl_module_id");
""===b.currentTarget.value.trim()?c.hide():c.length&&"undefined"!==typeof window.tdData&&(c.attr("href",tdData.adminUrl+"post.php?post_id="+b.currentTarget.value.trim()+"&td_action=tdc&tdbTemplateType=module").show(),c.show())});c.on("click",".tdc-refresh-cloud_tpl_module",function(b){b.preventDefault();var c=jQuery("select.tdc-edit-cloud_tpl_module_id");b=c.find("option:selected");var a="";b.length&&(a=b.val());jQuery.ajax({url:td_ajax_url,type:"post",data:{action:"tdb_get_module_templates",_nonce:window.tdb_globals.wpRestNonce},
success:function(b){b=JSON.parse(b).templates;c.find("option:not(:first-child)").remove();b.map(function(b){var d=b.ID===parseInt(a)?' selected="selected"':"";c.append('<option value="'+b.ID+'"'+d+">"+b.post_title+"</option>")})},error:function(a,b,c){console.log("%c"+c,"color: #dc2121c7")}})});c.on("change",".tdc-property-dropdown select",function(b){b=jQuery(this);b.find("option:selected").is(":disabled")?b.addClass("selected-op-disabled"):b.removeClass("selected-op-disabled")})},getCurrentStyleSettings:function(c,
b){_.isUndefined(b)&&(b=jQuery(c.currentTarget).data("model_id"),b=tdcIFrameData.getModel(b),c={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,c));var d=b.get("tag");b=b.get("attrs");b=_.clone(b);if(!_.isUndefined(b)){var a={};c={};for(var e in b)0===e.indexOf("tds_")&&(a[e]=b[e]);e=window.tdcAdminSettings.mappedShortcodes[d].params;for(d=0;d<e.length;d++){var h=!1,g=e[d];if(0===g.param_name.indexOf("tds_")){for(var m in a)if(g.param_name===m){c[m]=a[m];h=!0;break}h||(c[g.param_name]=
"")}}for(m in a)switch(a=m.split("-"),a.length){case 2:if(!_.has(c,m)){e=a[0];a=!1;for(var n in c)if(e===c[n]&&1===n.split("-").length){a=!0;break}if(!a){var k;for(k in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[k],e)){var l=k;break}_.has(c,l)&&""===c[l]&&window.tdcAdminSettings.globalStyle[l]===e&&(a=!0)}a||delete b[m]}break;case 3:e=a[0];d=a[2];for(k in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[k],e)){l=k;break}a=
!1;for(n in c)if(e===c[n]&&n===l+"-"+d){a=!0;break}a||_.has(c,l+"-"+d)&&""===c[l+"-"+d]&&window.tdcAdminSettings.globalStyle[l]===e&&(a=!0);a||delete b[m]}return b}},getCurrentListAtts:function(c,b,d){_.isUndefined(b)&&(c=jQuery(c.currentTarget).data("model_id"),b=tdcIFrameData.getModel(c),c={error:f},_.isUndefined(b)||tdcIFrameData._checkModelData(b,c));c=b.get("tag");b=b.get("attrs");var a=_.clone(b);if(!_.isUndefined(a)){var e={};b={};for(var h in a)0===h.indexOf("tds_")&&(e[h]=a[h]);h=window.tdcAdminSettings.mappedShortcodes[c].params;
for(var g=0;g<h.length;g++){var m=!1,n=h[g];if(0===n.param_name.indexOf("tds_")){for(var k in e)if(n.param_name===k){b[k]=e[k];m=!0;break}m||(b[n.param_name]="")}}for(k in e)switch(e=k.split("-"),e.length){case 2:if(!_.has(b,k)){h=e[0];e=!1;for(var l in b)if(h===b[l]&&1===l.split("-").length){e=!0;break}if(!e){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],h)){var q=p;break}_.has(b,q)&&""===b[q]&&window.tdcAdminSettings.globalStyle[q]===h&&(e=
!0)}e||delete a[k]}break;case 3:h=e[0];m=e[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],h)){q=p;break}e=!1;for(l in b)if(h===b[l]&&l===q+"-"+m){e=!0;break}e||_.has(b,q+"-"+m)&&""===b[q+"-"+m]&&window.tdcAdminSettings.globalStyle[q]===h&&(e=!0);e||delete a[k]}var r=[],t;for(t in window.tdcAdminSettings.listStyles[d])if(t===c){for(g=0;g<window.tdcAdminSettings.listStyles[d][t].length;g++)k=window.tdcAdminSettings.listStyles[d][t][g],_.isArray(k)?
_.map(k,function(b){_.isUndefined(a[b])||(_.isUndefined(r[g])&&(r[g]=[]),r[g].push(a[b]))}):_.isUndefined(a[k])||(_.isArray(a[k])&&a[k].length?r[g]=a[k][0]:r[g]=a[k]);break}return r}},showHideTdcCssEditor:function(c){c=jQuery("#tdc-editor-css");var b=jQuery(this).closest(".tdc-property-wrap"),d=b.find("textarea:first");c.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=d;b.next(".tdc-property-editor_css-title").length?(b.next(".tdc-property-editor_css-title").toggle(),c.toggle()):(b.after(c),
b.after('<div class="tdc-property-editor_expand tdc-property-editor_css-title"><span></span><div class="tdc-editor-toggle tdc-css-ace-editor-expand-collapse"></div></div>'),c.show(),tdcSidebar.editorCss.getSession().setValue(d.val()))},toggleEnableParamsFromText:function(c){var b=c.closest(".tdc-property-wrap"),d=b.data("enable-params");b=b.data("enable-params-reverse");d=jQuery('.tdc-property-wrap[data-enabled-by="'+d+'"]');d.length&&(""!==c.val()?"undefined"!==typeof b&&1===b?d.hasClass("tdc-disabled")||
d.addClass("tdc-disabled"):d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):"undefined"!==typeof b&&1===b?d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):d.hasClass("tdc-disabled")||d.addClass("tdc-disabled"))},toggleEnableParamsFromSelect:function(c){var b=c.val();c=c.closest(".tdc-property-wrap");var d=c.data("enable-params"),a=c.data("enable-params-reverse"),e=jQuery('.tdc-property-wrap[data-enabled-by^="'+d+'"]');e.length&&e.each(function(c,d){c=jQuery(d);d=c.data("enabled-by");
-1!==d.indexOf("--")?d.substring(d.indexOf("--")+2)===b?"undefined"!==typeof a&&1===a?c.hasClass("tdc-disabled")||c.addClass("tdc-disabled"):c.hasClass("tdc-disabled")&&c.removeClass("tdc-disabled"):"undefined"!==typeof a&&1===a?c.hasClass("tdc-disabled")&&c.removeClass("tdc-disabled"):c.hasClass("tdc-disabled")||c.addClass("tdc-disabled"):""!==b?"undefined"!==typeof a&&1===a?e.hasClass("tdc-disabled")||e.addClass("tdc-disabled"):e.hasClass("tdc-disabled")&&e.removeClass("tdc-disabled"):"undefined"!==
typeof a&&1===a?e.hasClass("tdc-disabled")&&e.removeClass("tdc-disabled"):e.hasClass("tdc-disabled")||e.addClass("tdc-disabled")})},toggleDisableParamsFromSelect:function(c){var b=c.val();c=c.closest(".tdc-property-wrap").data("disable-params");c=jQuery('.tdc-property-wrap[data-disabled-by^="'+c+'"]');c.length&&c.each(function(c,a){c=jQuery(a);a=c.data("disabled-by");-1!==a.indexOf("--")&&(a.substring(a.indexOf("--")+2)===b?c.hasClass("tdc-disabled")||c.addClass("tdc-disabled"):c.hasClass("tdc-disabled")&&
...
b.length&&("popular1"===c||"popular2"===c||"popular3"===c||"popular7"===c?b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"))},toggleEnableCFParams:function(c){var b=c.find("option:selected").text().match(/\(([^)]+)\)$/);c=jQuery(".tdc-separator-url, .tdc-property-url, .tdc-property-open_in_new_window, .tdc-property-url_rel");var d=jQuery(".tdc-property-text_cut");b&&(b=b[1],"user"===b||"taxonomy"===b?c.addClass("tdc-disabled"):c.removeClass("tdc-disabled"),
"wysiwyg"===b||"text"===b||"textarea"==b?d.removeClass("tdc-disabled"):d.addClass("tdc-disabled"))},bindPanelToModel:function(c,b){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==c.cid||!_.isUndefined(b)&&(_.isUndefined(b)||!0===b)){b=window.tdcAdminSettings.mappedShortcodes[c.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=c;for(var d=[],a=0;a<b.params.length;a++){var e=tdcSidebarPanel._defaultGroupName;
_.isEmpty(b.params[a].group)||(e=b.params[a].group);d.push(e)}d=_.uniq(d);var h=e="",g=tdcSidebar.getCurrentTabId(),m,f;e+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var k=f=m="";for(a=0;a<d.length;a++){h=tdcSidebarPanel._fixGroupName(d[a]);var l=tdcUtil.makeSafeForCSS(h);if(0===a)m='<a href="#" data-tab-id="td-tab-'+l+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>',f='<a href="#" data-tab-id="td-tab-'+l+'" title="'+h+' settings">'+
h+'<span class="tdc-tab-search-notice"></span></a>';else if(_.isUndefined(g)||g!=="td-tab-"+l){var p=c.getParentModel("vc_row");"ai"===l&&(_.isUndefined(window.TdAiBuilderModal)||!_.isUndefined(p)&&(_.isUndefined(p.attributes.attrs.aib_is_section)||"yes"!==p.attributes.attrs.aib_is_section))||"css"===l&&"td-aib-style"===window.tdcPostSettings.loadDataFromPostType||(k+='<a href="#" data-tab-id="td-tab-'+l+'" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>')}else m=f,k+=
'<a href="#" data-tab-id="td-tab-'+l+'" class="tdc-tab-active" title="'+h+' settings">'+h+'<span class="tdc-tab-search-notice"></span></a>'}e=e+(m+k)+"</div>";k=f=m=a="";if(tdcState.isMobileComposer())switch(tdcSidebar.currentViewportSettings.name){case "all":a="selected";break;case "phone":k="selected"}else switch(tdcSidebar.currentViewportSettings.name){case "all":a="selected";break;case "landscape":m="selected";break;case "portrait":f="selected";break;case "phone":k="selected"}e+='<div class="tdc-tab-responsive"><div class="tdc-responsive-buttons">';
tdcState.isMobileComposer()?e=e+('<div class="tdc-responsive-all tdc-responsive-tablet-landscape '+a+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div><div class="tdc-responsive-phone ')+(k+'" title="Portrait viewport"><span class="tdc-phone-icon"></span></div>'):(e+='<div class="tdc-responsive-all '+a+'" title="Desktop viewport"><span class="tdc-all-icon"></span></div>',"Newspaper"===window.tdcAdminSettings.themeName&&(e+='<div class="tdc-responsive-tablet-landscape '+
m+'" title="Landscape viewport"><span class="tdc-tablet-landscape-icon"></span></div>'),e+='<div class="tdc-responsive-tablet-portrait '+f+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>',e+='<div class="tdc-responsive-phone '+k+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>');e+="</div>";e+="</div>";e+='<div class="tdc-search">';e+='<i class="td-icon-search"></i>';e+='<input type="text" placeholder="Search settings..." />';e+="</div></div>";
e+='<div class="tdc-sidebar-sticky-a"></div>';e+='<div class="tdc-sidebar-sticky-b"></div>';e+='<div class="tdc-tab-content-wrap" data-tag="'+c.get("tag")+'">';k=f=m="";for(a=0;a<d.length;a++)h=tdcSidebarPanel._fixGroupName(d[a]),l=tdcUtil.makeSafeForCSS(h),h="tdc-tab-no-design",p=c.get("tag"),"css"===l&&(h="tdc-tab-design"),0===a?(m='<div class="tdc-tab-content tdc-tab-content-visible '+h+'" id="td-tab-'+l+'">',f='<div class="tdc-tab-content '+h+'" id="td-tab-'+l+'">',l=window.tdcAdminSettings.mappedShortcodes[p].tdc_start_values,
c.unset("presetValues"),_.isUndefined(l)||(l=JSON.parse(window.atob(l)),_.isArray(l)&&1<l.length&&c.set("presetValues",l)),c.has("presetValues")&&(l=c.get("presetValues"),k+=tdcSidebarPanel._addPresetValuesSelector(l,c))):_.isUndefined(g)||g!=="td-tab-"+l?k+='<div class="tdc-tab-content '+h+'" id="td-tab-'+l+'">':(m=f,k+='<div class="tdc-tab-content tdc-tab-content-visible '+h+'" id="td-tab-'+l+'">'),k+=tdcSidebarPanel._bindGroupAndGetHtml(d[a],b,c),l=' data-model_id="'+c.cid+'" ',"dev"===window.tdcAdminSettings.deployMode&&
(k+='<div class="tdc-sidebar-row-buttons">',k+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+l+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>',k+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+l+' title="Get the current styles\' settings">CONSOLE: style presets</div>',_.isUndefined(window.TdAiBuilderModal)||"vc_row"!==c.attributes.tag||(k+='<div class="tdc-sidebar-button tdc-sidebar-aib-section-config" '+l+">CONSOLE: AIB section config</div>"),
k+="</div>"),k+="</div>";e=e+(m+k)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(e);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");tdcSidebarPanel._hook.addAction("panel_rendered",function(){"undefined"===typeof window.tdcResponsiveValues&&(window.tdcResponsiveValues={},"all"===tdcSidebar.currentViewportSettings.name?(jQuery(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"),jQuery(".tdc-tab-content-wrap").removeAttr("data-viewport")):(jQuery(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),
jQuery(".tdc-tab-content-wrap").attr("data-viewport",tdcSidebar.currentViewportSettings.name)),jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),b=a.find("[data-responsive]"),c=b.attr("name"),d=b.data("responsive");try{var e=window.atob(d);window.tdcResponsiveValues[c]=JSON.parse(e)}catch(w){d={},a.hasClass("tdc-property-textfield-responsive")?""!==b.val()&&(d.all=b.val()):a.hasClass("tdc-property-dropdown-responsive")?a.hasClass("tdc-visual-selector")?(b=
a.find("[data-responsive]:checked:first"),b.length?d.all=b.val():(b=a.find("[data-responsive]:first"),b.length&&(d.all=b.val()))):b.find("option:first").val()!==b.val()&&(d.all=b.val()):a.hasClass("tdc-property-checkbox-responsive")?b.is(":checked")&&(d.all=b.val()):a.hasClass("tdc-property-range-responsive")?d.all=b.data("value"):a.hasClass("tdc-property-range_multiple-responsive")&&(d.all=b.data("range_value")+b.data("range_unit")),window.tdcResponsiveValues[c]=d}tdcSidebarPanel.setViewportCurrentResponsiveValue(b)}))});
...
a.find("option[value=13_23]").addClass("tdc-block-col"),a.find("option[value=13_13_13]").addClass("tdc-block-col")}else if(a=jQuery('body .tdc-innerRow-col-dropdown input[value="'+b+'"]'),a.length)switch(a.attr("checked","checked"),a.next("label").show(),e){case "":case "11":a.parent().find("input[value=12_12] + label").addClass("tdc-block-col");a.parent().find("input[value=23_13] + label").removeClass("tdc-block-col");a.parent().find("input[value=13_23] + label").removeClass("tdc-block-col");a.parent().find("input[value=13_13_13] + label").removeClass("tdc-block-col");
...
a.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})();(function(){var a=c.get("tag");if("vc_row"===a||"vc_row_inner"===a||"vc_column"===a||"vc_column_inner"===a){a=jQuery("body .tdc-property-flex_layout");var b=c.get("childCollection");if(!_.isUndefined(b)&&a.length){b=jQuery("body .tdc-property-flex_horiz_align");var d=jQuery("body .tdc-property-flex_vert_align"),e=jQuery("body .tdc-property-flex_layout_reverse");a.find("input[value=column]").is(":checked")&&(b.addClass("tdc-flex-row-align-rev"),
d.addClass("tdc-flex-row-align-rev"),e.find("input").is(":checked")&&b.addClass("tdc-flex-row-rev-align-rev"))}}})();(function(){var a=c.get("tag"),b=jQuery(".tdc-tab-content-wrap").data("viewport");"undefined"===typeof b||"phone"!==b||"vc_column"!==a&&"vc_column_inner"!==a||(a=jQuery("body .tdc-property-is_sticky"),b=c.get("childCollection"),!_.isUndefined(b)&&a.length&&(b=a.find('input[name="tdc-param-is_sticky"]'),a.addClass("tdc-disabled"),b.prop("disabled",!0),b.prop("checked",!1)))})();(function(){var a=
jQuery(".tdc-tab-content-wrap").data("viewport");if("undefined"!==typeof a&&"all"!==a){a=jQuery('body [data-responsive-disable-default="1"]');var b=c.get("childCollection");!_.isUndefined(b)&&a.length&&a.each(function(){var a=jQuery(this);a.hasClass("tdc-property-dropdown-responsive")&&(a=a.hasClass("tdc-visual-selector")?a.find('.tdc-property-input-radio[value="default"]'):a.find('select option[value="default"]'),a.length&&a.prop("disabled",!1))})}})();(function(){if("td_woo_products_live_search"===
...
b=jQuery(".tdc-property-wrap[data-disable-params] select");b.length&&b.each(function(a,b){tdcSidebarPanel.toggleDisableParamsFromSelect(jQuery(b))});b=jQuery(".tdc-property-wrap[data-enable-params] input[type=checkbox]");b.length&&b.each(function(a,b){tdcSidebarPanel.toggleEnableParamsFromCheckbox(jQuery(b))});b=jQuery(".tdc-list-menu-display select");b.length&&b.each(function(a,b){tdcSidebarPanel.toggleEnableListMenuDepthParam(jQuery(b))});b=jQuery(".tdc-gallery-source select");b.length&&b.each(function(a,
b){tdcSidebarPanel.toggleEnableGalleryACFfieldParam(jQuery(b))});b=jQuery('.tdc-ml-dropdown-only input[type="checkbox"]');b.length&&b.each(function(a,b){tdcSidebarPanel.toggleEnableTDSMenuLoginDrodownOnlyParams(jQuery(b))});b=jQuery('.tdc-fs-link-post-toggle input[type="checkbox"]');b.length&&b.each(function(a,b){tdcSidebarPanel.toggleEnableFSLinkPostParams(jQuery(b))});b=jQuery(".tdc-block-sort select");b.length&&b.each(function(a,b){tdcSidebarPanel.toggleEnableBlockSortParams(jQuery(b))});b=jQuery('[data-tag="tdb_single_custom_field"] [data-param_name="acf_field"]');
b.length&&tdcSidebarPanel.toggleEnableCFParams(b);var q=jQuery('[data-tag="vc_column"] [data-param_name="is_sticky"], [data-tag="vc_column_inner"] [data-param_name="is_sticky"]');if(q.length){var r=q.closest(".tdc-property-wrap");jQuery("body").on("click",".tdc-responsive-buttons > div",function(a){a=q.is(":checked");jQuery(this).hasClass("tdc-responsive-phone")?(r.addClass("tdc-disabled"),q.prop("disabled",!0),q.prop("checked",!1)):(r.removeClass("tdc-disabled"),q.prop("disabled",!1),q.prop("checked",
a))})}var t=jQuery('[data-responsive-disable-default="1"]');if(t.length)jQuery("body").on("click",".tdc-responsive-buttons > div",function(){var a=jQuery(this);t.each(function(){var b=jQuery(this);b.hasClass("tdc-property-dropdown-responsive")&&(b=b.hasClass("tdc-visual-selector")?b.find('.tdc-property-input-radio[value="default"]'):b.find('select option[value="default"]'),b.length&&(a.hasClass("tdc-responsive-all")?b.prop("disabled",!1):b.prop("disabled",!0)))})})}},_bindGroupAndGetHtml:function(c,
b,d){var a="",e=d.get("attrs");if("tdc_zone"===d.get("tag"))var h=e.type;for(var g=0;g<b.params.length;g++){var m=b.params[g].param_name,f=b.params[g].group;if(c===tdcSidebarPanel._defaultGroupName&&_.isEmpty(b.params[g].group)||b.params[g].group===c){if(!_.isUndefined(h)){if(!_.isUndefined(b.params[g].zone_group)&&h!==b.params[g].zone_group||"type"===m)continue;if("mob_load"===m&&!_.includes(["tdc_header_desktop","tdc_header_desktop_sticky"],h))continue;if("desktop_load"===m&&!_.includes(["tdc_header_mobile",
"tdc_header_mobile_sticky"],h))continue}a+=tdcSidebarPanel._bindParamAndGetHtml(b.params[g],d)}if("block_template_id"===m){f=e.block_template_id;_.isEmpty(f)&&(f=window.tdcAdminSettings.globalBlockTemplate);m=window.tdcAdminSettings.mappedBlockTemplates;for(var k=0;k<m[f].params.length;k++)if(c===tdcSidebarPanel._defaultGroupName&&_.isEmpty(m[f].params[k].group)||m[f].params[k].group===c)a+=tdcSidebarPanel._bindParamAndGetHtml(m[f].params[k],d)}else if(0===m.indexOf("tds_")){var l=m.split("-");k=
l[0];var p;2===l.length?p=l[1]:2<l.length&&new tdcNotice.notice('Param "'+m+'" must have up to at most one "-" separator ',!0,!1);m=e[m];_.isEmpty(m)&&(m=window.tdcAdminSettings.globalStyle[k]);l=window.tdcAdminSettings.settingsStyle[k];if("undefined"!==typeof l[m])for(k=0;k<l[m].params.length;k++)if(f==c||_.isUndefined(f)&&c===tdcSidebarPanel._defaultGroupName){var q=JSON.parse(JSON.stringify(l[m].params[k]));q.param_name=m+"-"+q.param_name;_.isUndefined(p)||(q.param_name+="-"+p);a+=tdcSidebarPanel._bindParamAndGetHtml(q,
...
b);case "textfield-responsive":return tdcSidebarPanel.addTextFieldResponsive(c,b);case "textarea":return tdcSidebarPanel.addTextArea(c,b);case "textarea_html":return tdcSidebarPanel.addTextAreaHtml(c,b);case "textarea_raw_html":return tdcSidebarPanel.addTextAreaRawHtml(c,b);case "textarea_raw_html_ace":return tdcSidebarPanel.addTextAreaRawHtmlAce(c,b);case "editor_css":return tdcSidebarPanel.addEditorCss(c,b);case "css_editor":return"";case "tdc_css_editor":return tdcCssEditor.init(),tdcCssEditor.addComposerCssEditor(c,
b);case "horizontal_separator":return tdcSidebarPanel.addSeparatorHorizontal(c,b);case "text_separator":return tdcSidebarPanel.addTextSeparatorHorizontal(c,b);case "font_header":return tdcSidebarPanel.addFontHeader(c,b);case "font_title":return tdcSidebarPanel.addFontTitle(c,b);case "font_reset":return tdcSidebarPanel.addFontReset(c,b);case "font_save":return tdcSidebarPanel.addFontSave(c,b);case "font_load":return tdcSidebarPanel.addFontLoad(c,b);case "font_settings":return tdcSidebarPanel.addFontSettings(c,
b);case "shadow_header":return tdcSidebarPanel.addShadowHeader(c,b);case "shadow_title":return tdcSidebarPanel.addShadowTitle(c,b);case "spot_header":return tdcSidebarPanel.addSpotHeader(c,b);case "filter_header":return tdcSidebarPanel.addFilterHeader(c,b);case "pages_header":return tdcSidebarPanel.addPagesHeader(c,b);case "plans_limit_header":return tdcSidebarPanel.addPlansLimitHeader(c,b);case "tdb_filter_type_header":return tdcSidebarPanel.addFilterTypeHeader(c,b);case "filter_title":return tdcSidebarPanel.addFilterTitle(c,
b);case "search_section_header":return tdcSidebarPanel.addSearchSectionHeader(c,b);case "clearfix":return tdcSidebarPanel.addClearfix(c,b);case "tdc_hidden_field":return"";default:return c.param_name+" - "+c.type+"<br>"}},_deletePanel:function(){tdcSidebarPanel._hook._hooks=[];tdcSidebarPanel._currentBoundModel=f;tdcSidebarPanel.saveTdcPalette();jQuery(".tdc-breadcrumbs").hide();jQuery(".tdc-param-switch-wrap").hide();jQuery(".tdc-inspector .tdc-current-element-head").empty();jQuery(".tdc-inspector .tdc-tabs-wrapper").empty();
jQuery(".tdc-inspector-wrap").removeClass("tdc-inspector-active");jQuery(".tdc-empty-sidebar").show();tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible");tdcSidebar.$_currentElementHead.removeClass("tdc-current-element-siblings-button-on");delete window.tdcResponsiveValues;tdcSidebar.hideWpeditor()},_getParameterClasses:function(c){var b="tdc-property-wrap tdc-property-"+c.type;b+=" tdc-property-"+c.param_name;_.isUndefined(c.class)||(b+=" "+c.class);return b},
_getParameterCurrentValue:function(c,b){b=b.get("attrs");return _.isUndefined(b[c.param_name])?"dropdown"===c.type||_.isUndefined(c.value)?"":c.value:b[c.param_name]},_getParameterDomName:function(c){return"tdc-param-"+c.param_name},_getParamterDataAtts:function(c,b){var d="";if("undefined"===typeof b)return d;d+=' data-model_id="'+b.cid+'"';"undefined"!==typeof c&&(d+=' data-param_name="'+c.param_name+'"',"woo_shortcode"===c.param_name&&(d+='id="woo_shortcode" '));return d},_fixGroupName:function(c){switch(c){case "Design options":return"Css";
case "Pagination":return"Extra";case "Ajax filter":return"Ajax"}return c},clearPanel:function(){tdcSidebarPanel._deletePanel()},blurInputPanel:function(){jQuery("body").find("input").blur()},_addPresetValuesSelector:function(c,b){b='<div class="tdc-preset-values tdc-sidebar-horizontal-separator"><i class="tdc-font-fa tdc-font-fa-cube"></i>Pre-made style presets<i class="tdc-font-fa tdc-font-fa-angle-right"></i></div><ul class="tdc-preset-values-list" data-model_id="'+(b.cid+'">');for(var d=1;d<c.length;d++){var a=
...
callbackColorPicker:function(){jQuery("#tdc-palette-color-picker").tdPalette();jQuery(".tdc-tab-no-design .tdc-property-colorpicker").each(function(){var c=jQuery(this),b=c.find("input");c=c.find(".tdc-colorpicker-wrap");_.isUndefined(b.val())||""===b.val()||(c.attr("style","background: "+b.val()),/var\(--[a-zA-z0-9\-]*\)/.test(b.val())&&(c.append('<i class="tdc-font-tdmp tdc-font-tdmp-globe"></i>'),c.attr("title",(b.val().includes("--td_aib_color")?"AI builder color: ":"Global color: ")+b.val()).data("has-color",
"1")))})},addGradient:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');
var m="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+m+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="hidden" value="'+
tdcSidebarPanel._getParameterCurrentValue(c,b)+'"/>');d=d+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");d+="</div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackGradient);return d},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var c=jQuery(this),b=c.find("input");c=c.find(".tdc-gradient-wrap");
if(!_.isUndefined(b.val())&&""!==b.val())try{var d=JSON.parse(window.atob(b.val()));_.isUndefined(d.css)||c.attr("style",d.css)}catch(a){d=b.val(),_.isUndefined(d)||(c.attr("style","background: "+d),/var\(--[a-zA-z0-9\-]*\)/.test(b.val())&&(c.append('<i class="tdc-font-tdmp tdc-font-tdmp-globe"></i>'),c.attr("title",(b.val().includes("--td_aib_color")?"AI builder color: ":"Global color: ")+d)))}})},addDropDown:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+
c.info_img+'"');if("tdb_mobile_menu"===b.get("tag")&&"menu_id"===c.param_name){var e=b.get("attrs");e.menu_id=window.tdcPostSettings.mobileMenuId;b.set("attrs",e)}var h=!1,g=!1;_.has(c,"tdc_dropdown_images")&&""!==c.tdc_dropdown_images&&(h=!0);_.has(c,"tdc_dropdown_texts")&&""!==c.tdc_dropdown_texts&&(g=!0);var m="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(m='data-enable-params="'+c.toggle_enable_params+'"');var f="";_.has(c,"toggle_disable_params")&&""!==c.toggle_disable_params&&
(f='data-disable-params="'+c.toggle_disable_params+'"');var k="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var l="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(l='data-enabled-by="'+c.toggle_enabled_by+'"');var p="";_.has(c,"toggle_disabled_by")&&""!==c.toggle_disabled_by&&(p='data-disabled-by="'+c.toggle_disabled_by+'"');var q=e="",r=!1,t=Object.keys(c.value),v=!0;if(_.has(c,"tdc_min_options")&&t.length<=parseInt(c.tdc_min_options))return e;
for(var u=0;u<t.length;u++){var x=!1,C="",z="",w="",y="",A="",B=t[u],E=String(tdcSidebarPanel._getParameterCurrentValue(c,b)),D=String(c.value[t[u]]);_.has(c,"options_to_disable")&&""!==c.options_to_disable&&(z=c.options_to_disable);_.has(c,"options_to_hide")&&""!==c.options_to_hide&&(w=c.options_to_hide);_.isObject(c.value[t[u]])&&(x=!0,D=_.values(c.value[t[u]])[0],B=_.keys(c.value[t[u]])[0]);if(h||g)0===u&&""===E&&(E=D),E===D&&(C=" checked "),z=_.uniqueId(),w=D,"vc_row"!==b.attributes.tag&&"vc_row_inner"!==
b.attributes.tag||-1!==c.param_name.indexOf("flex_")||(w="col_"+w),q+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(c,b)+' id="'+z+'" name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+C+' value="'+D+'">',h?(C="",x&&(C="tdc-standard-value"),q+='<label class="tdc-property-input-radio-label '+C+'" for="'+z+'" title="'+B+'"><div class="'+w+'"></div></label>'):q+='<label class="tdc-property-input-radio-label" for="'+z+'" title="'+B+'">'+D+"</label>";else{E===
D&&(C=' selected="selected" ',v=!1);if("__"===D&&-1!==B.search("--")||-1<z.indexOf(D)&&""!==D)y=" disabled ";-1<w.indexOf(D)&&""!==D&&(A=' style="display:none" ',"popular"===D&&(A=""));""!==y&&""!==C&&(r=!0);q+="<option "+C+" "+y+A+' value="'+D+'">'+B+"</option>"}}t="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':t=' title="'+c.description+'" ');e+='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+m+" "+f+" "+k+" "+l+" "+p+">";e+=
'<div class="tdc-property-title"><span class="tdc-search-data"'+t+">"+c.heading+"</span>";d="";a="#";"tdb_flex_block_builder"!==b.get("tag")&&"tdb_flex_loop_builder"!==b.get("tag")||"cloud_tpl_module_id"!==c.param_name||(d="tdc-edit-cloud_tpl_module_id",m='style="margin-left: 10px"',_.has(b.get("attrs"),"cloud_tpl_module_id")?""===b.get("attrs").cloud_tpl_module_id.trim()?m='style="margin-left: 10px; display: none"':"undefined"!==typeof window.tdData&&(a=tdData.adminUrl+"post.php?post_id="+b.get("attrs").cloud_tpl_module_id.trim()+
"&td_action=tdc&tdbTemplateType=module"):m='style="margin-left: 10px; display: none"',e+='<a href="'+a+'" class="'+d+'" target="_blank" '+m+">Edit</a>","dev"===window.td_deploy_mode&&(e+='<a href="#" class="tdc-refresh-cloud_tpl_module" target="_blank" style="margin-left: 10px">Refresh list</a>'));e+='</div><div class="tdc-property">';h||g?e+=q:(r&&(d+=" selected-op-disabled"),v&&["tds_plans_button","tds_plans_price"].includes(b.get("tag"))&&(h=String(tdcSidebarPanel._getParameterCurrentValue(c,b)),
q+='<option selected="selected" value="'+h+'" disabled>Plan #'+h+" n/a</option>",d+=" selected-op-disabled"),e+="<select "+tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" class="'+d+'">',e=e+q+"</select>");e=e+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return e+"</div>"},addDropDownResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e=!1,h=!1;_.has(c,"tdc_dropdown_images")&&
""!==c.tdc_dropdown_images&&(e=!0);_.has(c,"tdc_dropdown_texts")&&""!==c.tdc_dropdown_texts&&(h=!0);var g="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(g='data-enable-params="'+c.toggle_enable_params+'"');var m="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(m='data-enable-params-reverse="1"');var f="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(f='data-enabled-by="'+c.toggle_enabled_by+'"');var k="";_.has(c,"responsive_disable_default")&&
!0===c.responsive_disable_default&&(k=' data-responsive-disable-default="1"');var l="",p="",q=Object.keys(c.value);if(_.has(c,"tdc_min_options")&&q.length<=parseInt(c.tdc_min_options))return l;var r=' data-responsive="" ',t=String(tdcSidebarPanel._getParameterCurrentValue(c,b));try{var v=JSON.parse(window.atob(t));r=' data-responsive="'+t+'" ';"undefined"!==typeof v[tdcSidebar.currentViewportSettings.name]&&(t=v[tdcSidebar.currentViewportSettings.name])}catch(A){}for(v=0;v<q.length;v++){var u=!1,
x="",C="",z=q[v],w=String(c.value[q[v]]);_.isObject(c.value[q[v]])&&(u=!0,w=_.values(c.value[q[v]])[0],z=_.keys(c.value[q[v]])[0]);if(e||h){0===v&&""===t&&(t=w);t===w&&(x=" checked ");C=_.uniqueId();var y=w;"vc_row"!==b.attributes.tag&&"vc_row_inner"!==b.attributes.tag||-1!==c.param_name.indexOf("flex_")||(y="col_"+y);p+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(c,b)+' id="'+C+'" name="'+tdcSidebarPanel._getParameterDomName(c)+'" '+x+' value="'+w+
'" '+r+">";e?(x="",u&&(x="tdc-standard-value"),p+='<label class="tdc-property-input-radio-label '+x+'" for="'+C+'" title="'+z+'"><div class="'+y+'"></div></label>'):p+='<label class="tdc-property-input-radio-label" for="'+C+'" title="'+z+'">'+w+"</label>"}else t===w&&(x=' selected="selected" '),"__"===w.substring(0,2)&&-1!==z.search("--")&&(C=" disabled "),p+="<option "+x+" "+C+' value="'+w+'">'+z+"</option>"}q="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+
'"':q=' title="'+c.description+'" ');l+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+g+" "+m+" "+f+k+">";l+='<div class="tdc-property-title"><span class="tdc-search-data"'+q+">"+c.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';l+='<div class="tdc-property">';e||h?l+=p:(l+="<select "+tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+
'" '+r+q+">",l=l+p+"</select>");l=l+'</div><span class="tdc-param-name">'+(c.param_name+"</span>");return l+"</div>"},addCheckBox:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="",g=tdcSidebarPanel._getParameterCurrentValue(c,b);"product_cat_type_action"===c.param_name?""!==g&&"single_selection"!==g&&(h=
...
var q="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(q='data-enabled-by="'+c.toggle_enabled_by+'"');var r=' data-responsive="" ',t=tdcSidebarPanel._getParameterCurrentValue(c,b);try{var v=JSON.parse(window.atob(t));r=' data-responsive="'+t+'" ';t="undefined"===typeof v[tdcSidebar.currentViewportSettings.name]?"":v[tdcSidebar.currentViewportSettings.name]}catch(u){}d='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+l+" "+p+" "+q+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+
e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" data-value="'+t+'" data-min="'+g+'" data-max="'+h+'" data-step="'+m+'" min="'+g+'" max="'+h+'" step="'+m+'" value="'+t+'" '+r+" />");d=d+('<input type="text" class="tdc_range_value" data-default_value="'+f+'" '+k+' value="'+t+'"/></div><span class="tdc-param-name">')+(c.param_name+"</span>");return d+="</div>"},addRangeMultiple:function(c,
...
""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');var f=c.tdc_values,k=tdcSidebarPanel._getParameterCurrentValue(c,b),l="",p="",q=[],r="",t="",v="",u="",x="",C="",z="",w;for(w in f)f.hasOwnProperty(w)&&(q.push(f[w].unit),""===t||""===r)&&(u=f[w].unit,t=' data-range_unit="'+u+'" ',v=f[w].value,r=' data-range_value="'+v+'" ',x=f[w].range_min,C=f[w].range_max,z=f[w].range_step);if(""!==k){for(var y=[],A=0;A<q.length&&!(y=k.split(q[A]),1<y.length);A++);y.length&&(u=q[A],t=' data-range_unit="'+
u+'" ',v=y[0],r=' data-range_value="'+v+'" ')}for(w in f)f.hasOwnProperty(w)&&(k=_.uniqueId(),l+=" data-value_"+w+'="'+f[w].value+'" ',l+=" data-min_"+w+'="'+f[w].range_min+'" ',l+=" data-max_"+w+'="'+f[w].range_max+'" ',l+=" data-step_"+w+'="'+f[w].range_step+'" ',q=f[w].value,y="",f[w].unit===u&&(q=v,x=f[w].range_min,C=f[w].range_max,z=f[w].range_step,y="checked"),p+='<input name="'+tdcSidebarPanel._getParameterDomName(c)+'_unit" data-unit="'+w+'" data-unit_value="'+f[w].unit+'" type="radio" id="'+
k+'" '+y+' data-default_value="'+f[w].value+'" data-last_value="'+q+'"/>',p+='<label for="'+k+'">'+f[w].unit+"</label>");d='<div class="'+tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+h+" "+g+" "+m+">";d+='<div class="tdc-property-title"><span class="tdc-search-data"'+e+">"+c.heading+"</span></div>";d=d+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(c,b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" '+r+" "+t+" "+
l+' min="'+x+'" max="'+C+'" step="'+z+'" value="'+v+'"/>');d=d+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+p+'</div><input type="text" class="tdc_range_value" value="'+(v+'"/>');d+="</div>";d+="</div>";d+='<span class="tdc-param-name">'+c.param_name+"</span>";return d+="</div>"},addRangeMultipleResponsive:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+c.info_img+'"');var e="";_.has(c,"description")&&""!==c.description&&(""!==
d?a='data-info-descr="'+c.description+'"':e=' title="'+c.description+'" ');var h="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var m="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(m='data-enabled-by="'+c.toggle_enabled_by+'"');var f=c.tdc_values,k=tdcSidebarPanel._getParameterCurrentValue(c,
b),l="",p="",q=[],r=' data-responsive="" ',t="",v="",u="",x="",C="",z="",w="",y;for(y in f)f.hasOwnProperty(y)&&(q.push(f[y].unit),""===v||""===t)&&(x=f[y].unit,v=' data-range_unit="'+x+'" ',u=f[y].value,t=' data-range_value="'+u+'" ',C=f[y].range_min,z=f[y].range_max,w=f[y].range_step);if(""!==k){var A=k;try{var B=JSON.parse(window.atob(k));r=' data-responsive="'+k+'" ';A="undefined"===typeof B[tdcSidebar.currentViewportSettings.name]?"":B[tdcSidebar.currentViewportSettings.name]}catch(E){}if(""!==
A){k=[];for(B=0;B<q.length&&!(k=A.split(q[B]),1<k.length);B++);k.length&&(x=q[B],v=' data-range_unit="'+x+'" ',u=k[0],t=' data-range_value="'+u+'" ')}}for(y in f)f.hasOwnProperty(y)&&(q=_.uniqueId(),l+=" data-value_"+y+'="'+f[y].value+'" ',l+=" data-min_"+y+'="'+f[y].range_min+'" ',l+=" data-max_"+y+'="'+f[y].range_max+'" ',l+=" data-step_"+y+'="'+f[y].range_step+'" ',A=f[y].value,k="",f[y].unit===x&&(A=u,C=f[y].range_min,z=f[y].range_max,w=f[y].range_step,k="checked"),p+='<input name="'+tdcSidebarPanel._getParameterDomName(c)+
...
b)+' name="'+tdcSidebarPanel._getParameterDomName(c)+'" type="range" '+t+" "+v+" "+l+" "+r+' min="'+C+'" max="'+z+'" step="'+w+'" value="'+u+'"/>');d=d+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+p+'</div><input type="text" class="tdc_range_value" value="'+(u+'"/>');d+="</div>";d+="</div>";d+='<span class="tdc-param-name">'+c.param_name+"</span>";return d+="</div>"},addIconSelector:function(c,b){var d="",a="";_.has(c,"info_img")&&""!==c.info_img&&(d='data-info-img="'+
...
tdcSidebarController.onUpdate(b,c,"",a)});g.setTheme("ace/theme/textmate");g.getSession().setMode("ace/mode/html");g.setOptions({enableBasicAutocompletion:!0,enableSnippets:!0,wrap:!0,indentedSoftWrap:!1,fontSize:11});var h=jQuery("#tdc-ace-editor"),f=jQuery(".tdc-property-textarea_raw_html_ace .tdc-raw-html-ace"),m=h.children(".content");jQuery("body").on("click",".tdc-html-ace-editor-expand-collapse",function(){jQuery(".tdc-property-textarea_raw_html_ace .tdc-property-editor_expand").addClass("disabled");
h.find("header .title").text("HTML Code Editor");h.addClass("tdc-html-ace-editor-expand");m.empty();m.append(jQuery("#"+e+"_ace_html"));h.show();tdcWindowFrame.setWindowFrame(h);g.resize();setTimeout(function(){g.focus()},100)}).on("click",".tdc-html-ace-editor-expand .close",function(){h.removeClass("tdc-html-ace-editor-expand");h.hide();f.append(jQuery("#"+e+"_ace_html"));jQuery(".tdc-property-textarea_raw_html_ace .tdc-property-editor_expand").removeClass("disabled");tdcWindowFrame.unsetWindowFrame(h);
...
b="undefined"!==typeof c.tdb_filters&&!0===c.tdb_filters?b+'<span class="tdc-filter-header-slug">Slug</span>':b+'<span class="tdc-filter-header-name">Name</span>';b+='<span class="tdc-filter-header-type" title="Select type">Type</span>';b="undefined"!==typeof c.tdb_filters&&!0===c.tdb_filters?b+'<span class="tdc-filter-header-multiple" title="Allow multiple selection">Multi</span>':b+'<span class="tdc-filter-header-single">Multi</span><span class="tdc-filter-header-multiple" title="Allow multiple selection">And/Or</span>';
return b+"</div>"},addPagesHeader:function(c,b){var d="undefined"!==typeof c.id_heading_txt?c.id_heading_txt:"URL";b='<div class="tdc-pages-header '+tdcSidebarPanel._getParameterClasses(c)+'">';b=-1===tdcSidebarPanel._getParameterClasses(c).indexOf("tdc-pages-header-url")?b+('<span class="tdc-pages-header-id">'+d+"</span>"):b+('<span class="tdc-pages-header-url">'+d+"</span>");b+='<span class="tdc-pages-header-title">Title</span>';-1===tdcSidebarPanel._getParameterClasses(c).indexOf("no-icon")&&(b+=
'<span class="tdc-pages-header-icon">Icon</span>');return b+"</div>"},addPlansLimitHeader:function(c,b){var d=b="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(d='data-enable-params="'+c.toggle_enable_params+'"');var a="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(a='data-enable-params-reverse="1"');var e="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(e='data-enabled-by="'+c.toggle_enabled_by+'"');b+='<div class="tdc-plans-limit-header '+
tdcSidebarPanel._getParameterClasses(c)+'" '+d+" "+a+" "+e+">";return b+'<span class="tdc-plans-limit-header-id">Plan IDs</span><span class="tdc-plans-limit-header-limit">Limit</span></div>'},addFilterTypeHeader:function(c,b){b='<div class="tdc-filter-header '+tdcSidebarPanel._getParameterClasses(c)+'">';b+='<span class="tdc-filter-header-name">'+c.heading+"</span>";return b+'<span class="tdc-filter-header-type" title="Select filter type">Type</span></div>'},addFilterTitle:function(c,b){var d="",
a="",e="";_.has(c,"info_img")&&""!==c.info_img&&(a='data-info-img="'+c.info_img+'"',_.has(c,"description")&&""!==c.description&&(e='data-info-descr="'+c.description+'"'));var h="";_.has(c,"toggle_enable_params")&&""!==c.toggle_enable_params&&(h='data-enable-params="'+c.toggle_enable_params+'"');var g="";_.has(c,"toggle_enable_params_reverse")&&!0===c.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var f="";_.has(c,"toggle_enabled_by")&&""!==c.toggle_enabled_by&&(f='data-enabled-by="'+
c.toggle_enabled_by+'"');return d+='<div class="tdc-sidebar-filter-title '+tdcSidebarPanel._getParameterClasses(c)+'" '+a+" "+e+" "+h+" "+g+" "+f+'><span class="tdc-search-data">'+tdcSidebarPanel._getParameterCurrentValue(c,b)+"</span></div>"},addSearchSectionHeader:function(c,b){b='<div class="tdc-search-section-header '+tdcSidebarPanel._getParameterClasses(c)+'">';b+='<span class="tdc-search-section-header-title">Section title</span><span class="tdc-search-section-header-tax">Taxonomy</span>';-1===
tdcSidebarPanel._getParameterClasses(c).indexOf("no-level")&&(b+='<span class="tdc-search-section-header-level">Level</span>');return b+"</div>"},addClearfix:function(c,b){return'<div class="clearfix"></div>'},updateTextfieldResponsiveValues:function(c,b,d){"undefined"===typeof window.tdcResponsiveValues[c]?""!==b&&(window.tdcResponsiveValues[c]={},window.tdcResponsiveValues[c][d]={viewportName:b}):""===b?delete window.tdcResponsiveValues[c][d]:window.tdcResponsiveValues[c][d]=b;b=_.allKeys(window.tdcResponsiveValues[c]);
return 1===b.length&&"all"===b[0]?window.tdcResponsiveValues[c].all:1<b.length||1===b.length&&"all"!==b[0]?window.btoa(JSON.stringify(window.tdcResponsiveValues[c])):""},updateDropdownResponsiveValues:function(c,b,d){"undefined"===typeof window.tdcResponsiveValues[c]?(window.tdcResponsiveValues[c]={},window.tdcResponsiveValues[c][d]={},window.tdcResponsiveValues[c][d][d]=b):window.tdcResponsiveValues[c][d]=b;b=_.allKeys(window.tdcResponsiveValues[c]);return 1===b.length&&"all"===b[0]?window.tdcResponsiveValues[c].all:
...
""},deleteResponsiveValue:function(c,b){"undefined"!==typeof window.tdcResponsiveValues[c]&&delete window.tdcResponsiveValues[c][b];b=_.allKeys(window.tdcResponsiveValues[c]);return 1===b.length&&"all"===b[0]?window.tdcResponsiveValues[c].all:1<b.length||1===b.length&&"all"!==b[0]?window.btoa(JSON.stringify(window.tdcResponsiveValues[c])):""},deleteResponsiveValues:function(c){"undefined"!==typeof window.tdcResponsiveValues[c]&&(window.tdcResponsiveValues[c]={})},getCurrentResponsiveValue:function(c,
b){if("undefined"!==typeof window.tdcResponsiveValues[c])return window.tdcResponsiveValues[c][b]},setViewportCurrentResponsiveValue:function(c){var b=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),tdcSidebar.currentViewportSettings.name),d=c.closest(".tdc-property-responsive");if(d.hasClass("tdc-property-textfield-responsive")){var a="";_.isUndefined(c.data("placeholder"))||(a=c.data("placeholder"));c.attr("placeholder",a);_.isUndefined(b)?(b=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),
"all"),_.isUndefined(b)?c.val(""):(c.val(b),c.attr("placeholder",b),d.addClass("tdc-css-inherited"))):(c.val(b),d.removeClass("tdc-css-inherited"))}else if(d.hasClass("tdc-property-checkbox-responsive"))a=d.find(".tdc-inherit-checkbox"),_.isUndefined(b)?(b=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),_.isUndefined(b)?c.prop("checked",!1):(""===b?c.prop("checked",!1):c.prop("checked","checked"),d.addClass("tdc-css-inherited")),a.hide()):(""===b?c.prop("checked",!1):c.prop("checked",
"checked"),d.removeClass("tdc-css-inherited"),"all"===tdcSidebar.currentViewportSettings.name?a.hide():a.show());else if(d.hasClass("tdc-property-dropdown-responsive")){a=d.find(".tdc-inherit-select");var e=c.attr("type");_.isUndefined(b)?(b=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),_.isUndefined(b)?"undefined"!==typeof e&&"radio"===e?c.each(function(a){var b=jQuery(this);"radio"===b.attr("type")&&(0===a?b.prop("checked",!0):b.prop("checked",!1))}):c.find("option:selected").removeAttr("selected").find("option:first").attr("selected",
"selected"):("undefined"!==typeof e&&"radio"===e?c.each(function(a){a=jQuery(this);"radio"===a.attr("type")&&(a.val()===b?a.prop("checked",!0):a.prop("checked",!1))}):c.val(b),d.addClass("tdc-css-inherited")),a.hide()):("undefined"!==typeof e&&"radio"===e?c.each(function(a){a=jQuery(this);"radio"===a.attr("type")&&(a.val()===b?a.prop("checked",!0):a.prop("checked",!1))}):c.val(b),d.removeClass("tdc-css-inherited"),"all"===tdcSidebar.currentViewportSettings.name?a.hide():a.show())}else if(d.hasClass("tdc-property-range-responsive"))a=
"",_.isUndefined(c.data("placeholder"))||(a=c.data("placeholder")),e=c.next('input[type="text"]'),e.attr("placeholder",a),_.isUndefined(b)?(b=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),_.isUndefined(b)?(c.val(""),e.val("")):(c.val(b),e.val(b),e.attr("placeholder",b),d.addClass("tdc-css-inherited"))):(c.val(b),e.val(b),d.removeClass("tdc-css-inherited"));else if(d.hasClass("tdc-property-range_multiple-responsive")){a=tdcIFrameData.getModel(c.data("model_id"));var h=c.data("param_name"),
g=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];a=[];for(var f=e="",n=0;n<g.params.length;n++)if(h===g.params[n].param_name){h=g.params[n].tdc_values;for(var k in h)h.hasOwnProperty(k)&&(a.push(h[k].unit),""===e||""===f)&&(e=h[k].value,f=h[k].unit);break}_.isUndefined(b)?(b=tdcSidebarPanel.getCurrentResponsiveValue(c.attr("name"),"all"),_.isUndefined(b)&&(c.data("range_value",e),c.data("range_unit",f),c.val(e),k=d.find('input[type="radio"][data-unit_value="'+f+'"]'),n=k.data("unit"),
h=c.data("min_"+n),f=c.data("max_"+n),n=c.data("step_"+n),g=c.get(0),k.prop("checked",!0),g.min=h,g.max=f,g.step=n,g.value=e,k.data("last_value",e),d.find('input[type="text"]').val(e)),"all"===tdcSidebar.currentViewportSettings.name?d.removeClass("tdc-css-inherited"):d.addClass("tdc-css-inherited")):d.removeClass("tdc-css-inherited");if(!_.isUndefined(b)){e=[];for(n=0;n<a.length&&!(e=b.split(a[n]),1<e.length);n++);e.length&&(e=e[0],f=a[n],c.data("range_value",e),c.data("range_unit",f),c.val(e),k=
d.find('input[type="radio"][data-unit_value="'+f+'"]'),n=k.data("unit"),h=c.data("min_"+n),f=c.data("max_"+n),n=c.data("step_"+n),g=c.get(0),k.prop("checked",!0),g.min=h,g.max=f,g.step=n,g.value=e,k.data("last_value",e),d.find('input[type="text"]').val(e))}}},showShortcodeFromPath:function(c){if(!_.isUndefined(c)){c=c.toString().split("_");var b;c.forEach(function(a,c){""!==a&&(_.isUndefined(b)?b=tdcIFrameData.tdcTopCollection.at(a):(c=b.get("childCollection"),!_.isUndefined(c)&&c.length>a&&(b=c.at(a))))});
if(!_.isUndefined(b)){var d=b.get("blockUid");if(!_.isUndefined(d)){var a=tdcAdminIFrameUI.getLiveIframe();c=a.contents().find("#"+d);c.length||(c=a.contents().find('[data-td-block-uid="'+d+'"]'));c.length&&(a.contents().scrollTop(c.offset().top-100),d={},tdcOperationUI.inZone(c)?tdcOperationUI.inRow(c)?tdcOperationUI.inColumn(c)?tdcOperationUI.inInnerRow(c)?tdcOperationUI.inInnerColumn(c)?(d.$currentZone=tdcOperationUI.inZone(c),d.$currentRow=tdcOperationUI.inRow(c),d.$currentColumn=tdcOperationUI.inColumn(c),
d.$currentInnerRow=tdcOperationUI.inInnerRow(c),d.$currentInnerColumn=tdcOperationUI.inInnerColumn(c),d.$currentElement=c):(d.$currentZone=tdcOperationUI.inZone(c),d.$currentRow=tdcOperationUI.inRow(c),d.$currentColumn=tdcOperationUI.inColumn(c),d.$currentInnerRow=tdcOperationUI.inInnerRow(c),d.$currentInnerColumn=c):(d.$currentZone=tdcOperationUI.inZone(c),d.$currentRow=tdcOperationUI.inRow(c),d.$currentColumn=tdcOperationUI.inColumn(c),d.$currentInnerRow=c):(d.$currentZone=tdcOperationUI.inZone(c),
d.$currentRow=tdcOperationUI.inRow(c),d.$currentColumn=c):(d.$currentZone=tdcOperationUI.inZone(c),d.$currentRow=c):d.$currentZone=c,tdcSidebar._currentModel=b,c.data("model_id",b.cid),tdcSidebar.setSettings(d,!0,b))}}}}}})();var tdcSidebar;
...
(f(".tdc-tabs a").removeClass("tdc-tab-active"),b.addClass("tdc-tab-active"),f(".tdc-tab-content-wrap .tdc-tab-content").removeClass("tdc-tab-content-visible"),b=b.data("tab-id"),f("#"+b).addClass("tdc-tab-content-visible"))});f("body").on("click",".tdc-responsive-buttons > div",function(d){var a=f(this);a.addClass("selected");a.siblings().removeClass("selected");d=tdcSidebar.currentViewportSettings.name;var e="undefined"===typeof window.td_viewport_interval_list?tdcAdminIFrameUI._liveIframeWindowObject.td_viewport_interval_list:
window.td_viewport_interval_list;var h=tdcAdminIFrameUI.getLiveIframe();if(!c.isUndefined(h))var g=h.contents().find(".tdc-element-selected").offset().top-h.contents().scrollTop();c.isUndefined(tdcCssEditor.timeoutContentWidth)||clearTimeout(tdcCssEditor.timeoutContentWidth);var m="",n=0;a.hasClass("tdc-responsive-all")?(tdcSidebar.currentViewportSettings={name:"all",settings:b},tdcState.isMobileComposer()?c.isUndefined(h)||(m=768,tdcSidebar.setIframeClass("tdc-responsive-tablet-portrait")):c.isUndefined(h)||
(h.css("width","100%"),tdcSidebar.setIframeClass("tdc-responsive-all"))):a.hasClass("tdc-responsive-tablet-landscape")?(tdcSidebar.currentViewportSettings={name:"landscape",settings:{limitTop:e[2].limitBottom,limitBottom:parseInt(e[1].limitBottom)+1}},c.isUndefined(h)||(m=1024,tdcSidebar.setIframeClass("tdc-responsive-tablet-landscape"))):a.hasClass("tdc-responsive-tablet-portrait")?(tdcSidebar.currentViewportSettings={name:"portrait",settings:{limitTop:e[1].limitBottom,limitBottom:parseInt(e[0].limitBottom)+
1}},c.isUndefined(h)||(m=768,tdcSidebar.setIframeClass("tdc-responsive-tablet-portrait"))):a.hasClass("tdc-responsive-phone")&&(tdcSidebar.currentViewportSettings={name:"phone",settings:{limitTop:e[0].limitBottom,limitBottom:b}},c.isUndefined(h)||(m=375,tdcSidebar.setIframeClass("tdc-responsive-phone")));""!==m&&(h.css("width",m),tdcCssEditor.timeoutContentWidth=setTimeout(function(){var a=h.contents().width();a!==m&&a<m&&(n=m-a,h.css("width",m+n))},100));"dev"===window.tdcAdminSettings.deployMode&&
"module"!==window.tdcPostSettings.tdbTemplateType&&tdcCssEditor.setMediaInterval(m,n);f(".tdc-responsiveness").replaceWith(tdcCssEditor.generateEditorResponsiveContent());tdcSidebarPanel._hook.doAction("panel_css");if(!c.isUndefined(h)){a=h.contents().find(".tdc-element-selected");if(!a.length)return;a=a.offset().top;a=0<g?window.innerHeight>g?a-g:a-100:a-100;h.contents().scrollTop(a)}"all"===tdcSidebar.currentViewportSettings.name?(f(".tdc-tab-content-wrap").removeClass("tdc-viewport-responsive"),
f(".tdc-tab-content-wrap").removeAttr("data-viewport")):(f(".tdc-tab-content-wrap").addClass("tdc-viewport-responsive"),f(".tdc-tab-content-wrap").attr("data-viewport",tdcSidebar.currentViewportSettings.name));f(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=f(this).find("[data-responsive]");tdcSidebarPanel.setViewportCurrentResponsiveValue(a)});if("undefined"!==typeof tdcTemplateSettingsPanel.$panel&&"module"===window.tdcPostSettings.tdbTemplateType){g=tdcSidebar.currentViewportSettings.name;
a="";e=tdcTemplateSettingsPanel.$panel.find(".tdc-tsc-viewport-width");var k=e.find('[data-viewport="'+g+'"]'),l="";switch(g){case "all":a="Desktop";break;case "landscape":a="Landscape tablet";break;case "portrait":a="Portrait tablet";break;case "phone":a="Phone"}e.find(".tdc-tsc-label span").text("("+a+")");e.find('[id*="tdc-tsc-viewport"]').hide();k.show();"all"===g?l=""!==k.val()?k.val():"100%":""!==k.val()?l=k.val():(g=e.find('[data-viewport="all"]'),l=""!==g.val()?g.val():"100%");h.contents().find("body").css("width",
l)}setTimeout(function(){tdcIFrameData.addDummyContent();var a=h.contents().find(".td_block_wrap");window.checkTdBlockWrap(a)},100);document.dispatchEvent(new CustomEvent("tdc.viewportChanged",{detail:{oldViewport:d,currentViewport:tdcSidebar.currentViewportSettings.name}}))});f("body").on("change, keyup",'.tdc-search input[type="text"]',function(b){b=f(this);var a=f(".tdc-inspector"),d=a.find(".tdc-tab-content-wrap");a.find(".tdc-search-notice").remove();a.find(".tdc-tab-search-notice").hide();var h=
b.val().trim().toLowerCase();2<h.length&&d.find(".tdc-search-data").each(function(b,d){b=f(d);d=b.text();!c.isUndefined(d)&&0<=d.toLowerCase().indexOf(h)&&(d="tdc-search-notice",b.hasClass("tdc-search-notice-font")&&(d+=" tdc-search-notice-font"),f('<div class="'+d+'"></div>').insertBefore(b.closest(".tdc-property-wrap")),b=b.closest(".tdc-tab-content").attr("id"),a.find('.tdc-tabs a[data-tab-id="'+b+'"] .tdc-tab-search-notice').show())})})},setIframeClass:function(b){var a=["tdc-responsive-all",
"tdc-responsive-tablet-landscape","tdc-responsive-tablet-portrait","tdc-responsive-phone"];if(-1!==a.indexOf(b)){var c=tdcAdminIFrameUI.getLiveIframe();c.addClass(b);a.forEach(function(a){a!==b&&c.removeClass(a)})}},_setCurrentTabId:function(b){tdcSidebar._currentTabId=b},getCurrentTabId:function(){return tdcSidebar._currentTabId},_setCurrentElement:function(b){tdcSidebar._$currentElement=b},getCurrentElement:function(){return tdcSidebar._$currentElement},_setCurrentZone:function(b){tdcSidebar._$currentZone=
b},getCurrentZone:function(){return tdcSidebar._$currentZone},_setCurrentRow:function(b){tdcSidebar._$currentRow=b},getCurrentRow:function(){return tdcSidebar._$currentRow},_setCurrentColumn:function(b){tdcSidebar._$currentColumn=b},getCurrentColumn:function(){return tdcSidebar._$currentColumn},_setCurrentInnerRow:function(b){tdcSidebar._$currentInnerRow=b},getCurrentInnerRow:function(){return tdcSidebar._$currentInnerRow},_setCurrentInnerColumn:function(b){tdcSidebar._$currentInnerColumn=b},getCurrentInnerColumn:function(){return tdcSidebar._$currentInnerColumn},
setSidebarInfo:function(b){tdcSidebar.$_sidebarInfo.html(b)},getCurrentModel:function(){return tdcSidebar._currentModel},setSettings:function(d,a,e,h){if(c.isUndefined(tdcSidebar._currentModel)||c.isUndefined(e)||tdcSidebar._currentModel===e)c.isUndefined(tdcSidebar._currentModel)||tdcSidebar._currentModel.set("current",!1),c.isUndefined(d)?(tdcSidebar._setCurrentZone(b),tdcSidebar._setCurrentRow(b),tdcSidebar._setCurrentColumn(b),tdcSidebar._setCurrentInnerRow(b),tdcSidebar._setCurrentInnerColumn(b),
tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=b):c.has(d,"$currentZone")&&!c.isUndefined(d.$currentZone)?(tdcSidebar._setCurrentZone(d.$currentZone),c.has(d,"$currentRow")&&!c.isUndefined(d.$currentRow)?(tdcSidebar._setCurrentRow(d.$currentRow),c.has(d,"$currentColumn")&&!c.isUndefined(d.$currentColumn)?(tdcSidebar._setCurrentColumn(d.$currentColumn),c.has(d,"$currentInnerRow")&&!c.isUndefined(d.$currentInnerRow)?(tdcSidebar._setCurrentInnerRow(d.$currentInnerRow),c.has(d,"$currentInnerColumn")&&
!c.isUndefined(d.$currentInnerColumn)?(tdcSidebar._setCurrentInnerColumn(d.$currentInnerColumn),c.has(d,"$currentElement")&&!c.isUndefined(d.$currentElement)?(tdcSidebar._setCurrentElement(d.$currentElement),tdcSidebar._currentModel=tdcIFrameData.getModel(d.$currentElement.data("model_id"))):(tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=tdcIFrameData.getModel(d.$currentInnerColumn.data("model_id")))):(tdcSidebar._setCurrentInnerColumn(b),tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=
tdcIFrameData.getModel(d.$currentInnerRow.data("model_id")))):(tdcSidebar._setCurrentInnerRow(b),tdcSidebar._setCurrentInnerColumn(b),c.has(d,"$currentElement")&&!c.isUndefined(d.$currentElement)?(tdcSidebar._setCurrentElement(d.$currentElement),tdcSidebar._currentModel=tdcIFrameData.getModel(d.$currentElement.data("model_id"))):(tdcSidebar._setCurrentElement(b),tdcSidebar._currentModel=tdcIFrameData.getModel(d.$currentColumn.data("model_id"))))):(tdcSidebar._setCurrentColumn(b),tdcSidebar._setCurrentInnerRow(b),
...
e.model=c.model;e.shortcode=d.getShortcode;e.columns=tdcIFrameData.getColumnNumber(c.model);e.blockUid=a;parseInt(c.model.get("level"),10);c.model.set("bindNewContent",!0);e.success_callback=function(b){var d=tdcAdminIFrameUI.getIframeWindow();tdcIFrameData.deleteCallback(c.model);c.model.set("blockUid",b.blockUid);_.has(b,"replyHtml")&&(c.model.set("shortcode",e.shortcode),c.model.set("html",b.replyHtml));_.has(b,"replyJsForEval")&&(d.tdcEvalGlobal={oldBlockUid:a},tdcAdminIFrameUI.evalInIframe(b.replyJsForEval));
...
".tdc-tab-design input.tdc-css-z-index",tdcCssEditor._changeTextInput);b.on("change",".tdc-tab-design .tdc-css-display",tdcCssEditor._changeDropDown);b.on("change",".tdc-tab-design .tdc-css-scroll-anim",tdcCssEditor._changeDropDown);b.on("keydown",".tdc-tab-design input.tdc-css-scroll-anim-distance",tdcCssEditor._keydownTextInput);b.on("keyup mousewheel",".tdc-tab-design input.tdc-css-scroll-anim-distance",tdcCssEditor._changeTextInput);b.on("keydown",".tdc-tab-design input.tdc-css-scroll-anim-duration",
tdcCssEditor._keydownTextInput);b.on("keyup mousewheel",".tdc-tab-design input.tdc-css-scroll-anim-duration",tdcCssEditor._changeTextInput);b.on("mousedown",".tdc-tab-design .wp-picker-clear",tdcCssEditor._clearColorPicker);b.on("click",".tdc-tab-design .tdc-inherit-select",tdcCssEditor._inheritSelect);b.on("click",".tdc-tab-design .tdc-inherit-color",tdcCssEditor._inheritColor);b.on("click",".tdc-tab-design .tdc-css-image-wrap",tdcCssEditor.tdcCssImageWrapHandler);b.on("click",".tdc-tab-design .tdc-css-image-remove",
...
(tdcSidebarPanel._getParamterDataAtts(g,m)+' name="">');k+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Show"},{value:"none",display:"Hidden"},{value:"inline",display:"Inline"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"},{value:"inline-table",display:"Inline-table"}],l);k+='</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
l=tdcCssEditor._getSettingsProperty("--tdb-scroll-anim","",d());k+='<div class="tdc-property-wrap tdc-scroll-anim tdc-dropdown-big'+e()+'" data-tdc-for="--tdb-scroll-anim">';k=k+'<div class="tdc-property-title"><span title="Scroll animation on reveal" class="tdc-search-data">Scroll animation<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-scroll-anim" '+(tdcSidebarPanel._getParamterDataAtts(g,m)+' name="">');
k+=tdcCssEditor._generateDropdownOptions([{value:"none",display:"None"},{value:"slide-up",display:"Slide up"},{value:"slide-down",display:"Slide down"},{value:"slide-left",display:"Slide left"},{value:"slide-right",display:"Slide right"},{value:"fade",display:"Fade in"}],l);k+="</select></div></div>";l=tdcCssEditor._getSettingsProperty("--tdb-scroll-anim-distance","",d());p="";n.isInherited&&(p=l,l="");k+='<div class="tdc-property-wrap tdc-scroll-anim-distance tdc-textfield-small'+e()+'" data-tdc-for="--tdb-scroll-anim-distance">';
k=k+'<div class="tdc-property-title"><span title="Scroll animation distance (e.g. 80px)" class="tdc-search-data">Scroll distance</span></div><div class="tdc-property"><input class="tdc-css-scroll-anim-distance" '+(tdcSidebarPanel._getParamterDataAtts(g,m)+' name="" type="text" '+a(p)+' value="'+l+'"/>');k+="</div></div>";l=tdcCssEditor._getSettingsProperty("--tdb-scroll-anim-duration","",d());p="";n.isInherited&&(p=l,l="");k+='<div class="tdc-property-wrap tdc-scroll-anim-duration tdc-textfield-small'+
e()+'" data-tdc-for="--tdb-scroll-anim-duration">';k=k+'<div class="tdc-property-title"><span title="Scroll animation duration (e.g. 0.6s, 400ms)" class="tdc-search-data">Scroll duration</span></div><div class="tdc-property"><input class="tdc-css-scroll-anim-duration" '+(tdcSidebarPanel._getParamterDataAtts(g,m)+' name="" type="text" '+a(p)+' value="'+l+'"/>');k=k+'</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div><div class="tdc-clear-css-properties" '+
...
m=b.find(".tdc-css-box-input-margin-left").val().trim(),n=b.find(".tdc-css-box-input-border-top-width").val().trim(),k=b.find(".tdc-css-box-input-border-right-width").val().trim(),l=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),p=b.find(".tdc-css-box-input-border-left-width").val().trim(),q=b.find(".tdc-css-box-input-padding-top").val().trim(),r=b.find(".tdc-css-box-input-padding-right").val().trim(),t=b.find(".tdc-css-box-input-padding-bottom").val().trim(),v=b.find(".tdc-css-box-input-padding-left").val().trim(),
u=b.find(".tdc-css-border-radius").val().trim(),x=b.find(".tdc-css-width").val().trim(),C=b.find(".tdc-css-height").val().trim(),z=b.find(".tdc-css-shadow-size").val().trim(),w=b.find(".tdc-css-shadow-offset-h").val().trim(),y=b.find(".tdc-css-shadow-offset-v").val().trim(),A=b.find(".tdc-css-opacity").val().trim(),B=b.find(".tdc-css-gradient-direction").val().trim();b.find(".tdc-css-scroll-anim-distance").val().trim();b.find(".tdc-css-scroll-anim-duration").val().trim();var E=b.find(".tdc-css-z-index").val().trim(),
D="";b.find(".tdc-css-order").length&&(D=b.find(".tdc-css-order").val().trim());""!==d&&(a["margin-top"]=d);""!==f&&(a["margin-right"]=f);""!==g&&(a["margin-bottom"]=g);""!==m&&(a["margin-left"]=m);""!==n&&(a["border-top-width"]=n);""!==k&&(a["border-right-width"]=k);""!==l&&(a["border-bottom-width"]=l);""!==p&&(a["border-left-width"]=p);""!==q&&(a["padding-top"]=q);""!==r&&(a["padding-right"]=r);""!==t&&(a["padding-bottom"]=t);""!==v&&(a["padding-left"]=v);d=b.find(".tdc-css-border-style");f=d.val().trim();
""===f||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["border-style"]=f);d=b.find(".tdc-css-border-color");f=d.val().trim();""!==f?a["border-color"]=f:(d=d.data("no_value"),c.isUndefined(d)||1!==d||(a["border-color"]="no_value"));""!==u&&(a["border-radius"]=u);""!==x&&(a.width=x);""!==C&&(a.height=C);""!==z&&(a["shadow-size"]=z);u=b.find(".tdc-css-shadow-color");x=u.val().trim();""!==x?a["shadow-color"]=x:(u=u.data("no_value"),c.isUndefined(u)||1!==u||(a["shadow-color"]=
"no_value"));""!==w&&(a["shadow-offset-h"]=w);""!==y&&(a["shadow-offset-v"]=y);w=b.find(".tdc-css-bg-color");y=w.val().trim();""!==y?a["background-color"]=y:(w=w.data("no_value"),c.isUndefined(w)||1!==w||(a["background-color"]="no_value"));w=b.find(".tdc-css-bg-image");w.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(w=w.data("image_link"),c.isUndefined(w)||("no_value"===w?a["background-image"]="no_value":""!==w&&(a["background-image"]='url("'+w+'")')));w=b.find(".tdc-css-bg-style");
y=w.val().trim();""===y||w.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["background-style"]=y);w=b.find(".tdc-css-bg-position");y=w.val().trim();""===y||w.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["background-position"]=y);""!==A&&(a.opacity=A);A=b.find(".tdc-css-color-1-overlay");w=A.val().trim();""!==w?a["color-1-overlay"]=w:(A=A.data("no_value"),c.isUndefined(A)||1!==A||(a["color-1-overlay"]="no_value"));A=b.find(".tdc-css-color-2-overlay");
w=A.val().trim();""!==w?a["color-2-overlay"]=w:(A=A.data("no_value"),c.isUndefined(A)||1!==A||(a["color-2-overlay"]="no_value"));""!==B&&(a["gradient-direction"]=B);""!==D&&(a.order=D);""!==E&&(a["z-index"]=E);B=b.find(".tdc-css-content-h-align");E=B.val().trim();""===E||B.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(a["content-h-align"]=E);B=b.find(".tdc-css-display");a.display=B.val().trim();B=b.find(".tdc-css-scroll-anim");E=B.val().trim();""===E||B.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||
(a["--tdb-scroll-anim"]=E);B=b.find(".tdc-css-scroll-anim-distance").val().trim();""!==B&&(/^[0-9.]+$/.test(B)&&(B+="px"),a["--tdb-scroll-anim-distance"]=B);b=b.find(".tdc-css-scroll-anim-duration").val().trim();""!==b&&(/^[0-9.]+$/.test(b)&&(b+="s"),a["--tdb-scroll-anim-duration"]=b);c.isUndefined(tdcCssEditor._currentCssSettings)&&(tdcCssEditor._currentCssSettings={});c.isUndefined(a["border-style"])||"solid"!==a["border-style"]||("all"===tdcSidebar.currentViewportSettings.name||c.isUndefined(tdcCssEditor._currentCssSettings.all)||
...
d=b="";/var\(--[a-zA-z0-9\-]*\)/.test(a)&&(b='<i class="tdc-font-tdmp tdc-font-tdmp-globe"></i>',d=(a.includes("--td_aib_color")?"AI builder color: ":"Global color: ")+a);m.prepend('<div class="tdc-color-value" data-color="'+a+'" style="background-color:'+a+'" title="'+d+'"><div class="tdc-color-value-delete"></div>'+b+"</div>");g.prepend('<div class="tdc-gradient-color-value" data-color="'+a+'" style="background-color:'+a+'" title="'+d+'"><div class="tdc-gradient-color-value-delete"></div>'+b+"</div>")}}});
"undefined"===typeof f.fn.tdGradient&&(f.fn.tdGradient=function(){return this.each(function(){var a=this,b=f(this);a.$this=b;if(!1!==b.data("rgba")){var h=f.cs_ParseColorValue(b.val());b.tdGradientColorPicker({clear:function(){a.$container.find(".tdc-global-colors-values .tdc-global-color-value, .tdc-aib-active-colors-values .tdc-aib-active-color-value").each(function(){f(this).removeClass("current")});jQuery("#tdc-gradient").prev(".tdc-property-wrap").find("i").remove();b.trigger("keyup")},change:function(c,
d){c=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",c);b.val(c).trigger("change");a.triggerSelection?a.setColor(c,!0):a.setColor(c)},create:function(){var e=b.data("a8cIris"),m=b.closest(".wp-picker-container"),n=f('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(m.find(".wp-picker-holder")),k=n.find(".cs-alpha-slider"),l=n.find(".cs-alpha-text"),
p=n.find(".cs-alpha-slider-offset"),q=f('<div class="tdc-gradient-result-wrap"></div>').prependTo(m),r=f('<div class="tdc-gradient-result"><div class="tdc-gradient-color tdc-gradient-left-color"></div><div class="tdc-gradient-color tdc-gradient-right-color"></div></div>').prependTo(q);f('<div class="tdc-gradient-degree-label">deg.</div><input class="tdc-gradient-degree" placeholder="0">').appendTo(m.find(".wp-picker-input-wrap"));f('<div class="tdc-gradient-result-labels"><div class="tdc-gradient-result-label">Solid color</div><div class="tdc-gradient-result-label tdc-gradient-result-percentage"></div><div class="tdc-gradient-result-label">Gradient</div></div>').prependTo(m);
f('<div class="tdc-gradient-save">Save Gradient</div>').appendTo(m);var t=f('<div class="tdc-gradient-presets">Gradient presets</div>').appendTo(m);q=f('<div class="tdc-gradient-values-wrapper"></div>').appendTo(m);var v=f('<div class="tdc-gradient-values"></div>').appendTo(q);q=f('<div class="tdc-gradient-color-values-wrapper"></div>').appendTo(m);q=f('<div class="tdc-gradient-color-values"></div>').appendTo(q);if("undefined"!==typeof c.tdcAdminSettings.tdcSavings.gradients&&c.tdcAdminSettings.tdcSavings.gradients.length)for(var u=
!1,x=c.tdcAdminSettings.tdcSavings.gradients.length-1;0<=x;x--){var C=c.tdcAdminSettings.tdcSavings.gradients[x];try{var z=JSON.parse(c.atob(C));"undefined"!==typeof z.css&&(u=!0,f('<div class="tdc-gradient-value" style="'+z.css+'" data-gradient="'+C+'"><div class="tdc-gradient-value-delete"></div></div>').appendTo(v))}catch(y){}}u||t.hide();a.$container=m;a.$gradientResult=r;if("undefined"!==typeof c.tdc_wm_global_colors){var w=f('<div class="tdc-global-colors-values"></div>').insertAfter(m.find(".tdc-gradient-values-wrapper"));
Object.entries(c.tdc_wm_global_colors).forEach(function(a){var b=a[1].color,c=a[1].name;a="var(--"+a[0].replace(/_/g,"-")+")";f('<div class="tdc-global-color-value" style="background-color: '+a+'" data-color="'+b+'" data-color-var="'+a+'" title="'+c+'"></div>').prependTo(w)})}if(!_.isUndefined(c.tdAibOptions)&&!_.isUndefined(c.tdAibOptions.colors)&&!_.isUndefined(c.tdAibOptions.colors.active))for(u=f('<div class="tdc-aib-active-colors-values"></div>').insertAfter(m.find(".tdc-global-colors-values")),
x=$jscomp.makeIterator(Object.entries(c.tdAibOptions.colors.active)),r=x.next();!r.done;r=x.next())t=$jscomp.makeIterator(r.value),r=t.next().value,t=t.next().value,v="var(--td_aib_color_"+r+")",f('<div class="tdc-aib-active-color-value" style="background-color: '+v+'" data-color="'+t.color+'" data-color-var="'+v+'" title="'+r.split("_").map(function(a){return a.charAt(0).toUpperCase()+a.slice(1)}).join(" ")+'"></div>').prependTo(u);k.slider({slide:function(a,c){a=parseFloat(c.value/100);e._color._alpha=
a;b.tdGradientColorPicker("color",e._color.toString());l.text(1>a?a:"")},create:function(){var c=parseFloat(h.alpha/100);l.text(1>c?c:"");p.css("background-color",h.value);m.on("click",".wp-picker-clear",function(){e._color._alpha=1;l.text("");k.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(d,!0):a.setColor(d)});m.on("click",".wp-picker-default",function(){var a=f.cs_ParseColorValue(b.data("default-color")),c=parseFloat(a.alpha/100);e._color._alpha=c;l.text(1>c?c:"");
k.slider("option","value",a.alpha).trigger("slide")});m.on("click",".wp-color-result",function(a){n.toggle()});f("body").on("click.wpcolorpicker",function(){n.hide()});m.on("change keyup",".tdc-gradient-degree",function(b){b=f(this);a.degree=b.val().trim();a.mixedColors=a._getMixedColors();a._updateGradient();a._saveValue()})},value:h.alpha,step:1,min:0,max:100});if("undefined"!==typeof c.tdcAdminSettings.tdcSavings.recentColors&&c.tdcAdminSettings.tdcSavings.recentColors.length)for(x=c.tdcAdminSettings.tdcSavings.recentColors.length-
1;0<=x;x--){u=c.tdcAdminSettings.tdcSavings.recentColors[x];try{z=JSON.parse(c.atob(u)),"undefined"!==typeof z&&(r=u="",/var\(--[a-zA-z0-9\-]*\)/.test(z)&&(u='<i class="tdc-font-tdmp tdc-font-tdmp-globe"></i>',r=(z.includes("--td_aib_color")?"AI builder color: ":"Global color: ")+z),f('<div class="tdc-gradient-color-value" style="background-color: '+z+'" data-color="'+z+'" title="'+r+'"><div class="tdc-gradient-color-value-delete"></div>'+u+"</div>").appendTo(q))}catch(y){}}}})}else b.tdGradientColorPicker({clear:function(){b.trigger("keyup")},
...
b/(c.width()-d.outerWidth(!0)));d.css("left",b);d.data("percentage",c);a.currentColor="mixed"}}),a.$container.on("mouseup",".tdc-gradient-mix-color",function(b){f(this).removeClass("tdc-gradient-current-mix");a.eventOffsetX=d}),a.$container.on("mousemove",".tdc-gradient-result",function(b){var c=a.$container.find(".tdc-gradient-result-percentage"),d=a.$container.find(".tdc-gradient-result"),e=d.find(".tdc-gradient-right-color"),f=d.find(".tdc-gradient-current-mix");if(f.length){var g=0;"undefined"!==
...
a=a.data("percentage");b.push({color:c,percentage:a})});b.sort(function(a,b){return a.percentage-b.percentage});return b},a._updateGradient=function(){if("undefined"!==typeof a.color1&&"undefined"!==typeof a.color2&&a.color1!==a.color2){var b="",c="",e=c="",h=["-webkit-linear-gradient","linear-gradient"];c="undefined"!==typeof a.degree&&""!==a.degree.trim()?a.degree+"deg,":"0deg,";for(var l=0;l<h.length;l++){var p="";if("undefined"!==typeof a.mixedColors)for(var q=0;q<a.mixedColors.length;q++){var r=
"";"undefined"!==typeof a.mixedColors[q].percentage&&(r=a.mixedColors[q].percentage+"%");"undefined"!==typeof a.mixedColors[q].color&&(p+=a.mixedColors[q].color+" "+r+",")}b+="background: "+h[l]+"("+c+a.color2+","+p+a.color1+");";e+="background: "+h[l]+"( -90deg,"+a.color2+","+p+a.color1+");"}c=c+a.color2+","+p+a.color1;a.result={type:"gradient",color1:a.color1,color2:a.color2,mixedColors:a.mixedColors,degree:a.degree,css:b,cssParams:c};a.$gradientResult.attr("style",e)}else if("undefined"!==typeof a.color1||
"undefined"!==typeof a.color2){b="color1";var t="color2";"undefined"!==typeof a.color2&&(b="color2",t="color1");if(a.mixedColors.length){var v=a.mixedColors[0];"undefined"!==typeof a.color2&&(v=a.mixedColors[a.mixedColors.length-1]);b=a.$container.find(".tdc-gradient-result").find(".tdc-gradient-mix-color");f.each(b,function(){var b=f(this);v.color===b.data("color")&&v.percentage===b.data("percentage")&&(a[t]=b.data("color"),b.remove())});a.mixedColors=a._getMixedColors();a._updateGradient();a._showColor(a[t])}else a.result=
{type:"solid",color:a[b],css:"background: "+a[b]+";"},a.$gradientResult.css("background",a[b])}else a.result=d,a.$gradientResult.css("background","")},a.$container.on("mousedown",".tdc-gradient-save",function(b){var d=a.$container.find(".tdc-gradient-values");""===c.tdcAdminSettings.tdcSavings&&(c.tdcAdminSettings.tdcSavings={});"undefined"===typeof c.tdcAdminSettings.tdcSavings.gradients&&(c.tdcAdminSettings.tdcSavings.gradients=[]);if("gradient"===a.result.type){var e=c.btoa(JSON.stringify(a.result));
-1===c.tdcAdminSettings.tdcSavings.gradients.indexOf(e)&&(c.tdcAdminSettings.tdcSavings.gradients.push(e),tdcUtil.updateTdcSavings(this,function(){f('<div class="tdc-gradient-value" style="'+a.result.css+'" data-gradient="'+e+'"><div class="tdc-gradient-value-delete"></div></div>').prependTo(d);a.$container.find(".tdc-gradient-presets").show()}))}}),a.$container.on("mousedown",".tdc-gradient-value",function(b){b=jQuery(b.currentTarget).data("gradient");var c=a.$container.parent().prev(".tdc-property-gradient"),
d=c.find("input");c=c.find(".tdc-gradient-wrap");a.init(b);d.val(b);c.attr("style",a.result.css);d.trigger("change")}),a.$container.on("mousedown",".tdc-gradient-color-value",function(b){var c=jQuery(b.currentTarget).data("color"),d=a.$container.parent().prev(".tdc-property-gradient");b=d.find("input");d=d.find(".tdc-gradient-wrap");c=tdcUtil.b64EncodeUnicode(JSON.stringify({type:"gradient",color1:c,color2:c,mixedColors:[],degree:"-90",css:"background-color: "+c+";",cssParams:"0deg,"+c+","+c}));a.init(c);
b.val(c);d.attr("style",a.result.css);b.trigger("change")}),a.$container.on("mousedown",".tdc-global-color-value, .tdc-aib-active-color-value",function(b){var c=jQuery(b.currentTarget);b=c.data("color");c=c.data("color-var");"undefined"!==typeof c?a.init(c):a.init(b);a._saveValue()}),a.$container.on("tdc_wm_global_colors_update",".tdc-global-colors-values",function(b,c,d){if("new"===c){b=d.color;var e=d.color_name,g="var(--"+d.color_option_id.replace(/_/g,"-")+")";f('<div class="tdc-global-color-value" style="background-color: '+
g+'" data-color="'+b+'" data-color-var="'+g+'" title="'+e+'"></div>').prependTo(f(this))}"update"===c&&(b=d.color,e="var(--"+d.option.replace(/_/g,"-")+")",f(this).find("[data-color-var='"+e+"']").data("color",b));"col_name_update"===c&&(e=d.new_option,b="var(--"+d.option.replace(/_/g,"-")+")",e="var(--"+e.replace(/_/g,"-")+")",g=d.color_name,f(this).find("[data-color-var='"+b+"']").attr("title",g).data("color-var",e).attr("data-color-var",e).css("background",e));"delete"===c&&(c="var(--"+d.option.replace(/_/g,
"-")+")",f(this).find("[data-color-var='"+c+"']").remove(),a.$container.find(".wp-picker-clear").trigger("click"),a.$container.find(".tdc-gradient-color-values [data-color='"+c+"'] .tdc-gradient-color-value-delete").trigger("mousedown"))}),a.$container.on("mousedown",".tdc-gradient-value-delete",function(b){b.preventDefault();b.stopImmediatePropagation();if("undefined"===typeof c.tdcAdminSettings.tdcSavings.gradients||0===c.tdcAdminSettings.tdcSavings.gradients.length)a.$container.find(".tdc-gradient-value").remove();
else{var d=f(this).parent();b=d.data("gradient");b=c.tdcAdminSettings.tdcSavings.gradients.indexOf(b);c.tdcAdminSettings.tdcSavings.gradients.splice(b,1);b=!0;for(var e in c.tdcAdminSettings.tdcSavings)if(c.tdcAdminSettings.tdcSavings[e].length){b=!1;break}b&&(c.tdcAdminSettings.tdcSavings="");tdcUtil.updateTdcSavings(this,function(){""!==c.tdcAdminSettings.tdcSavings&&0!==c.tdcAdminSettings.tdcSavings.gradients.length||a.$container.find(".tdc-gradient-presets").hide();d.remove()})}}),a.$container.on("mousedown",
".tdc-gradient-color-value-delete",function(a){a.preventDefault();a.stopImmediatePropagation();var b=f(this).parent();a=b.data("color");a=c.btoa(JSON.stringify(a));a=c.tdcAdminSettings.tdcSavings.recentColors.indexOf(a);c.tdcAdminSettings.tdcSavings.recentColors.splice(a,1);a=!0;for(var d in c.tdcAdminSettings.tdcSavings)if(c.tdcAdminSettings.tdcSavings[d].length){a=!1;break}a&&(c.tdcAdminSettings.tdcSavings="");tdcUtil.updateTdcSavings(this,function(){b.remove()})}),a._saveValue=function(){var b=
a.$container.parent().prev(".tdc-property-gradient"),d=b.find("input");b=b.find(".tdc-gradient-wrap");if("undefined"===typeof a.result)d.val(""),b.removeAttr("style");else{var e=b.find("i");/var\(--[a-zA-z0-9\-]*\)/.test(a.result.color)?(e.length||b.append('<i class="tdc-font-tdmp tdc-font-tdmp-globe"></i>'),b.attr("title",(a.result.color.includes("--td_aib_color")?"AI builder color: ":"Global color: ")+a.result.color)):(a.$container.find(".tdc-global-colors-values .tdc-global-color-value, .tdc-aib-active-colors-values .tdc-aib-active-color-value").each(function(){f(this).removeClass("current")}),
e.length&&e.remove());switch(a.result.type){case "solid":d.val(a.result.color);break;case "gradient":d.val(c.btoa(JSON.stringify(a.result)))}b.attr("style",a.result.css)}d.trigger("change")},a.init=function(b){a.triggerSelection=!1;a.color1=d;a.color2=d;a.mixedColors=d;a.degree=d;a.currentColor=d;a.$container.find(".cs-alpha-text").text("");a.$container.find(".cs-alpha-slider-offset").css("background-color","");a.$container.find(".cs-alpha-slider").slider("option","value",100).trigger("slide");a.$container.find(".tdc-global-colors-values .tdc-global-color-value, .tdc-aib-active-colors-values .tdc-aib-active-color-value").each(function(){var a=
f(this);a.removeClass("current");/var\(--[a-zA-z0-9\-]*\)/.test(b)&&a.data("color-var")===b&&a.addClass("current")});var e=a.$container.find(".tdc-gradient-result");e.find(".tdc-gradient-mix-color").remove();if("undefined"!==typeof b&&""!==b){try{b=JSON.parse(c.atob(b));a.color1=b.color1;a.color2=b.color2;a.degree=b.degree;a.setColor(a.color1);a.$this.tdGradientColorPicker("color",a.color1);a.mixedColors=b.mixedColors;if("undefined"!==typeof a.mixedColors)for(var g=0;g<a.mixedColors.length;g++){var h=
f('<div class="tdc-gradient-color tdc-gradient-mix-color"></div>').appendTo(e),l=(e.width()-h.outerWidth(!0))*(100-a.mixedColors[g].percentage)/100;h.css("left",l);h.data("percentage",a.mixedColors[g].percentage);"undefined"!==typeof a.mixedColors[g].color&&h.data("color",a.mixedColors[g].color)}a._updateGradient()}catch(p){a.setColor(b),a.$this.tdGradientColorPicker("color",b)}e=f.cs_ParseColorValue(a.color1);g=parseFloat(e.alpha/100);g=1>g?g:"";a.$container.find(".cs-alpha-text").text(g);a.$container.find(".cs-alpha-slider-offset").css("background-color",
e.value);a.$container.find(".cs-alpha-slider").slider("option","value",e.alpha).trigger("slide")}else a.setColor(d),a.$container.find(".wp-picker-clear").trigger("click");a.triggerSelection=!0})})});"undefined"===typeof f.fn.tdPalette&&(f.fn.tdPalette=function(){return this.each(function(){var a=this,b=f(this);a.$this=b;if(!1!==b.data("rgba")){var h=f.cs_ParseColorValue(b.val());b.tdPaletteColorPicker({clear:function(){a.$container.find(".tdc-global-colors-values .tdc-color-value, .tdc-aib-active-colors-values .tdc-aib-active-color-value").each(function(){f(this).removeClass("current")});
jQuery("#tdc-palette").prev(".tdc-property-wrap").find("i").remove();b.trigger("keyup")},change:function(c,d){c=d.color.toString();b.closest(".wp-picker-container").find(".cs-alpha-slider-offset").css("background-color",c);b.val(c).trigger("change");a.triggerSelection?a.setColor(c,!0):a.setColor(c)},create:function(){var e=b.data("a8cIris"),m=b.closest(".wp-picker-container"),n=f('<div class="cs-alpha-wrap"><div class="cs-alpha-slider"></div><div class="cs-alpha-slider-offset"></div><div class="cs-alpha-text"></div></div>').appendTo(m.find(".wp-picker-holder")),
k=n.find(".cs-alpha-slider"),l=n.find(".cs-alpha-text"),p=n.find(".cs-alpha-slider-offset"),q=f('<div class="tdc-color-values"></div>').appendTo(m.find(".wp-picker-holder"));a.$container=m;if("undefined"!==typeof c.tdcAdminSettings.tdcSavings.recentColors&&c.tdcAdminSettings.tdcSavings.recentColors.length)for(var r=c.tdcAdminSettings.tdcSavings.recentColors.length-1;0<=r;r--){var t=c.tdcAdminSettings.tdcSavings.recentColors[r];try{var v=JSON.parse(c.atob(t));if("undefined"!==typeof v){var u=t="";
/var\(--[a-zA-z0-9\-]*\)/.test(v)&&(t='<i class="tdc-font-tdmp tdc-font-tdmp-globe"></i>',u=(v.includes("--td_aib_color")?"AI builder color: ":"Global color: ")+v);f('<div class="tdc-color-value" style="background-color: '+v+'" data-color="'+v+'" title="'+u+'"><div class="tdc-color-value-delete"></div>'+t+"</div>").appendTo(q)}}catch(C){}}if("undefined"!==typeof c.tdc_wm_global_colors){var x=f('<div class="tdc-global-colors-values"></div>').insertAfter(m.find(".wp-picker-holder .cs-alpha-wrap"));
Object.entries(c.tdc_wm_global_colors).forEach(function(a){var b=a[1].color,c=a[1].name;a="var(--"+a[0].replace(/_/g,"-")+")";f('<div class="tdc-color-value" style="background-color: '+a+'" data-color="'+b+'" data-color-var="'+a+'" title="'+c+'"></div>').prependTo(x)})}if(!_.isUndefined(c.tdAibOptions)&&!_.isUndefined(c.tdAibOptions.colors)&&!_.isUndefined(c.tdAibOptions.colors.active))for(q=f('<div class="tdc-aib-active-colors-values"></div>').insertAfter(m.find(".tdc-global-colors-values")),r=$jscomp.makeIterator(Object.entries(c.tdAibOptions.colors.active)),
v=r.next();!v.done;v=r.next())t=$jscomp.makeIterator(v.value),v=t.next().value,t=t.next().value,u="var(--td_aib_color_"+v+")",f('<div class="tdc-aib-active-color-value" style="background-color: '+u+'" data-color="'+t.color+'" data-color-var="'+u+'" title="'+v.split("_").map(function(a){return a.charAt(0).toUpperCase()+a.slice(1)}).join(" ")+'"></div>').prependTo(q);k.slider({slide:function(a,c){a=parseFloat(c.value/100);e._color._alpha=a;b.tdPaletteColorPicker("color",e._color.toString());l.text(1>
a?a:"")},create:function(){var c=parseFloat(h.alpha/100);l.text(1>c?c:"");p.css("background-color",h.value);m.on("click",".wp-picker-clear",function(){e._color._alpha=1;l.text("");k.slider("option","value",100).trigger("slide");a.triggerSelection?a.setColor(d,!0):a.setColor(d)});m.on("click",".wp-picker-default",function(){var a=f.cs_ParseColorValue(b.data("default-color")),c=parseFloat(a.alpha/100);e._color._alpha=c;l.text(1>c?c:"");k.slider("option","value",a.alpha).trigger("slide")});m.on("click",
".wp-color-result",function(a){n.toggle()});f("body").on("click.wpcolorpicker",function(){n.hide()})},value:h.alpha,step:1,min:0,max:100})}})}else b.tdPaletteColorPicker({clear:function(){b.trigger("keyup")},change:function(a,c){b.val(c.color.toString()).trigger("change")}});"undefined"===typeof a.setColor&&(a.setColor=function(b,c){a.color=b;!0===c&&a._saveValue()},a._saveValue=function(){var b=a.$container.parent().prev(".tdc-property-colorpicker"),c=b.find("input");b=b.find(".tdc-colorpicker-wrap");
if("undefined"===typeof a.color)c.val(""),b.removeAttr("style");else{var d=b.find("i");/var\(--[a-zA-z0-9\-]*\)/.test(a.color)?(d.length||b.append('<i class="tdc-font-tdmp tdc-font-tdmp-globe"></i>'),b.attr("title",(a.color.includes("--td_aib_color")?"AI builder color: ":"Global color: ")+a.color)):(a.$container.find(".tdc-global-colors-values .tdc-color-value, .tdc-aib-active-colors-values .tdc-aib-active-color-value").each(function(){f(this).removeClass("current")}),d.length&&d.remove());c.val(a.color);
b.attr("style","background: "+a.color)}c.trigger("change")},a.$container.on("mousedown",".tdc-color-value, .tdc-aib-active-color-value",function(b){var c=jQuery(b.currentTarget);b=c.data("color");c=c.data("color-var");"undefined"!==typeof c?a.init(c):a.init(b);a._saveValue()}),a.$container.on("mousedown",".tdc-color-value-delete",function(a){a.preventDefault();a.stopImmediatePropagation();var b=f(this).parent();a=b.data("color");a=c.btoa(JSON.stringify(a));a=c.tdcAdminSettings.tdcSavings.recentColors.indexOf(a);
c.tdcAdminSettings.tdcSavings.recentColors.splice(a,1);a=!0;for(var d in c.tdcAdminSettings.tdcSavings)if(c.tdcAdminSettings.tdcSavings[d].length){a=!1;break}a&&(c.tdcAdminSettings.tdcSavings="");tdcUtil.updateTdcSavings(this,function(){b.remove()})}),a.$container.on("tdc_wm_global_colors_update",".tdc-global-colors-values",function(b,c,d){if("new"===c){b=d.color;var e=d.color_name,g="var(--"+d.color_option_id.replace(/_/g,"-")+")";f('<div class="tdc-color-value" style="background-color: '+g+'" data-color="'+
b+'" data-color-var="'+g+'" title="'+e+'"></div>').prependTo(f(this))}"update"===c&&(b=d.color,e="var(--"+d.option.replace(/_/g,"-")+")",f(this).find("[data-color-var='"+e+"']").data("color",b));"col_name_update"===c&&(e=d.new_option,b="var(--"+d.option.replace(/_/g,"-")+")",e="var(--"+e.replace(/_/g,"-")+")",g=d.color_name,f(this).find("[data-color-var='"+b+"']").attr("title",g).data("color-var",e).attr("data-color-var",e).css("background",e));"delete"===c&&(c="var(--"+d.option.replace(/_/g,"-")+
")",f(this).find("[data-color-var='"+c+"']").remove(),a.$container.find(".tdc-color-values [data-color='"+c+"'] .tdc-color-value-delete").trigger("mousedown"))}),a.init=function(b){a.triggerSelection=!1;a.color=d;a.$container.find(".cs-alpha-text").text("");a.$container.find(".cs-alpha-slider-offset").css("background-color","");a.$container.find(".cs-alpha-slider").slider("option","value",100).trigger("slide");a.$container.find(".tdc-global-colors-values .tdc-color-value, .tdc-aib-active-colors-values .tdc-aib-active-color-value").each(function(){var a=
f(this);a.removeClass("current");/var\(--[a-zA-z0-9\-]*\)/.test(b)&&a.data("color-var")===b&&a.addClass("current")});if("undefined"!==typeof b&&""!==b){a.setColor(b);a.$this.tdPaletteColorPicker("color",b);var c=f.cs_ParseColorValue(a.color),e=parseFloat(c.alpha/100);e=1>e?e:"";a.$container.find(".cs-alpha-text").text(e);a.$container.find(".cs-alpha-slider-offset").css("background-color",c.value);a.$container.find(".cs-alpha-slider").slider("option","value",c.alpha).trigger("slide")}else a.setColor(d),
a.$container.find(".wp-picker-clear").trigger("click");a.triggerSelection=!0})})})})(jQuery,window,document);
...
break;case "single":case "cpt":b=window.tdcPostSettings.tdbTemplateType;var h="",g=e=a=c="",m="undefined"!==typeof window.tdcPostSettings.tdbTemplateSettings.autoload_options?Object.entries(window.tdcPostSettings.tdbTemplateSettings.autoload_options):Object.entries(window.tdb_p_autoload_vars);m=$jscomp.makeIterator(m);for(var n=m.next();!n.done;n=m.next()){var k=$jscomp.makeIterator(n.value);n=k.next().value;k=k.next().value;switch(n){case "status":c=k;"on"===c&&(a='checked="checked"');break;case "type":h=
k;break;case "count":e=k;break;case "scroll_percent":g=k}}m=[{name:"Latest posts",value:"latest_posts"},{name:"Previous posts",value:"prev"},{name:"Next posts",value:"next"}];n="";switch(b){case "single":m.push({name:"Same category previous",value:"same_cat_prev"},{name:"Same category next",value:"same_cat_next"},{name:"Same category latest",value:"same_cat_latest"},{name:"Post autoload tag",value:"post_autoload_tag"});n+='<div class="tdc-tsc-notif tdc-tsc-notif-autoload-tag tdc-tsc-notif-warning" style="display: none;">Please note that this option may not return accurate results if you don\'t set the <b>Autoload tag</b> option using a preferred tag slug for each individual post that uses this single template.</div>';
break;case "cpt":m.push({name:"Same taxonomy terms previous",value:"same_tax_prev"},{name:"Same taxonomy terms next",value:"same_tax_next"},{name:"Same taxonomy terms latest",value:"same_tax_latest"}),n+='<div class="tdc-tsc-notif tdc-tsc-notif-autoload-tax-latest tdc-tsc-notif-warning" style="display: none;">Please note that this option will refer to all taxonomies terms found on post. <br><br> To relate just on one of post\'s taxonomies terms you can use the <b>Autoload taxonomy</b> option for each individual post that uses this cpt template.</div><div class="tdc-tsc-notif tdc-tsc-notif-autoload-tax-next-prev tdc-tsc-notif-warning" style="display: none;">Please note that this option will auto select a taxonomy and load next/prev posts based on the terms set on post from the auto selected taxonomy. <br><br> To focus on one specific post taxonoy you can use the <b>Autoload taxonomy</b> option for each individual post that uses this cpt template.</div>'}var l=
"";m.forEach(function(a,b,c){l+='<option value="'+a.value+'" '+(h===a.value?"selected":"")+">"+a.name+"</option>"});tdcTemplateSettingsPanel.$panel.find(".tdc-ts-c-body").append('<div class="tdc-ts-cb-section"><div class="tdc-tsc-section-title">Articles auto loading</div><label class="tdc-tsc-switch"><input type="checkbox" value="'+c+'" class="tdc-tsc-switch-input" id="tdc-tsc-autoload-status" '+a+'><div class="tdc-tsc-switch-btn"><div class="tdc-tsc-switch-ball"></div></div><div class="tdc-tsc-switch-label" title="Enable or disable the articles auto loading.">Enable auto loading</div></label><div class="tdc-tsc-select-wrap"><div class="tdc-tsc-label">Auto loading type</div><select class="tdc-tsc-input tdc-tsc-autoload-type-select" id="tdc-tsc-autoload-type"><option value="">- Select type -</option>'+
l+"</select>"+n+'</div><div class="tdc-tsc-input-wrap tdc-tsc-autoload-art-count"><div class="tdc-tsc-label">Limit articles number</div><input type="number" name="tdc-tsc-autoload-art-count" id="tdc-tsc-autoload-art-count" class="tdc-tsc-input" placeholder="5" min="1" value="'+e+'" pattern="[0-9]"/></div><div class="tdc-tsc-input-wrap tdc-tsc-autoload-scroll-percent"><div class="tdc-tsc-label">Page scroll percent</div><input type="number" name="tdc-tsc-autoload-scroll-percent" id="tdc-tsc-autoload-scroll-percent" class="tdc-tsc-input" placeholder="50" min="0" value="'+
g+'" pattern="[0-100]"/></div></div>');tdcTemplateSettingsPanel.$panel.find(".tdc-ts-c-footer").prepend('<div class="tdc-tsc-notif tdc-tsc-notif-success" style="display: none;">Template settings saved successfully.</div>');tdcTemplateSettingsPanel.$panel.on("change","#tdc-tsc-autoload-type",function(a){a=f(this).val();var b=tdcTemplateSettingsPanel.$panel.find(".tdc-tsc-select-wrap"),c=b.find(".tdc-tsc-notif-autoload-tag"),d=b.find(".tdc-tsc-notif-autoload-tax-latest");b=b.find(".tdc-tsc-notif-autoload-tax-next-prev");
"post_autoload_tag"===a?c.show():"same_tax_latest"===a?(d.show(),b.hide()):["same_tax_prev","same_tax_next"].includes(a)?(d.hide(),b.show()):(c.hide(),d.hide(),b.hide())})}},panelToggle:function(b){b=f(this).closest(".tdc-template-settings");b.hasClass("tdc-ts-open")?b.removeClass("tdc-ts-open"):b.addClass("tdc-ts-open")},panelSave:function(b){b.preventDefault();if(!tdcTemplateSettingsPanel.$panel.hasClass("tdc-ts-loading")){tdcTemplateSettingsPanel.$panel.addClass("tdc-ts-loading");b={td_magic_token:tdcLivePanel.$token.val(),
action:"update_"+window.tdcPostSettings.tdbTemplateType+"_template_settings",templateID:window.tdcPostSettings.postId};var c="td-composer/update_"+window.tdcPostSettings.tdbTemplateType+"_template_settings";switch(window.tdcPostSettings.tdbTemplateType){case "module":b.tdcDesktopWidth=tdcTemplateSettingsPanel.$panel.find("#tdc-tsc-viewport-all").val();b.tdcTabletLandscapeWidth=tdcTemplateSettingsPanel.$panel.find("#tdc-tsc-viewport-tablet-landscape").val();b.tdcTabletPortraitWidth=tdcTemplateSettingsPanel.$panel.find("#tdc-tsc-viewport-tablet-portrait").val();
b.tdcPhoneWidth=tdcTemplateSettingsPanel.$panel.find("#tdc-tsc-viewport-phone").val();b.tdcBgColor=tdcTemplateSettingsPanel.$panel.find("#tdc-tsc-bg-color").val();break;case "single":case "cpt":b.autoloadStatus=tdcTemplateSettingsPanel.$panel.find("#tdc-tsc-autoload-status").is(":checked")?"on":"off",b.autoloadType=tdcTemplateSettingsPanel.$panel.find("#tdc-tsc-autoload-type").val(),b.autoloadArtCount=tdcTemplateSettingsPanel.$panel.find("#tdc-tsc-autoload-art-count").val(),b.autoloadScrollPercent=
tdcTemplateSettingsPanel.$panel.find("#tdc-tsc-autoload-scroll-percent").val(),b.action="update_single_template_settings",c="td-composer/update_single_template_settings"}tdcTemplateSettingsPanel.$panelSaveDataFilter&&(b=tdcTemplateSettingsPanel.$panelSaveDataFilter(b));f.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint(c,"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},data:b}).done(function(a,b,c){tdcTemplateSettingsPanel.$panel.removeClass("tdc-ts-loading");
["single","cpt"].includes(window.tdcPostSettings.tdbTemplateType)&&(a.success?(tdcTemplateSettingsPanel.$panel.find(".tdc-tsc-notif-success").show(),setTimeout(function(){tdcTemplateSettingsPanel.$panel.find(".tdc-tsc-notif-success").hide()},2E3)):a.error&&(tdcTemplateSettingsPanel.$panel.find(".tdc-tsc-notif-success").after('<div class="tdc-tsc-notif tdc-tsc-notif-error">'+a.error+"</div>"),setTimeout(function(){tdcTemplateSettingsPanel.$panel.find(".tdc-tsc-notif-error").hide()},2E3)))})}}};tdcTemplateSettingsPanel.init()})(jQuery);
