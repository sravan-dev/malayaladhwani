...
".tdc-tab-design input.tdc-css-z-index",tdcCssEditor._changeTextInput);a.on("change",".tdc-tab-design .tdc-css-display",tdcCssEditor._changeDropDown);a.on("change",".tdc-tab-design .tdc-css-scroll-anim",tdcCssEditor._changeDropDown);a.on("keydown",".tdc-tab-design input.tdc-css-scroll-anim-distance",tdcCssEditor._keydownTextInput);a.on("keyup mousewheel",".tdc-tab-design input.tdc-css-scroll-anim-distance",tdcCssEditor._changeTextInput);a.on("keydown",".tdc-tab-design input.tdc-css-scroll-anim-duration",
tdcCssEditor._keydownTextInput);a.on("keyup mousewheel",".tdc-tab-design input.tdc-css-scroll-anim-duration",tdcCssEditor._changeTextInput);a.on("mousedown",".tdc-tab-design .wp-picker-clear",tdcCssEditor._clearColorPicker);a.on("click",".tdc-tab-design .tdc-inherit-select",tdcCssEditor._inheritSelect);a.on("click",".tdc-tab-design .tdc-inherit-color",tdcCssEditor._inheritColor);a.on("click",".tdc-tab-design .tdc-css-image-wrap",tdcCssEditor.tdcCssImageWrapHandler);a.on("click",".tdc-tab-design .tdc-css-image-remove",
...
m);h+="</select></div></div>";m=a.uniqueId();var r=tdcCssEditor._getSettingsProperty("border-color","",b()),p="";n.isInherited&&(p=r,r="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-border-color'+d()+'" data-tdc-for="border-color">';h=h+'<div class="tdc-property-title"><span title="Css border-color" class="tdc-search-data">Border color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-border-color" '+tdcSidebarPanel._getParamterDataAtts(g,k)+tdcCssEditor._getDataNoValue(r)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+e(p)+' value="'+r+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("border-radius","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-border-radius tdc-textfield-small'+d()+'" data-tdc-for="border-radius">';h=h+'<div class="tdc-property-title"><span title="Css border-radius" class="tdc-search-data">Border radius</span></div><div class="tdc-property"><input class="tdc-css-border-radius" '+
(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("width","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-width tdc-textfield-big'+d()+'" data-tdc-for="width">';h=h+'<div class="tdc-property-title"><span title="Css width" class="tdc-search-data">Width</span></div><div class="tdc-property"><input class="tdc-css-width" '+
(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("height","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-height tdc-textfield-big'+d()+'" data-tdc-for="height">';h=h+'<div class="tdc-property-title"><span title="CSS height" class="tdc-search-data">Height</span></div><div class="tdc-property"><input class="tdc-css-height" '+(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+
e(r)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';m=tdcCssEditor._getSettingsProperty("shadow-size","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-size">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size" class="tdc-search-data">Shadow size</span></div><div class="tdc-property"><input class="tdc-css-shadow-size" '+
(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+="</div></div>";m=a.uniqueId();r=tdcCssEditor._getSettingsProperty("shadow-color","",b());p="";n.isInherited&&(p=r,r="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-shadow-color'+d()+'" data-tdc-for="shadow-color">';h=h+'<div class="tdc-property-title"><span title="Css shadow-color" class="tdc-search-data">Shadow color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-shadow-color" '+tdcSidebarPanel._getParamterDataAtts(g,k)+tdcCssEditor._getDataNoValue(r)+' data-default_value="#888888" id="'+m+'" name="" type="text" '+e(p)+' value="'+r+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-h","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-offset-h">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-h" class="tdc-search-data">Shadow offset H</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-h" '+
(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("shadow-offset-v","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-shadow-size tdc-textfield-small'+d()+'" data-tdc-for="shadow-offset-v">';h=h+'<div class="tdc-property-title"><span title="Css shadow-offset-v" class="tdc-search-data">Shadow offset V</span></div><div class="tdc-property"><input class="tdc-css-shadow-offset-v" '+
(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=a.uniqueId();r=tdcCssEditor._getSettingsProperty("background-color","",b());p="";n.isInherited&&(p=r,r="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-bg-color'+d()+'" data-tdc-for="background-color">';h=h+'<div class="tdc-property-title"><span title="Css background-color" class="tdc-search-data">Background color<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-bg-color" '+tdcSidebarPanel._getParamterDataAtts(g,k)+tdcCssEditor._getDataNoValue(r)+' id="'+m+'" name="" type="text" '+e(p)+' value="'+r+'"/>');h+="</div></div>";tdcCssEditor._getSettingsProperty("background-image",c,b());h+='<div class="tdc-property-wrap tdc-property-attach_image'+d()+'">';h=h+'<div class="tdc-property-title"><span title="Css background-image" class="tdc-search-data">Background image<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-image"></div></span></div><div class="tdc-property"><div class="tdc-css-bg-image tdc-css-image-wrap " '+
...
"</select></div></div>";m=tdcCssEditor._getSettingsProperty("opacity","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="opacity">';h=h+'<div class="tdc-property-title"><span title="Css background-image opacity" class="tdc-search-data">Background opacity</span></div><div class="tdc-property"><input class="tdc-css-opacity" '+(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
...
('<input class="tdc-css-color-1-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,k)+tdcCssEditor._getDataNoValue(r)+' id="'+m+'" name="" type="text" '+e(p)+' value="'+r+'"/>');h+="</div></div>";m=a.uniqueId();r=tdcCssEditor._getSettingsProperty("color-2-overlay","",b());p="";n.isInherited&&(p=r,r="");h+='<div class="tdc-property-wrap tdc-property-colorpicker tdc-color-2-overlay'+d()+'" data-tdc-for="color-2-overlay">';h=h+'<div class="tdc-property-title"><span  title="Css gradient color To" class="tdc-search-data">Color 2 overlay<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-color"></div></span></div><div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
('<input class="tdc-css-color-2-overlay" '+tdcSidebarPanel._getParamterDataAtts(g,k)+tdcCssEditor._getDataNoValue(r)+' id="'+m+'" name="" type="text" '+e(p)+' value="'+r+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("gradient-direction","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+d()+'" data-tdc-for="gradient-direction">';h=h+'<div class="tdc-property-title"><span title="Css gradient direction" class="tdc-search-data">Gradient direction</span></div><div class="tdc-property"><input class="tdc-css-gradient-direction" '+
(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';m=tdcCssEditor._getSettingsProperty("content-h-align",c,b());h+='<div class="tdc-property-wrap tdc-bg-position tdc-dropdown-big'+d()+'" data-tdc-for="content-h-align">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">H. align<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-content-h-align" '+
(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Default"},{value:"content-horiz-left",display:"Left"},{value:"content-horiz-center",display:"Center"},{value:"content-horiz-right",display:"Right"}],m);h+="</select></div></div>";"vc_row"!==k.get("tag")&&"vc_row_inner"!==k.get("tag")&&"vc_column"!==k.get("tag")&&"vc_column_inner"!==k.get("tag")&&(m=tdcCssEditor._getSettingsProperty("order","",b()),r="",n.isInherited&&(r=m,m=""),h+=
'<div class="tdc-property-wrap tdc-order tdc-textfield-small'+d()+'" data-tdc-for="order">',h=h+'<div class="tdc-property-title"><span title="Order" class="tdc-search-data">Order</span></div><div class="tdc-property"><input class="tdc-css-order" '+(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>'),h+="</div></div>");m=tdcCssEditor._getSettingsProperty("z-index","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-opacity tdc-textfield-small'+
d()+'" data-tdc-for="z-index">';h=h+'<div class="tdc-property-title"><span title="Z-index" class="tdc-search-data">Z-index</span></div><div class="tdc-property"><input class="tdc-css-z-index" '+(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsPropertyFromCssSettings("display",c);h+='<div class="tdc-property-wrap tdc-display tdc-dropdown-big'+d()+'" data-tdc-for="display">';h=h+'<div class="tdc-property-title"><span title="Css content horizontal align" class="tdc-search-data">Display</span></div><div class="tdc-property"><select class="tdc-css-display" '+
(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="">');h+=tdcCssEditor._generateDropdownOptions([{value:"",display:"Show"},{value:"none",display:"Hidden"},{value:"inline",display:"Inline"},{value:"inline-block",display:"Inline-block"},{value:"block",display:"Block"},{value:"table",display:"Table"},{value:"inline-table",display:"Inline-table"}],m);h+='</select></div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small"></div>';
m=tdcCssEditor._getSettingsProperty("--tdb-scroll-anim","",b());h+='<div class="tdc-property-wrap tdc-scroll-anim tdc-dropdown-big'+d()+'" data-tdc-for="--tdb-scroll-anim">';h=h+'<div class="tdc-property-title"><span title="Scroll animation on reveal" class="tdc-search-data">Scroll animation<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select"></div></span></div><div class="tdc-property"><select class="tdc-css-scroll-anim" '+(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="">');
h+=tdcCssEditor._generateDropdownOptions([{value:"none",display:"None"},{value:"slide-up",display:"Slide up"},{value:"slide-down",display:"Slide down"},{value:"slide-left",display:"Slide left"},{value:"slide-right",display:"Slide right"},{value:"fade",display:"Fade in"}],m);h+="</select></div></div>";m=tdcCssEditor._getSettingsProperty("--tdb-scroll-anim-distance","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-scroll-anim-distance tdc-textfield-small'+d()+'" data-tdc-for="--tdb-scroll-anim-distance">';
h=h+'<div class="tdc-property-title"><span title="Scroll animation distance (e.g. 80px)" class="tdc-search-data">Scroll distance</span></div><div class="tdc-property"><input class="tdc-css-scroll-anim-distance" '+(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h+="</div></div>";m=tdcCssEditor._getSettingsProperty("--tdb-scroll-anim-duration","",b());r="";n.isInherited&&(r=m,m="");h+='<div class="tdc-property-wrap tdc-scroll-anim-duration tdc-textfield-small'+
d()+'" data-tdc-for="--tdb-scroll-anim-duration">';h=h+'<div class="tdc-property-title"><span title="Scroll animation duration (e.g. 0.6s, 400ms)" class="tdc-search-data">Scroll duration</span></div><div class="tdc-property"><input class="tdc-css-scroll-anim-duration" '+(tdcSidebarPanel._getParamterDataAtts(g,k)+' name="" type="text" '+e(r)+' value="'+m+'"/>');h=h+'</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator"></div><div class="tdc-clear-css-properties" '+
...
k=b.find(".tdc-css-box-input-margin-left").val().trim(),n=b.find(".tdc-css-box-input-border-top-width").val().trim(),h=b.find(".tdc-css-box-input-border-right-width").val().trim(),m=b.find(".tdc-css-box-input-border-bottom-width").val().trim(),r=b.find(".tdc-css-box-input-border-left-width").val().trim(),l=b.find(".tdc-css-box-input-padding-top").val().trim(),x=b.find(".tdc-css-box-input-padding-right").val().trim(),t=b.find(".tdc-css-box-input-padding-bottom").val().trim(),u=b.find(".tdc-css-box-input-padding-left").val().trim(),
w=b.find(".tdc-css-border-radius").val().trim(),A=b.find(".tdc-css-width").val().trim(),B=b.find(".tdc-css-height").val().trim(),C=b.find(".tdc-css-shadow-size").val().trim(),q=b.find(".tdc-css-shadow-offset-h").val().trim(),v=b.find(".tdc-css-shadow-offset-v").val().trim(),y=b.find(".tdc-css-opacity").val().trim(),z=b.find(".tdc-css-gradient-direction").val().trim();b.find(".tdc-css-scroll-anim-distance").val().trim();b.find(".tdc-css-scroll-anim-duration").val().trim();var E=b.find(".tdc-css-z-index").val().trim(),
D="";b.find(".tdc-css-order").length&&(D=b.find(".tdc-css-order").val().trim());""!==d&&(c["margin-top"]=d);""!==f&&(c["margin-right"]=f);""!==g&&(c["margin-bottom"]=g);""!==k&&(c["margin-left"]=k);""!==n&&(c["border-top-width"]=n);""!==h&&(c["border-right-width"]=h);""!==m&&(c["border-bottom-width"]=m);""!==r&&(c["border-left-width"]=r);""!==l&&(c["padding-top"]=l);""!==x&&(c["padding-right"]=x);""!==t&&(c["padding-bottom"]=t);""!==u&&(c["padding-left"]=u);d=b.find(".tdc-css-border-style");f=d.val().trim();
""===f||d.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["border-style"]=f);d=b.find(".tdc-css-border-color");f=d.val().trim();""!==f?c["border-color"]=f:(d=d.data("no_value"),a.isUndefined(d)||1!==d||(c["border-color"]="no_value"));""!==w&&(c["border-radius"]=w);""!==A&&(c.width=A);""!==B&&(c.height=B);""!==C&&(c["shadow-size"]=C);w=b.find(".tdc-css-shadow-color");A=w.val().trim();""!==A?c["shadow-color"]=A:(w=w.data("no_value"),a.isUndefined(w)||1!==w||(c["shadow-color"]=
"no_value"));""!==q&&(c["shadow-offset-h"]=q);""!==v&&(c["shadow-offset-v"]=v);q=b.find(".tdc-css-bg-color");v=q.val().trim();""!==v?c["background-color"]=v:(q=q.data("no_value"),a.isUndefined(q)||1!==q||(c["background-color"]="no_value"));q=b.find(".tdc-css-bg-image");q.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(q=q.data("image_link"),a.isUndefined(q)||("no_value"===q?c["background-image"]="no_value":""!==q&&(c["background-image"]='url("'+q+'")')));q=b.find(".tdc-css-bg-style");
v=q.val().trim();""===v||q.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-style"]=v);q=b.find(".tdc-css-bg-position");v=q.val().trim();""===v||q.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["background-position"]=v);""!==y&&(c.opacity=y);y=b.find(".tdc-css-color-1-overlay");q=y.val().trim();""!==q?c["color-1-overlay"]=q:(y=y.data("no_value"),a.isUndefined(y)||1!==y||(c["color-1-overlay"]="no_value"));y=b.find(".tdc-css-color-2-overlay");
q=y.val().trim();""!==q?c["color-2-overlay"]=q:(y=y.data("no_value"),a.isUndefined(y)||1!==y||(c["color-2-overlay"]="no_value"));""!==z&&(c["gradient-direction"]=z);""!==D&&(c.order=D);""!==E&&(c["z-index"]=E);z=b.find(".tdc-css-content-h-align");E=z.val().trim();""===E||z.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||(c["content-h-align"]=E);z=b.find(".tdc-css-display");c.display=z.val().trim();z=b.find(".tdc-css-scroll-anim");E=z.val().trim();""===E||z.closest(".tdc-property-wrap").hasClass(tdcCssEditor._INHERITED_CSS_CLASS)||
(c["--tdb-scroll-anim"]=E);z=b.find(".tdc-css-scroll-anim-distance").val().trim();""!==z&&(/^[0-9.]+$/.test(z)&&(z+="px"),c["--tdb-scroll-anim-distance"]=z);b=b.find(".tdc-css-scroll-anim-duration").val().trim();""!==b&&(/^[0-9.]+$/.test(b)&&(b+="s"),c["--tdb-scroll-anim-duration"]=b);a.isUndefined(tdcCssEditor._currentCssSettings)&&(tdcCssEditor._currentCssSettings={});a.isUndefined(c["border-style"])||"solid"!==c["border-style"]||("all"===tdcSidebar.currentViewportSettings.name||a.isUndefined(tdcCssEditor._currentCssSettings.all)||
...
function(a){var b=jQuery(this),c=b.closest(".tdc-property-responsive"),d=c.find('input[type="range"]'),f=c.find('input[type="radio"]:checked'),g=c.find('input[type="text"]'),k=d.get(0),n="",h=f.data("default_value"),m=tdcIFrameData.getModel(d.data("model_id")),l=d.data("param_name"),p=window.tdcAdminSettings.mappedShortcodes[m.attributes.tag],x=m="";var t=[];for(var u=0;u<p.params.length;u++)if(l===p.params[u].param_name){u=p.params[u].tdc_values;for(var w in u)u.hasOwnProperty(w)&&(t.push(u[w].unit),
""===m||""===x)&&(m=u[w].value,x=u[w].unit);break}f.length&&(n=f.data("unit_value"));if("range"===b.attr("type"))t=d.val(),g.val(t),f.data("last_value",t),g.val(t),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),t+n,tdcSidebar.currentViewportSettings.name)),c.removeClass("tdc-css-inherited");else if("text"===b.attr("type")){if("input"===a.type||"change"===a.type)return;c.removeClass("tdc-css-inherited");t=g.val().trim();if("all"===tdcSidebar.currentViewportSettings.name)""!==
t||_.isUndefined(h)||""===h?(d.val(t),f.data("last_value",t),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),t+n,tdcSidebar.currentViewportSettings.name))):(d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+l,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",x),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+x+'"]'),p=n.data("unit"),w=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",
!0),k.min=w,k.max=f,k.step=p,k.value=m,n.data("last_value",m),g.val(m));else if(""===t)if(n=tdcSidebarPanel.getCurrentResponsiveValue(d.attr("name"),"all"),"undefined"===typeof n)d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+l,tdcSidebar.currentViewportSettings.name)),d.data("range_value",m),d.data("range_unit",x),d.val(m),n=c.find('input[type="radio"][data-unit_value="'+x+'"]'),p=n.data("unit"),w=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+p),n.prop("checked",
!0),k.min=w,k.max=f,k.step=p,k.value=m,n.data("last_value",m),g.val(m),c.addClass("tdc-css-inherited");else for(u=0;u<p.params.length;u++){if(l===p.params[u].param_name){t=[];g=[];u=p.params[u].tdc_values;for(w in u)u.hasOwnProperty(w)&&t.push(u[w].unit);for(u=0;u<t.length&&!(g=n.split(t[u]),1<g.length);u++);g.length&&(m=g[0],x=t[u],d.data("range_value",m),d.data("range_unit",x),n=c.find('input[type="radio"][data-unit_value="'+x+'"]'),p=n.data("unit"),w=d.data("min_"+p),f=d.data("max_"+p),p=d.data("step_"+
p),n.prop("checked",!0),k.min=w,k.max=f,k.step=p,k.value=m,n.data("last_value",m),c.find('input[type="text"]').val(m));d.data("data-to-save",tdcSidebarPanel.deleteResponsiveValue("tdc-param-"+l,tdcSidebar.currentViewportSettings.name));c.addClass("tdc-css-inherited");break}}else d.val(t),f.data("last_value",t),d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),t+n,tdcSidebar.currentViewportSettings.name))}else if("radio"===b.attr("type")){if("input"===a.type)return;
l=f.data("last_value");p=f.data("unit");w=d.data("min_"+p);f=d.data("max_"+p);p=d.data("step_"+p);k.min=w;k.max=f;k.step=p;""===l?(g.val(h),d.val(h),t=h):(g.val(l),d.val(l),t=l);d.data("data-to-save",tdcSidebarPanel.updateTextfieldResponsiveValues(d.attr("name"),t+n,tdcSidebar.currentViewportSettings.name));c.removeClass("tdc-css-inherited")}n="";c=jQuery(k).parent().find('input[type="radio"]:checked');c.length&&(n=jQuery(c[0]).data("unit_value"));"focusin"===a.type?k.oldValue=k.value+n:(c=jQuery(k),
...
function(){var a=jQuery('.tdc-fs-link-post-toggle input[type="checkbox"]');a.length&&tdcSidebarPanel.toggleEnableFSLinkPostParams(a)});a.on("change",'.tdc-fs-link-post-toggle input[type="checkbox"]',function(){tdcSidebarPanel.toggleEnableFSLinkPostParams(jQuery(this))});a.on("change",".tdc-block-sort select",function(){tdcSidebarPanel.toggleEnableBlockSortParams(jQuery(this))});a.on("change",'[data-tag="tdb_single_custom_field"] [data-param_name="acf_field"]',function(){tdcSidebarPanel.toggleEnableCFParams(jQuery(this))});
a.on("mousedown",function(a){var b=jQuery("#tdc-sidebar"),c=jQuery("#tdc-icon-selector"),d=jQuery("#tdc-gradient"),f=jQuery("#tdc-palette"),g=jQuery("#tdc-font-list"),k=jQuery(".tdc-preset-values-list");c.length?c.get(0).contains(a.target)||(c.hide(),b.after(c)):c=tdcSidebar.buildIconSelector();d.length?d.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-gradient-wrap")||(d.hide(),b.after(d))):d=tdcSidebar.buildGradient();f.length?f.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-colorpicker-wrap")||
(f.hide(),b.after(f),f.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):f=tdcSidebar.buildPalette();g.length&&!g.get(0).contains(a.target)&&(g.hide(),b.after(g));!k.length||k.get(0).contains(a.target)||jQuery(".tdc-preset-values").get(0).contains(a.target)?k.is(":visible")&&jQuery(".tdc-preset-values").get(0).contains(a.target)&&setTimeout(function(){tdcSidebar.setSettings({$currentZone:tdcSidebar.getCurrentZone(),$currentRow:tdcSidebar.getCurrentRow(),$currentColumn:tdcSidebar.getCurrentColumn(),
...
b);_.isUndefined(b.getShortcode)||console.log(b.getShortcode)});a.on("click",".tdc-sidebar-aib-section-config",function(a){a=jQuery(a.currentTarget).data("model_id");var b=tdcIFrameData.getModel(a);_.isUndefined(window.TdAiBuilderModal)||"vc_row"!==b.attributes.tag||(a={error:l,getShortcode:""},_.isUndefined(b)||tdcIFrameData._checkModelData(b,a),_.isUndefined(a.getShortcode)||(b=b.attributes.attrs,a={id:b.aib_section_id,type:b.aib_section_type,title:b.aib_section_title,style:_.isUndefined(b.aib_section_style)?
"":b.aib_section_style,preview:"",content:a.getShortcode.replace(/(aib_section_title=".*?)(\s\d+)"(.*?)/g,'$1"')},console.log(JSON.stringify(a,null,2))))});a.on("click",".tdc-sidebar-current-styles-settings",function(a){a=tdcSidebarPanel.getCurrentStyleSettings(a);if(!_.isUndefined(a)){var b="",c;for(c in a)b+='"'+c+'" => "'+a[c]+'",\n';console.log(b)}});a.on("click",".tdc-sidebar-font-reset",function(a){tdConfirm.modal({caption:"Clear Font Settings",htmlInfoContent:"This will clear all values for this font group settings.",
textYes:"Yes",objectContext:this,callbackYes:function(){tb_remove();var a=jQuery(this),c=a.data("model_id"),d=tdcIFrameData.getModel(c),f=d.get("attrs");f=_.clone(f);for(var g="font-family font-size font-line-height font-style font-weight font-transform font-spacing".split(" "),k="",n=0;n<g.length;n++){var h=a.closest(".tdc-font-manager-wrap").nextAll(".tdc-"+g[n]+":first");if(h.length){var m=h.find('[data-model_id="'+c+'"]');m.length&&(m.val(""),m.data("responsive",""),h.removeClass("tdc-css-inherited"),
k=h.find(".tdc-inherit"),k.length&&k.hide(),k=m.data("placeholder"),"undefined"!==typeof k&&m.attr("placeholder",k),k=m.data("param_name"),delete f[k],m=m.attr("name"),tdcSidebarPanel.deleteResponsiveValues(m))}}d.set("attrs",f);tdcSidebarController.onUpdate(d,k,"","")}})});a.on("click",".tdc-sidebar-font-save",function(a){a=jQuery(this);var b=a.data("model_id");b=tdcIFrameData.getModel(b).get("attrs");var c=a.data("param_name").replace("font_settings",""),d="font_family font_size font_line_height font_style font_weight font_transform font_spacing".split(" "),
f={};_.each(b,function(a,b,e){if(0===b.indexOf(c))for(e=0;e<d.length;e++)if(0<b.indexOf(d[e])){f[d[e]]=a;break}});_.isEmpty(f)||tdConfirm.modal({caption:"Saving Font Settings",htmlInfoContent:function(){setTimeout(function(){jQuery("#TB_ajaxContent").find("input").focus()},100);return'<label>Font Name: </label><input type="text" autofocus><div class="info"></div>'},textYes:"Save",textNo:"Cancel",callbackYes:function(){var a=jQuery("#TB_ajaxContent"),b=a.find(".info");a=a.find("input").val().trim();
...
if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(f);a=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var g=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<g;g--){var k=window.tdcAdminSettings.tdcSavings.recentFonts[g],n=a[k];_.isUndefined(n)||jQuery('<div class="tdc-recent-font-settings" data-value="'+k+'" data-model_id="'+e+'" data-param_name="'+d+'"><span class="tdc-font-name">'+
...
!_.isUndefined(b.val())&&""!==b.val()&&/var\(--[a-zA-z0-9\-]*\)/.test(b.val())&&b.val()===c&&(b.val(d),a.attr("style","background: "+d).data("has-color","1"),a.attr("title","Global color: "+d),b.trigger("change"))});jQuery(".tdc-property-gradient").each(function(){var a=jQuery(this),b=a.find("input");a=a.find(".tdc-gradient-wrap");!_.isUndefined(b.val())&&""!==b.val()&&/var\(--[a-zA-z0-9\-]*\)/.test(b.val())&&b.val()===c&&(b.val(d),a.attr("style","background: "+d),a.attr("title","Global color: "+
d),b.trigger("change"))})});a.on("keyup","input.tdc-edit-page_id",function(a){var b=jQuery(this).closest(".tdc-property-wrap").find("a.tdc-edit-page_id");""===a.currentTarget.value.trim()?b.hide():b.length&&"undefined"!==typeof window.tdData&&(b.attr("href",tdData.adminUrl+"post.php?post="+a.currentTarget.value.trim()+"&action=edit").show(),b.css("visibility","visible"))});a.on("change","select.tdc-edit-cloud_tpl_module_id",function(a){var b=jQuery(this).closest(".tdc-property-wrap").find("a.tdc-edit-cloud_tpl_module_id");
""===a.currentTarget.value.trim()?b.hide():b.length&&"undefined"!==typeof window.tdData&&(b.attr("href",tdData.adminUrl+"post.php?post_id="+a.currentTarget.value.trim()+"&td_action=tdc&tdbTemplateType=module").show(),b.show())});a.on("click",".tdc-refresh-cloud_tpl_module",function(a){a.preventDefault();var b=jQuery("select.tdc-edit-cloud_tpl_module_id");a=b.find("option:selected");var c="";a.length&&(c=a.val());jQuery.ajax({url:td_ajax_url,type:"post",data:{action:"tdb_get_module_templates",_nonce:window.tdb_globals.wpRestNonce},
success:function(a){a=JSON.parse(a).templates;b.find("option:not(:first-child)").remove();a.map(function(a){var d=a.ID===parseInt(c)?' selected="selected"':"";b.append('<option value="'+a.ID+'"'+d+">"+a.post_title+"</option>")})},error:function(a,b,c){console.log("%c"+c,"color: #dc2121c7")}})});a.on("change",".tdc-property-dropdown select",function(a){a=jQuery(this);a.find("option:selected").is(":disabled")?a.addClass("selected-op-disabled"):a.removeClass("selected-op-disabled")})},getCurrentStyleSettings:function(a,
c){_.isUndefined(c)&&(c=jQuery(a.currentTarget).data("model_id"),c=tdcIFrameData.getModel(c),a={error:l},_.isUndefined(c)||tdcIFrameData._checkModelData(c,a));var b=c.get("tag");c=c.get("attrs");c=_.clone(c);if(!_.isUndefined(c)){var e={};a={};for(var d in c)0===d.indexOf("tds_")&&(e[d]=c[d]);d=window.tdcAdminSettings.mappedShortcodes[b].params;for(b=0;b<d.length;b++){var f=!1,g=d[b];if(0===g.param_name.indexOf("tds_")){for(var k in e)if(g.param_name===k){a[k]=e[k];f=!0;break}f||(a[g.param_name]=
"")}}for(k in e)switch(e=k.split("-"),e.length){case 2:if(!_.has(a,k)){d=e[0];e=!1;for(var n in a)if(d===a[n]&&1===n.split("-").length){e=!0;break}if(!e){var h;for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],d)){var m=h;break}_.has(a,m)&&""===a[m]&&window.tdcAdminSettings.globalStyle[m]===d&&(e=!0)}e||delete c[k]}break;case 3:d=e[0];b=e[2];for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],d)){m=h;break}e=
!1;for(n in a)if(d===a[n]&&n===m+"-"+b){e=!0;break}e||_.has(a,m+"-"+b)&&""===a[m+"-"+b]&&window.tdcAdminSettings.globalStyle[m]===d&&(e=!0);e||delete c[k]}return c}},getCurrentListAtts:function(a,c,b){_.isUndefined(c)&&(a=jQuery(a.currentTarget).data("model_id"),c=tdcIFrameData.getModel(a),a={error:l},_.isUndefined(c)||tdcIFrameData._checkModelData(c,a));a=c.get("tag");c=c.get("attrs");var e=_.clone(c);if(!_.isUndefined(e)){var d={};c={};for(var f in e)0===f.indexOf("tds_")&&(d[f]=e[f]);f=window.tdcAdminSettings.mappedShortcodes[a].params;
for(var g=0;g<f.length;g++){var k=!1,n=f[g];if(0===n.param_name.indexOf("tds_")){for(var h in d)if(n.param_name===h){c[h]=d[h];k=!0;break}k||(c[n.param_name]="")}}for(h in d)switch(d=h.split("-"),d.length){case 2:if(!_.has(c,h)){f=d[0];d=!1;for(var m in c)if(f===c[m]&&1===m.split("-").length){d=!0;break}if(!d){var r;for(r in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[r],f)){var p=r;break}_.has(c,p)&&""===c[p]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=
!0)}d||delete e[h]}break;case 3:f=d[0];k=d[2];for(r in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[r],f)){p=r;break}d=!1;for(m in c)if(f===c[m]&&m===p+"-"+k){d=!0;break}d||_.has(c,p+"-"+k)&&""===c[p+"-"+k]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0);d||delete e[h]}var x=[],t;for(t in window.tdcAdminSettings.listStyles[b])if(t===a){for(g=0;g<window.tdcAdminSettings.listStyles[b][t].length;g++)h=window.tdcAdminSettings.listStyles[b][t][g],_.isArray(h)?
_.map(h,function(a){_.isUndefined(e[a])||(_.isUndefined(x[g])&&(x[g]=[]),x[g].push(e[a]))}):_.isUndefined(e[h])||(_.isArray(e[h])&&e[h].length?x[g]=e[h][0]:x[g]=e[h]);break}return x}},showHideTdcCssEditor:function(a){a=jQuery("#tdc-editor-css");var c=jQuery(this).closest(".tdc-property-wrap"),b=c.find("textarea:first");a.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=b;c.next(".tdc-property-editor_css-title").length?(c.next(".tdc-property-editor_css-title").toggle(),a.toggle()):(c.after(a),
c.after('<div class="tdc-property-editor_expand tdc-property-editor_css-title"><span></span><div class="tdc-editor-toggle tdc-css-ace-editor-expand-collapse"></div></div>'),a.show(),tdcSidebar.editorCss.getSession().setValue(b.val()))},toggleEnableParamsFromText:function(a){var c=a.closest(".tdc-property-wrap"),b=c.data("enable-params");c=c.data("enable-params-reverse");b=jQuery('.tdc-property-wrap[data-enabled-by="'+b+'"]');b.length&&(""!==a.val()?"undefined"!==typeof c&&1===c?b.hasClass("tdc-disabled")||
b.addClass("tdc-disabled"):b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):"undefined"!==typeof c&&1===c?b.hasClass("tdc-disabled")&&b.removeClass("tdc-disabled"):b.hasClass("tdc-disabled")||b.addClass("tdc-disabled"))},toggleEnableParamsFromSelect:function(a){var c=a.val();a=a.closest(".tdc-property-wrap");var b=a.data("enable-params"),e=a.data("enable-params-reverse"),d=jQuery('.tdc-property-wrap[data-enabled-by^="'+b+'"]');d.length&&d.each(function(a,b){a=jQuery(b);b=a.data("enabled-by");
-1!==b.indexOf("--")?b.substring(b.indexOf("--")+2)===c?"undefined"!==typeof e&&1===e?a.hasClass("tdc-disabled")||a.addClass("tdc-disabled"):a.hasClass("tdc-disabled")&&a.removeClass("tdc-disabled"):"undefined"!==typeof e&&1===e?a.hasClass("tdc-disabled")&&a.removeClass("tdc-disabled"):a.hasClass("tdc-disabled")||a.addClass("tdc-disabled"):""!==c?"undefined"!==typeof e&&1===e?d.hasClass("tdc-disabled")||d.addClass("tdc-disabled"):d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):"undefined"!==
typeof e&&1===e?d.hasClass("tdc-disabled")&&d.removeClass("tdc-disabled"):d.hasClass("tdc-disabled")||d.addClass("tdc-disabled")})},toggleDisableParamsFromSelect:function(a){var c=a.val();a=a.closest(".tdc-property-wrap").data("disable-params");a=jQuery('.tdc-property-wrap[data-disabled-by^="'+a+'"]');a.length&&a.each(function(a,e){a=jQuery(e);e=a.data("disabled-by");-1!==e.indexOf("--")&&(e.substring(e.indexOf("--")+2)===c?a.hasClass("tdc-disabled")||a.addClass("tdc-disabled"):a.hasClass("tdc-disabled")&&
...
c.length&&("popular1"===a||"popular2"===a||"popular3"===a||"popular7"===a?c.hasClass("tdc-disabled")&&c.removeClass("tdc-disabled"):c.hasClass("tdc-disabled")||c.addClass("tdc-disabled"))},toggleEnableCFParams:function(a){var c=a.find("option:selected").text().match(/\(([^)]+)\)$/);a=jQuery(".tdc-separator-url, .tdc-property-url, .tdc-property-open_in_new_window, .tdc-property-url_rel");var b=jQuery(".tdc-property-text_cut");c&&(c=c[1],"user"===c||"taxonomy"===c?a.addClass("tdc-disabled"):a.removeClass("tdc-disabled"),
"wysiwyg"===c||"text"===c||"textarea"==c?b.removeClass("tdc-disabled"):b.addClass("tdc-disabled"))},bindPanelToModel:function(a,c){if(_.isUndefined(tdcSidebarPanel._currentBoundModel)||tdcSidebarPanel._currentBoundModel.cid!==a.cid||!_.isUndefined(c)&&(_.isUndefined(c)||!0===c)){c=window.tdcAdminSettings.mappedShortcodes[a.attributes.tag];tdcSidebarPanel._deletePanel();jQuery(".tdc-empty-sidebar").hide();tdcSidebarPanel._currentBoundModel=a;for(var b=[],e=0;e<c.params.length;e++){var d=tdcSidebarPanel._defaultGroupName;
_.isEmpty(c.params[e].group)||(d=c.params[e].group);b.push(d)}b=_.uniq(b);var f=d="",g=tdcSidebar.getCurrentTabId(),k,n;d+='<div class="tdc-sidebar-header"><div class="tdc-tabs">';var h=n=k="";for(e=0;e<b.length;e++){f=tdcSidebarPanel._fixGroupName(b[e]);var m=tdcUtil.makeSafeForCSS(f);if(0===e)k='<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>',n='<a href="#" data-tab-id="td-tab-'+m+'" title="'+f+' settings">'+
f+'<span class="tdc-tab-search-notice"></span></a>';else if(_.isUndefined(g)||g!=="td-tab-"+m){var l=a.getParentModel("vc_row");"ai"===m&&(_.isUndefined(window.TdAiBuilderModal)||!_.isUndefined(l)&&(_.isUndefined(l.attributes.attrs.aib_is_section)||"yes"!==l.attributes.attrs.aib_is_section))||"css"===m&&"td-aib-style"===window.tdcPostSettings.loadDataFromPostType||(h+='<a href="#" data-tab-id="td-tab-'+m+'" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>')}else k=n,h+=
'<a href="#" data-tab-id="td-tab-'+m+'" class="tdc-tab-active" title="'+f+' settings">'+f+'<span class="tdc-tab-search-notice"></span></a>'}d=d+(k+h)+"</div>";h=n=k=e="";if(tdcState.isMobileComposer())switch(tdcSidebar.currentViewportSettings.name){case "all":e="selected";break;case "phone":h="selected"}else switch(tdcSidebar.currentViewportSettings.name){case "all":e="selected";break;case "landscape":k="selected";break;case "portrait":n="selected";break;case "phone":h="selected"}d+='<div class="tdc-tab-responsive"><div class="tdc-responsive-buttons">';
...
b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})();(function(){var b=a.get("tag");if("vc_row"===b||"vc_row_inner"===b||"vc_column"===b||"vc_column_inner"===b){b=jQuery("body .tdc-property-flex_layout");var c=a.get("childCollection");if(!_.isUndefined(c)&&b.length){c=jQuery("body .tdc-property-flex_horiz_align");var d=jQuery("body .tdc-property-flex_vert_align"),e=jQuery("body .tdc-property-flex_layout_reverse");b.find("input[value=column]").is(":checked")&&(c.addClass("tdc-flex-row-align-rev"),
d.addClass("tdc-flex-row-align-rev"),e.find("input").is(":checked")&&c.addClass("tdc-flex-row-rev-align-rev"))}}})();(function(){var b=a.get("tag"),c=jQuery(".tdc-tab-content-wrap").data("viewport");"undefined"===typeof c||"phone"!==c||"vc_column"!==b&&"vc_column_inner"!==b||(b=jQuery("body .tdc-property-is_sticky"),c=a.get("childCollection"),!_.isUndefined(c)&&b.length&&(c=b.find('input[name="tdc-param-is_sticky"]'),b.addClass("tdc-disabled"),c.prop("disabled",!0),c.prop("checked",!1)))})();(function(){var b=
jQuery(".tdc-tab-content-wrap").data("viewport");if("undefined"!==typeof b&&"all"!==b){b=jQuery('body [data-responsive-disable-default="1"]');var c=a.get("childCollection");!_.isUndefined(c)&&b.length&&b.each(function(){var a=jQuery(this);a.hasClass("tdc-property-dropdown-responsive")&&(a=a.hasClass("tdc-visual-selector")?a.find('.tdc-property-input-radio[value="default"]'):a.find('select option[value="default"]'),a.length&&a.prop("disabled",!1))})}})();(function(){if("td_woo_products_live_search"===
...
'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+
...
var k="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="hidden" value="'+
tdcSidebarPanel._getParameterCurrentValue(a,c)+'"/>');b=b+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");b+="</div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackGradient);return b},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var a=jQuery(this),c=a.find("input");a=a.find(".tdc-gradient-wrap");
if(!_.isUndefined(c.val())&&""!==c.val())try{var b=JSON.parse(window.atob(c.val()));_.isUndefined(b.css)||a.attr("style",b.css)}catch(e){b=c.val(),_.isUndefined(b)||(a.attr("style","background: "+b),/var\(--[a-zA-z0-9\-]*\)/.test(c.val())&&(a.append('<i class="tdc-font-tdmp tdc-font-tdmp-globe"></i>'),a.attr("title",(c.val().includes("--td_aib_color")?"AI builder color: ":"Global color: ")+b)))}})},addDropDown:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+
a.info_img+'"');if("tdb_mobile_menu"===c.get("tag")&&"menu_id"===a.param_name){var d=c.get("attrs");d.menu_id=window.tdcPostSettings.mobileMenuId;c.set("attrs",d)}var f=!1,g=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(f=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(g=!0);var k="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(k='data-enable-params="'+a.toggle_enable_params+'"');var n="";_.has(a,"toggle_disable_params")&&""!==a.toggle_disable_params&&
(n='data-disable-params="'+a.toggle_disable_params+'"');var h="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(h='data-enable-params-reverse="1"');var m="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(m='data-enabled-by="'+a.toggle_enabled_by+'"');var l="";_.has(a,"toggle_disabled_by")&&""!==a.toggle_disabled_by&&(l='data-disabled-by="'+a.toggle_disabled_by+'"');var p=d="",x=!1,t=Object.keys(a.value),u=!0;if(_.has(a,"tdc_min_options")&&t.length<=parseInt(a.tdc_min_options))return d;
for(var w=0;w<t.length;w++){var A=!1,B="",C="",q="",v="",y="",z=t[w],E=String(tdcSidebarPanel._getParameterCurrentValue(a,c)),D=String(a.value[t[w]]);_.has(a,"options_to_disable")&&""!==a.options_to_disable&&(C=a.options_to_disable);_.has(a,"options_to_hide")&&""!==a.options_to_hide&&(q=a.options_to_hide);_.isObject(a.value[t[w]])&&(A=!0,D=_.values(a.value[t[w]])[0],z=_.keys(a.value[t[w]])[0]);if(f||g)0===w&&""===E&&(E=D),E===D&&(B=" checked "),C=_.uniqueId(),q=D,"vc_row"!==c.attributes.tag&&"vc_row_inner"!==
c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(q="col_"+q),p+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+C+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+B+' value="'+D+'">',f?(B="",A&&(B="tdc-standard-value"),p+='<label class="tdc-property-input-radio-label '+B+'" for="'+C+'" title="'+z+'"><div class="'+q+'"></div></label>'):p+='<label class="tdc-property-input-radio-label" for="'+C+'" title="'+z+'">'+D+"</label>";else{E===
D&&(B=' selected="selected" ',u=!1);if("__"===D&&-1!==z.search("--")||-1<C.indexOf(D)&&""!==D)v=" disabled ";-1<q.indexOf(D)&&""!==D&&(y=' style="display:none" ',"popular"===D&&(y=""));""!==v&&""!==B&&(x=!0);p+="<option "+B+" "+v+y+' value="'+D+'">'+z+"</option>"}}t="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':t=' title="'+a.description+'" ');d+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+k+" "+n+" "+h+" "+m+" "+l+">";d+=
'<div class="tdc-property-title"><span class="tdc-search-data"'+t+">"+a.heading+"</span>";b="";e="#";"tdb_flex_block_builder"!==c.get("tag")&&"tdb_flex_loop_builder"!==c.get("tag")||"cloud_tpl_module_id"!==a.param_name||(b="tdc-edit-cloud_tpl_module_id",k='style="margin-left: 10px"',_.has(c.get("attrs"),"cloud_tpl_module_id")?""===c.get("attrs").cloud_tpl_module_id.trim()?k='style="margin-left: 10px; display: none"':"undefined"!==typeof window.tdData&&(e=tdData.adminUrl+"post.php?post_id="+c.get("attrs").cloud_tpl_module_id.trim()+
"&td_action=tdc&tdbTemplateType=module"):k='style="margin-left: 10px; display: none"',d+='<a href="'+e+'" class="'+b+'" target="_blank" '+k+">Edit</a>","dev"===window.td_deploy_mode&&(d+='<a href="#" class="tdc-refresh-cloud_tpl_module" target="_blank" style="margin-left: 10px">Refresh list</a>'));d+='</div><div class="tdc-property">';f||g?d+=p:(x&&(b+=" selected-op-disabled"),u&&["tds_plans_button","tds_plans_price"].includes(c.get("tag"))&&(f=String(tdcSidebarPanel._getParameterCurrentValue(a,c)),
p+='<option selected="selected" value="'+f+'" disabled>Plan #'+f+" n/a</option>",b+=" selected-op-disabled"),d+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" class="'+b+'">',d=d+p+"</select>");d=d+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return d+"</div>"},addDropDownResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d=!1,f=!1;_.has(a,"tdc_dropdown_images")&&
""!==a.tdc_dropdown_images&&(d=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(f=!0);var g="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(g='data-enable-params="'+a.toggle_enable_params+'"');var k="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(k='data-enable-params-reverse="1"');var n="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(n='data-enabled-by="'+a.toggle_enabled_by+'"');var h="";_.has(a,"responsive_disable_default")&&
!0===a.responsive_disable_default&&(h=' data-responsive-disable-default="1"');var m="",l="",p=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&p.length<=parseInt(a.tdc_min_options))return m;var x=' data-responsive="" ',t=String(tdcSidebarPanel._getParameterCurrentValue(a,c));try{var u=JSON.parse(window.atob(t));x=' data-responsive="'+t+'" ';"undefined"!==typeof u[tdcSidebar.currentViewportSettings.name]&&(t=u[tdcSidebar.currentViewportSettings.name])}catch(y){}for(u=0;u<p.length;u++){var w=!1,
A="",B="",C=p[u],q=String(a.value[p[u]]);_.isObject(a.value[p[u]])&&(w=!0,q=_.values(a.value[p[u]])[0],C=_.keys(a.value[p[u]])[0]);if(d||f){0===u&&""===t&&(t=q);t===q&&(A=" checked ");B=_.uniqueId();var v=q;"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(v="col_"+v);l+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+B+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+A+' value="'+q+
'" '+x+">";d?(A="",w&&(A="tdc-standard-value"),l+='<label class="tdc-property-input-radio-label '+A+'" for="'+B+'" title="'+C+'"><div class="'+v+'"></div></label>'):l+='<label class="tdc-property-input-radio-label" for="'+B+'" title="'+C+'">'+q+"</label>"}else t===q&&(A=' selected="selected" '),"__"===q.substring(0,2)&&-1!==C.search("--")&&(B=" disabled "),l+="<option "+A+" "+B+' value="'+q+'">'+C+"</option>"}p="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+
'"':p=' title="'+a.description+'" ');m+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+g+" "+k+" "+n+h+">";m+='<div class="tdc-property-title"><span class="tdc-search-data"'+p+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';m+='<div class="tdc-property">';d||f?m+=l:(m+="<select "+tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+
'" '+x+p+">",m=m+l+"</select>");m=m+'</div><span class="tdc-param-name">'+(a.param_name+"</span>");return m+"</div>"},addCheckBox:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="",g=tdcSidebarPanel._getParameterCurrentValue(a,c);"product_cat_type_action"===a.param_name?""!==g&&"single_selection"!==g&&(f=
...
'"');g="";var l=tdcSidebarPanel._getParameterClasses(a);if(l.includes("tdc-filter-multiple")||l.includes("tdc-filter-single"))g=' title="'+a.description+'" ';b='<div class="'+l+'" '+b+" "+e+" "+k+" "+n+" "+h+" "+m+'><div class="tdc-property-title"><span class="tdc-search-data"'+(d+">"+a.heading+"</span></div>");b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+f+" "+g+"/>");b=b+'</div><span class="tdc-param-name">'+
...
var p="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(p='data-enabled-by="'+a.toggle_enabled_by+'"');var x=' data-responsive="" ',t=tdcSidebarPanel._getParameterCurrentValue(a,c);try{var u=JSON.parse(window.atob(t));x=' data-responsive="'+t+'" ';t="undefined"===typeof u[tdcSidebar.currentViewportSettings.name]?"":u[tdcSidebar.currentViewportSettings.name]}catch(w){}b='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+m+" "+l+" "+p+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+
d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+t+'" data-min="'+g+'" data-max="'+f+'" data-step="'+k+'" min="'+g+'" max="'+f+'" step="'+k+'" value="'+t+'" '+x+" />");b=b+('<input type="text" class="tdc_range_value" data-default_value="'+n+'" '+h+' value="'+t+'"/></div><span class="tdc-param-name">')+(a.param_name+"</span>");return b+="</div>"},addRangeMultiple:function(a,
c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==b?e='data-info-descr="'+a.description+'"':d=' title="'+a.description+'" ');var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&
""!==a.toggle_enabled_by&&(k='data-enabled-by="'+a.toggle_enabled_by+'"');var n=a.tdc_values,h=tdcSidebarPanel._getParameterCurrentValue(a,c),m="",l="",p=[],x="",t="",u="",w="",A="",B="",C="",q;for(q in n)n.hasOwnProperty(q)&&(p.push(n[q].unit),""===t||""===x)&&(w=n[q].unit,t=' data-range_unit="'+w+'" ',u=n[q].value,x=' data-range_value="'+u+'" ',A=n[q].range_min,B=n[q].range_max,C=n[q].range_step);if(""!==h){for(var v=[],y=0;y<p.length&&!(v=h.split(p[y]),1<v.length);y++);v.length&&(w=p[y],t=' data-range_unit="'+
w+'" ',u=v[0],x=' data-range_value="'+u+'" ')}for(q in n)n.hasOwnProperty(q)&&(h=_.uniqueId(),m+=" data-value_"+q+'="'+n[q].value+'" ',m+=" data-min_"+q+'="'+n[q].range_min+'" ',m+=" data-max_"+q+'="'+n[q].range_max+'" ',m+=" data-step_"+q+'="'+n[q].range_step+'" ',p=n[q].value,v="",n[q].unit===w&&(p=u,A=n[q].range_min,B=n[q].range_max,C=n[q].range_step,v="checked"),l+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+q+'" data-unit_value="'+n[q].unit+'" type="radio" id="'+
h+'" '+v+' data-default_value="'+n[q].value+'" data-last_value="'+p+'"/>',l+='<label for="'+h+'">'+n[q].unit+"</label>");b='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+f+" "+g+" "+k+">";b+='<div class="tdc-property-title"><span class="tdc-search-data"'+d+">"+a.heading+"</span></div>";b=b+'<div class="tdc-property"><input class="tdc-multiple-range" '+(tdcSidebarPanel._getParamterDataAtts(a,c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+x+" "+t+" "+
m+' min="'+A+'" max="'+B+'" step="'+C+'" value="'+u+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+l+'</div><input type="text" class="tdc_range_value" value="'+(u+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addRangeMultipleResponsive:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+a.info_img+'"');var d="";_.has(a,"description")&&""!==a.description&&(""!==
...
c),m="",l="",p=[],x=' data-responsive="" ',t="",u="",w="",A="",B="",C="",q="",v;for(v in n)n.hasOwnProperty(v)&&(p.push(n[v].unit),""===u||""===t)&&(A=n[v].unit,u=' data-range_unit="'+A+'" ',w=n[v].value,t=' data-range_value="'+w+'" ',B=n[v].range_min,C=n[v].range_max,q=n[v].range_step);if(""!==h){var y=h;try{var z=JSON.parse(window.atob(h));x=' data-responsive="'+h+'" ';y="undefined"===typeof z[tdcSidebar.currentViewportSettings.name]?"":z[tdcSidebar.currentViewportSettings.name]}catch(E){}if(""!==
y){h=[];for(z=0;z<p.length&&!(h=y.split(p[z]),1<h.length);z++);h.length&&(A=p[z],u=' data-range_unit="'+A+'" ',w=h[0],t=' data-range_value="'+w+'" ')}}for(v in n)n.hasOwnProperty(v)&&(p=_.uniqueId(),m+=" data-value_"+v+'="'+n[v].value+'" ',m+=" data-min_"+v+'="'+n[v].range_min+'" ',m+=" data-max_"+v+'="'+n[v].range_max+'" ',m+=" data-step_"+v+'="'+n[v].range_step+'" ',y=n[v].value,h="",n[v].unit===A&&(y=w,B=n[v].range_min,C=n[v].range_max,q=n[v].range_step,h="checked"),l+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+
...
c)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+t+" "+u+" "+m+" "+x+' min="'+B+'" max="'+C+'" step="'+q+'" value="'+w+'"/>');b=b+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+l+'</div><input type="text" class="tdc_range_value" value="'+(w+'"/>');b+="</div>";b+="</div>";b+='<span class="tdc-param-name">'+a.param_name+"</span>";return b+="</div>"},addIconSelector:function(a,c){var b="",e="";_.has(a,"info_img")&&""!==a.info_img&&(b='data-info-img="'+
...
c="undefined"!==typeof a.tdb_filters&&!0===a.tdb_filters?c+'<span class="tdc-filter-header-slug">Slug</span>':c+'<span class="tdc-filter-header-name">Name</span>';c+='<span class="tdc-filter-header-type" title="Select type">Type</span>';c="undefined"!==typeof a.tdb_filters&&!0===a.tdb_filters?c+'<span class="tdc-filter-header-multiple" title="Allow multiple selection">Multi</span>':c+'<span class="tdc-filter-header-single">Multi</span><span class="tdc-filter-header-multiple" title="Allow multiple selection">And/Or</span>';
return c+"</div>"},addPagesHeader:function(a,c){var b="undefined"!==typeof a.id_heading_txt?a.id_heading_txt:"URL";c='<div class="tdc-pages-header '+tdcSidebarPanel._getParameterClasses(a)+'">';c=-1===tdcSidebarPanel._getParameterClasses(a).indexOf("tdc-pages-header-url")?c+('<span class="tdc-pages-header-id">'+b+"</span>"):c+('<span class="tdc-pages-header-url">'+b+"</span>");c+='<span class="tdc-pages-header-title">Title</span>';-1===tdcSidebarPanel._getParameterClasses(a).indexOf("no-icon")&&(c+=
'<span class="tdc-pages-header-icon">Icon</span>');return c+"</div>"},addPlansLimitHeader:function(a,c){var b=c="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(b='data-enable-params="'+a.toggle_enable_params+'"');var e="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(e='data-enable-params-reverse="1"');var d="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(d='data-enabled-by="'+a.toggle_enabled_by+'"');c+='<div class="tdc-plans-limit-header '+
tdcSidebarPanel._getParameterClasses(a)+'" '+b+" "+e+" "+d+">";return c+'<span class="tdc-plans-limit-header-id">Plan IDs</span><span class="tdc-plans-limit-header-limit">Limit</span></div>'},addFilterTypeHeader:function(a,c){c='<div class="tdc-filter-header '+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<span class="tdc-filter-header-name">'+a.heading+"</span>";return c+'<span class="tdc-filter-header-type" title="Select filter type">Type</span></div>'},addFilterTitle:function(a,c){var b="",
e="",d="";_.has(a,"info_img")&&""!==a.info_img&&(e='data-info-img="'+a.info_img+'"',_.has(a,"description")&&""!==a.description&&(d='data-info-descr="'+a.description+'"'));var f="";_.has(a,"toggle_enable_params")&&""!==a.toggle_enable_params&&(f='data-enable-params="'+a.toggle_enable_params+'"');var g="";_.has(a,"toggle_enable_params_reverse")&&!0===a.toggle_enable_params_reverse&&(g='data-enable-params-reverse="1"');var k="";_.has(a,"toggle_enabled_by")&&""!==a.toggle_enabled_by&&(k='data-enabled-by="'+
a.toggle_enabled_by+'"');return b+='<div class="tdc-sidebar-filter-title '+tdcSidebarPanel._getParameterClasses(a)+'" '+e+" "+d+" "+f+" "+g+" "+k+'><span class="tdc-search-data">'+tdcSidebarPanel._getParameterCurrentValue(a,c)+"</span></div>"},addSearchSectionHeader:function(a,c){c='<div class="tdc-search-section-header '+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<span class="tdc-search-section-header-title">Section title</span><span class="tdc-search-section-header-tax">Taxonomy</span>';-1===
tdcSidebarPanel._getParameterClasses(a).indexOf("no-level")&&(c+='<span class="tdc-search-section-header-level">Level</span>');return c+"</div>"},addClearfix:function(a,c){return'<div class="clearfix"></div>'},updateTextfieldResponsiveValues:function(a,c,b){"undefined"===typeof window.tdcResponsiveValues[a]?""!==c&&(window.tdcResponsiveValues[a]={},window.tdcResponsiveValues[a][b]={viewportName:c}):""===c?delete window.tdcResponsiveValues[a][b]:window.tdcResponsiveValues[a][b]=c;c=_.allKeys(window.tdcResponsiveValues[a]);
...
"all"),_.isUndefined(c)?a.val(""):(a.val(c),a.attr("placeholder",c),b.addClass("tdc-css-inherited"))):(a.val(c),b.removeClass("tdc-css-inherited"))}else if(b.hasClass("tdc-property-checkbox-responsive"))e=b.find(".tdc-inherit-checkbox"),_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)?a.prop("checked",!1):(""===c?a.prop("checked",!1):a.prop("checked","checked"),b.addClass("tdc-css-inherited")),e.hide()):(""===c?a.prop("checked",!1):a.prop("checked",
...
g=window.tdcAdminSettings.mappedShortcodes[e.attributes.tag];e=[];for(var k=d="",l=0;l<g.params.length;l++)if(f===g.params[l].param_name){f=g.params[l].tdc_values;for(var h in f)f.hasOwnProperty(h)&&(e.push(f[h].unit),""===d||""===k)&&(d=f[h].value,k=f[h].unit);break}_.isUndefined(c)?(c=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(c)&&(a.data("range_value",d),a.data("range_unit",k),a.val(d),h=b.find('input[type="radio"][data-unit_value="'+k+'"]'),l=h.data("unit"),
f=a.data("min_"+l),k=a.data("max_"+l),l=a.data("step_"+l),g=a.get(0),h.prop("checked",!0),g.min=f,g.max=k,g.step=l,g.value=d,h.data("last_value",d),b.find('input[type="text"]').val(d)),"all"===tdcSidebar.currentViewportSettings.name?b.removeClass("tdc-css-inherited"):b.addClass("tdc-css-inherited")):b.removeClass("tdc-css-inherited");if(!_.isUndefined(c)){d=[];for(l=0;l<e.length&&!(d=c.split(e[l]),1<d.length);l++);d.length&&(d=d[0],k=e[l],a.data("range_value",d),a.data("range_unit",k),a.val(d),h=
b.find('input[type="radio"][data-unit_value="'+k+'"]'),l=h.data("unit"),f=a.data("min_"+l),k=a.data("max_"+l),l=a.data("step_"+l),g=a.get(0),h.prop("checked",!0),g.min=f,g.max=k,g.step=l,g.value=d,h.data("last_value",d),b.find('input[type="text"]').val(d))}}},showShortcodeFromPath:function(a){if(!_.isUndefined(a)){a=a.toString().split("_");var c;a.forEach(function(a,b){""!==a&&(_.isUndefined(c)?c=tdcIFrameData.tdcTopCollection.at(a):(b=c.get("childCollection"),!_.isUndefined(b)&&b.length>a&&(c=b.at(a))))});
...
l)}}})();var tdcJobManager={};
(function(){tdcJobManager={_sentJobs:{},totalJobsCount:0,job:function(){this.model=void 0;this.shortcode="";this.columns=0;this.error_callback=this.success_callback=this.blockUid=""},jobRequest:function(l){this.parentRowAttributes="";if(!_.isUndefined(l.model)){var a=l.model.getParentModel("vc_row");_.isUndefined(a)||(this.parentRowAttributes=JSON.stringify(a.attributes.attrs))}this.shortcode=l.shortcode;this.columns=l.columns;this.jobId=tdcJobManager._generateJobId();this.postId=window.tdcPostSettings.postId;
this.replyHtml=""},addJob:function(l){tdcMain.setContentModified();tdcDebug.group("%c tdcJobManager.addJob","background-color:#2489c2; color:white");var a=new tdcJobManager.jobRequest(l),c="";!1!==window.tdcPostSettings.tdbLoadDataFromId&&(c+="&tdbLoadDataFromId="+window.tdcPostSettings.tdbLoadDataFromId);!1!==window.tdcPostSettings.tdbTemplateType&&(c+="&tdbTemplateType="+window.tdcPostSettings.tdbTemplateType);jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/do_job",
"tmp_jobId="+a.jobId+"&tmp_blockUid="+a.blockUid+"&post_id="+window.tdcPostSettings.postId+c+"&uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},cache:!1,data:a,dataType:"json",statusCode:{404:function(){console.log("tdcJobManager.addJob - ERROR: 404 not found")},500:function(){console.log("tdcJobManager.addJob - ERROR: 500 server error")}},success:function(b,c,d){null===b?l.error_callback(a,"tdcJobManager.addJob - ERROR: Empty response received from server"):
(!0===tdcJobManager._isJobCallbackReplyValid(l.blockUid,b.jobId)?l.success_callback(b):tdcDebug.log("tdcJobManager.addJob - dropped job :) (probably it's older than the last timestamp)"),tdcDebug.groupEnd())},error:function(b,c,d){l.error_callback(a,"tdcJobManager.addJob - Error callback - textStatus: "+c+" errorThrown: "+d);tdcDebug.groupEnd()}})},_isJobCallbackReplyValid:function(l,a){return"undefined"===typeof tdcJobManager._sentJobs[l]||parseInt(tdcJobManager._sentJobs[l])<parseInt(a)?(tdcJobManager._sentJobs[l]=
a,!0):!1},_generateJobId:function(){var l=tdcJobManager.totalJobsCount;tdcJobManager.totalJobsCount++;return l},_getUniqueID:function(){function l(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return l()+l()+"-"+l()+"-"+l()+"-"+l()+"-"+l()+l()+l()}}})();
